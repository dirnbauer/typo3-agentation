...
.icon-transitions-module__sending___uaLN- {
  ...
  `,document.head.appendChild(e),Re.pausedAnimations=[];try{document.getAnimations().forEach(t=>{if(t.playState!=="running")return;const n=t.effect?.target;Xg(n)||(t.pause(),Re.pausedAnimations.push(t))})}catch{}document.querySelectorAll("video").forEach(t=>{t.paused||(t.dataset.wasPaused="false",t.pause())})}function S_(){if(typeof document>"u"||!Re.frozen)return;Re.frozen=!1;const e=Re.frozenTimeoutQueue;Re.frozenTimeoutQueue=[];for(const n of e)Re.origSetTimeout(()=>{if(Re.frozen){Re.frozenTimeoutQueue.push(n);return}try{n()}catch(o){console.warn("[agentation] Error replaying queued timeout:",o)}},0);const t=Re.frozenRAFQueue;Re.frozenRAFQueue=[];for(const n of t)Re.origRAF(o=>{if(Re.frozen){Re.frozenRAFQueue.push(n);return}n(o)});for(const n of Re.pausedAnimations)try{n.play()}catch(o){console.warn("[agentation] Error resuming animation:",o)}Re.pausedAnimations=[],document.getElementById(Oc)?.remove(),document.querySelectorAll("video").forEach(n=>{n.dataset.wasPaused==="false"&&(n.play().catch(()=>{}),delete n.dataset.wasPaused)})}function Ba(e){if(!e)return;const t=n=>n.stopImmediatePropagation();document.addEventListener("focusin",t,!0),document.addEventListener("focusout",t,!0);try{e.focus()}finally{document.removeEventListener("focusin",t,!0),document.removeEventListener("focusout",t,!0)}}var Ei=_.forwardRef(function({element:t,timestamp:n,selectedText:o,placeholder:r="What should change?",initialValue:l="",submitLabel:i="Add",onSubmit:a,onCancel:c,onDelete:p,style:m,accentColor:w="#3c82f7",isExiting:g=!1,lightMode:$=!1,computedStyles:k},j){const[M,f]=_.useState(l),[y,b]=_.useState(!1),[N,W]=_.useState("initial"),[Y,D]=_.useState(!1),[Q,he]=_.useState(!1),q=_.useRef(null),de=_.useRef(null),Be=_.useRef(null),Ae=_.useRef(null);_.useEffect(()=>{g&&N!=="exit"&&W("exit")},[g,N]),_.useEffect(()=>{fe(()=>{W("enter")},0);const U=fe(()=>{W("entered")},200),G=fe(()=>{const Se=q.current;Se&&(Ba(Se),Se.selectionStart=Se.selectionEnd=Se.value.length,Se.scrollTop=Se.scrollHeight)},50);return()=>{clearTimeout(U),clearTimeout(G),Be.current&&clearTimeout(Be.current),Ae.current&&clearTimeout(Ae.current)}},[]);const ke=_.useCallback(()=>{Ae.current&&clearTimeout(Ae.current),b(!0),Ae.current=fe(()=>{b(!1),Ba(q.current)},250)},[]);_.useImperativeHandle(j,()=>({shake:ke}),[ke]);const Ne=_.useCallback(()=>{W("exit"),Be.current=fe(()=>{c()},150)},[c]),oe=_.useCallback(()=>{M.trim()&&a(M.trim())},[M,a]),lt=_.useCallback(U=>{U.stopPropagation(),!U.nativeEvent.isComposing&&(U.key==="Enter"&&!U.shiftKey&&(U.preventDefault(),oe()),U.key==="Escape"&&Ne())},[oe,Ne]),I=[nt.popup,$?nt.light:"",N==="enter"?nt.enter:"",N==="entered"?nt.entered:"",N==="exit"?nt.exit:"",y?nt.shake:""].filter(Boolean).join(" ");return s.jsxs("div",{ref:de,className:I,"data-annotation-popup":!0,style:m,onClick:U=>U.stopPropagation(),children:[s.jsxs("div",{className:nt.header,children:[k&&Object.keys(k).length>0?s.jsxs("button",{className:nt.headerToggle,onClick:()=>{const U=Q;he(!Q),U&&fe(()=>Ba(q.current),0)},type:"button",children:[s.jsx("svg",{className:`${nt.chevron} ${Q?nt.expanded:""}`,width:"14",height:"14",viewBox:"0 0 14 14",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:s.jsx("path",{d:"M5.5 10.25L9 7.25L5.75 4",stroke:"currentColor",strokeWidth:"1.5",strokeLinecap:"round",strokeLinejoin:"round"})}),s.jsx("span",{className:nt.element,children:t})]}):s.jsx("span",{className:nt.element,children:t}),n&&s.jsx("span",{className:nt.timestamp,children:n})]}),k&&Object.keys(k).length>0&&s.jsx("div",{className:`${nt.stylesWrapper} ${Q?nt.expanded:""}`,children:s.jsx("div",{className:nt.stylesInner,children:s.jsx("div",{className:nt.stylesBlock,children:Object.entries(k).map(([U,G])=>s.jsxs("div",{className:nt.styleLine,children:[s.jsx("span",{className:nt.styleProperty,children:U.replace(/([A-Z])/g,"-$1").toLowerCase()}),": ",s.jsx("span",{className:nt.styleValue,children:G}),";"]},U))})})}),o&&s.jsxs("div",{className:nt.quote,children:["“",o.slice(0,80),o.length>80?"...":"","”"]}),s.jsx("textarea",{ref:q,className:nt.textarea,style:{borderColor:Y?w:void 0},placeholder:r,value:M,onChange:U=>f(U.target.value),onFocus:()=>D(!0),onBlur:()=>D(!1),rows:2,onKeyDown:lt}),s.jsxs("div",{className:nt.actions,children:[p&&s.jsx("div",{className:nt.deleteWrapper,children:s.jsx("button",{className:nt.deleteButton,onClick:p,type:"button",children:s.jsx(Wg,{size:22})})}),s.jsx("button",{className:nt.cancel,onClick:Ne,children:"Cancel"}),s.jsx("button",{className:nt.submit,style:{backgroundColor:w,opacity:M.trim()?1:.4},onClick:oe,disabled:!M.trim(),children:i})]})]})}),Vg=({content:e,children:t,...n})=>{const[o,r]=_.useState(!1),[l,i]=_.useState(!1),[a,c]=_.useState({top:0,right:0}),p=_.useRef(null),m=_.useRef(null),w=_.useRef(null),g=()=>{if(p.current){const j=p.current.getBoundingClientRect();c({top:j.top+j.height/2,right:window.innerWidth-j.left+8})}},$=()=>{i(!0),w.current&&(clearTimeout(w.current),w.current=null),g(),m.current=fe(()=>{r(!0)},500)},k=()=>{m.current&&(clearTimeout(m.current),m.current=null),r(!1),w.current=fe(()=>{i(!1)},150)};return _.useEffect(()=>()=>{m.current&&clearTimeout(m.current),w.current&&clearTimeout(w.current)},[]),s.jsxs(s.Fragment,{children:[s.jsx("span",{ref:p,onMouseEnter:$,onMouseLeave:k,...n,children:t}),l&&Ou.createPortal(s.jsx("div",{"data-feedback-toolbar":!0,style:{position:"fixed",top:a.top,right:a.right,transform:"translateY(-50%)",padding:"6px 10px",background:"#383838",color:"rgba(255, 255, 255, 0.7)",fontSize:"11px",fontWeight:400,lineHeight:"14px",borderRadius:"10px",width:"180px",textAlign:"left",zIndex:100020,pointerEvents:"none",boxShadow:"0px 1px 8px rgba(0, 0, 0, 0.28)",opacity:o?1:0,transition:"opacity 0.15s ease"},children:e}),document.body)]})},Kg=`.styles-module__tooltip___mcXL2 {
  display: flex;
  justify-content: center;
  align-items: center;
  cursor: help;
...
}`,_1={overlayExiting:"styles-module__overlayExiting___iEmYr",overlay:"styles-module__overlay___aWh-q",overlayFadeIn:"styles-module__overlayFadeIn___aECVy",light:"styles-module__light___ORIft",wireframe:"styles-module__wireframe___itvQU",placing:"styles-module__placing___45yD8",passthrough:"styles-module__passthrough___xaFeE",blankCanvas:"styles-module__blankCanvas___t2Eue",visible:"styles-module__visible___OKKqX",gridActive:"styles-module__gridActive___OZ-cf",paletteHeader:"styles-module__paletteHeader___-Q5gQ",paletteHeaderTitle:"styles-module__paletteHeaderTitle___oHqZC",paletteHeaderDesc:"styles-module__paletteHeaderDesc___6i74T",wireframePurposeWrap:"styles-module__wireframePurposeWrap___To-tS",collapsed:"styles-module__collapsed___Ms9vS",wireframePurposeInner:"styles-module__wireframePurposeInner___Lrahs",wireframePurposeInput:"styles-module__wireframePurposeInput___7EtBN",canvasToggle:"styles-module__canvasToggle___-QqSy",active:"styles-module__active___hosp7",canvasToggleIcon:"styles-module__canvasToggleIcon___7pJ82",canvasToggleLabel:"styles-module__canvasToggleLabel___OanpY",canvasPurposeWrap:"styles-module__canvasPurposeWrap___hj6zk",canvasPurposeInner:"styles-module__canvasPurposeInner___VWiyu",canvasPurposeToggle:"styles-module__canvasPurposeToggle___byDH2",canvasPurposeCheck:"styles-module__canvasPurposeCheck___xqd7l",checked:"styles-module__checked___-1JGH",canvasPurposeLabel:"styles-module__canvasPurposeLabel___Zu-tD",canvasPurposeHelp:"styles-module__canvasPurposeHelp___jijwR",placement:"styles-module__placement___zcxv8",placementEnter:"styles-module__placementEnter___TdRhf",selected:"styles-module__selected___6yrp6",dragging:"styles-module__dragging___le6KZ",exiting:"styles-module__exiting___YrM8F",placementContent:"styles-module__placementContent___f64A4",placementLabel:"styles-module__placementLabel___0KvWl",placementAnnotation:"styles-module__placementAnnotation___78pTr",annotationVisible:"styles-module__annotationVisible___mrUyA",sectionAnnotation:"styles-module__sectionAnnotation___aUIs0",handle:"styles-module__handle___Ikbxm",sectionOutline:"styles-module__sectionOutline___s0hy-",ghostOutline:"styles-module__ghostOutline___po-kO",handleNw:"styles-module__handleNw___4TMIj",handleNe:"styles-module__handleNe___mnsTh",handleSe:"styles-module__handleSe___oSFnk",handleSw:"styles-module__handleSw___pi--Z",handleN:"styles-module__handleN___aBA-Q",handleE:"styles-module__handleE___0hM5u",handleS:"styles-module__handleS___JjDRv",handleW:"styles-module__handleW___ERWGQ",edgeHandle:"styles-module__edgeHandle___XxXdT",edgeN:"styles-module__edgeN___-JJDj",edgeS:"styles-module__edgeS___66lMX",edgeE:"styles-module__edgeE___1bGDa",edgeW:"styles-module__edgeW___lHQNo",deleteButton:"styles-module__deleteButton___LkGCb",rearrangeOverlay:"styles-module__rearrangeOverlay___-3R3t",drawBox:"styles-module__drawBox___BrVAa",selectBox:"styles-module__selectBox___Iu8kB",sizeIndicator:"styles-module__sizeIndicator___7zJ4y",guideLine:"styles-module__guideLine___DUQY2",dragPreview:"styles-module__dragPreview___onPbU",dragPreviewWireframe:"styles-module__dragPreviewWireframe___jsg0G",palette:"styles-module__palette___C7iSH",paletteItem:"styles-module__paletteItem___6TlnA",paletteItemLabel:"styles-module__paletteItemLabel___6ncO4",paletteSectionTitle:"styles-module__paletteSectionTitle___PqnjX",paletteFooter:"styles-module__paletteFooter___QYnAG",enter:"styles-module__enter___6LYk5",exit:"styles-module__exit___iSGRw",paletteSection:"styles-module__paletteSection___V8DEA",paletteItemIcon:"styles-module__paletteItemIcon___0NPQK",placeScroll:"styles-module__placeScroll___7sClM",fadeTop:"styles-module__fadeTop___KT9tF",fadeBottom:"styles-module__fadeBottom___x3ShT",paletteFooterWrap:"styles-module__paletteFooterWrap___71-fI",footerHidden:"styles-module__footerHidden___fJUik",paletteFooterInnerContent:"styles-module__paletteFooterInnerContent___VC26h",paletteFooterInner:"styles-module__paletteFooterInner___dfylY",paletteFooterCount:"styles-module__paletteFooterCount___D3Fia",paletteFooterClear:"styles-module__paletteFooterClear___ybBoa",paletteFooterActions:"styles-module__paletteFooterActions___fLzv8",rollingWrap:"styles-module__rollingWrap___S75jM",rollingNum:"styles-module__rollingNum___1RKDx",exitUp:"styles-module__exitUp___AFDRW",numExitUp:"styles-module__numExitUp___FRQqx",enterUp:"styles-module__enterUp___CPlXb",numEnterUp:"styles-module__numEnterUp___2Yd-w",exitDown:"styles-module__exitDown___-1yAy",numExitDown:"styles-module__numExitDown___xm5by",enterDown:"styles-module__enterDown___DDuFR",numEnterDown:"styles-module__numEnterDown___hpxBk",hoverHighlight:"styles-module__hoverHighlight___8eT-v",highlightFadeIn:"styles-module__highlightFadeIn___Lg7KY",sectionEnter:"styles-module__sectionEnter___-8BXT",settled:"styles-module__settled___b5U5o",sectionLabel:"styles-module__sectionLabel___F80HQ",movedBadge:"styles-module__movedBadge___s8z-q",sectionDimensions:"styles-module__sectionDimensions___RcJSL",badgeVisible:"styles-module__badgeVisible___npbdS",resizedBadge:"styles-module__resizedBadge___u51V8",wireframeNotice:"styles-module__wireframeNotice___4GJyB",wireframeOpacityRow:"styles-module__wireframeOpacityRow___CJXzi",wireframeOpacityLabel:"styles-module__wireframeOpacityLabel___afkfT",wireframeOpacitySlider:"styles-module__wireframeOpacitySlider___YcoEs",wireframeNoticeTitleRow:"styles-module__wireframeNoticeTitleRow___PJqyG",wireframeNoticeTitle:"styles-module__wireframeNoticeTitle___okr08",wireframeNoticeDivider:"styles-module__wireframeNoticeDivider___PNKQ6",wireframeStartOver:"styles-module__wireframeStartOver___YFk-I",ghostEnter:"styles-module__ghostEnter___EC3Mb",ghostBadge:"styles-module__ghostBadge___tsQUK",badgeSlideIn:"styles-module__badgeSlideIn___typJ7",ghostBadgeExtra:"styles-module__ghostBadgeExtra___6CVoD",badgeExtraIn:"styles-module__badgeExtraIn___i4W8F",originalOutline:"styles-module__originalOutline___Y6DD1",originalLabel:"styles-module__originalLabel___HqI9g",connectorSvg:"styles-module__connectorSvg___Lovld",connectorLine:"styles-module__connectorLine___XeWh-",connectorDraw:"styles-module__connectorDraw___8sK5I",connectorDot:"styles-module__connectorDot___yvf7C",connectorDotIn:"styles-module__connectorDotIn___NwTUq",connectorExiting:"styles-module__connectorExiting___2lLOs",connectorOut:"styles-module__connectorOut___5QoPl",connectorDotOut:"styles-module__connectorDotOut___FEq7e"};if(typeof document<"u"){let e=document.getElementById("feedback-tool-styles-design-mode-styles");e||(e=document.createElement("style"),e.id="feedback-tool-styles-design-mode-styles",document.head.appendChild(e)),e.textContent=d1}var R=_1,gr=24,Tl=5;function j_(e,t,n,o,r){let l=1/0,i=1/0;const a=e.x,c=e.x+e.width,p=e.x+e.width/2,m=e.y,w=e.y+e.height,g=e.y+e.height/2,$=!o,k=$?[a,c,p]:[...o.left?[a]:[],...o.right?[c]:[]],j=$?[m,w,g]:[...o.top?[m]:[],...o.bottom?[w]:[]],M=[];for(const de of t)n.has(de.id)||M.push(de);r&&M.push(...r);for(const de of M){const Be=de.x,Ae=de.x+de.width,ke=de.x+de.width/2,Ne=de.y,oe=de.y+de.height,lt=de.y+de.height/2;for(const I of k)for(const U of[Be,Ae,ke]){const G=U-I;Math.abs(G)<Tl&&Math.abs(G)<Math.abs(l)&&(l=G)}for(const I of j)for(const U of[Ne,oe,lt]){const G=U-I;Math.abs(G)<Tl&&Math.abs(G)<Math.abs(i)&&(i=G)}}const f=Math.abs(l)<Tl?l:0,y=Math.abs(i)<Tl?i:0,b=[],N=new Set,W=a+f,Y=c+f,D=p+f,Q=m+y,he=w+y,q=g+y;for(const de of M){const Be=de.x,Ae=de.x+de.width,ke=de.x+de.width/2,Ne=de.y,oe=de.y+de.height,lt=de.y+de.height/2;for(const I of[Be,ke,Ae])for(const U of[W,D,Y])if(Math.abs(U-I)<.5){const G=`x:${Math.round(I)}`;N.has(G)||(N.add(G),b.push({axis:"x",pos:I}))}for(const I of[Ne,lt,oe])for(const U of[Q,q,he])if(Math.abs(U-I)<.5){const G=`y:${Math.round(I)}`;N.has(G)||(N.add(G),b.push({axis:"y",pos:I}))}}return{dx:f,dy:y,guides:b}}function M_(){return`dp-${Date.now()}-${Math.random().toString(36).slice(2,7)}`}function f1({placements:e,onChange:t,activeComponent:n,onActiveComponentChange:o,isDarkMode:r,exiting:l,onInteractionChange:i,className:a,passthrough:c,extraSnapRects:p,onSelectionChange:m,deselectSignal:w,onDragMove:g,onDragEnd:$,clearSignal:k,wireframe:j}){const[M,f]=_.useState(new Set),[y,b]=_.useState(null),[N,W]=_.useState(null),[Y,D]=_.useState(null),[Q,he]=_.useState([]),[q,de]=_.useState(null),[Be,Ae]=_.useState(!1),ke=_.useRef(!1),[Ne,oe]=_.useState(new Set),lt=_.useRef(new Map),I=_.useRef(null),U=_.useRef(null),G=_.useRef(e);G.current=e;const Se=_.useRef(m);Se.current=m;const Fe=_.useRef(g);Fe.current=g;const wt=_.useRef($);wt.current=$;const Pt=_.useRef(w);_.useEffect(()=>{w!==Pt.current&&(Pt.current=w,f(new Set))},[w]);const Dt=_.useRef(k);_.useEffect(()=>{if(k!==void 0&&k!==Dt.current){Dt.current=k;const T=new Set(G.current.map(ie=>ie.id));T.size>0&&(oe(T),f(new Set),U.current=null,fe(()=>{t([]),oe(new Set)},180))}},[k,t]),_.useEffect(()=>{const T=ie=>{const Me=ie.target;if(!(Me.tagName==="INPUT"||Me.tagName==="TEXTAREA"||Me.isContentEditable)){if((ie.key==="Backspace"||ie.key==="Delete")&&M.size>0){ie.preventDefault();const Ce=new Set(M);oe(Ce),f(new Set),fe(()=>{t(G.current.filter(Ye=>!Ce.has(Ye.id))),oe(new Set)},180);return}if(["ArrowUp","ArrowDown","ArrowLeft","ArrowRight"].includes(ie.key)&&M.size>0){ie.preventDefault();const Ce=ie.shiftKey?20:1,Ye=ie.key==="ArrowLeft"?-Ce:ie.key==="ArrowRight"?Ce:0,He=ie.key==="ArrowUp"?-Ce:ie.key==="ArrowDown"?Ce:0;t(e.map(Ie=>M.has(Ie.id)?{...Ie,x:Math.max(0,Ie.x+Ye),y:Math.max(0,Ie.y+He)}:Ie));return}if(ie.key==="Escape"){n?o(null):M.size>0&&f(new Set);return}}};return document.addEventListener("keydown",T),()=>document.removeEventListener("keydown",T)},[M,n,e,t,o]);const Bt=_.useCallback(T=>{if(T.button!==0||c||T.target.closest(`.${R.placement}`))return;T.preventDefault(),T.stopPropagation();const Me=window.scrollY,ge=T.clientX,Ce=T.clientY;if(n){U.current="place",i?.(!0);let Ye=!1,He=ge,Ie=Ce;const Xe=ue=>{He=ue.clientX,Ie=ue.clientY;const C=Math.abs(He-ge),E=Math.abs(Ie-Ce);if((C>5||E>5)&&(Ye=!0),Ye){const B=Math.min(ge,He),O=Math.min(Ce,Ie),se=Math.abs(He-ge),K=Math.abs(Ie-Ce);b({x:B,y:O,w:se,h:K}),D({x:ue.clientX+12,y:ue.clientY+12,text:`${Math.round(se)} × ${Math.round(K)}`})}},at=ue=>{window.removeEventListener("mousemove",Xe),window.removeEventListener("mouseup",at),b(null),D(null),U.current=null,i?.(!1);const C=J[n];let E,B,O,se;Ye?(E=Math.min(ge,He),B=Math.min(Ce,Ie)+Me,O=Math.max(gr,Math.abs(He-ge)),se=Math.max(gr,Math.abs(Ie-Ce))):(O=C.width,se=C.height,E=ge-O/2,B=Ce+Me-se/2),E=Math.max(0,E),B=Math.max(0,B);const K={id:M_(),type:n,x:E,y:B,width:O,height:se,scrollY:Me,timestamp:Date.now()},F=[...e,K];t(F),f(new Set([K.id])),o(null)};window.addEventListener("mousemove",Xe),window.addEventListener("mouseup",at)}else{T.shiftKey||f(new Set),U.current="select";let Ye=!1;const He=Xe=>{const at=Math.abs(Xe.clientX-ge),ue=Math.abs(Xe.clientY-Ce);if((at>4||ue>4)&&(Ye=!0),Ye){const C=Math.min(ge,Xe.clientX),E=Math.min(Ce,Xe.clientY);W({x:C,y:E,w:Math.abs(Xe.clientX-ge),h:Math.abs(Xe.clientY-Ce)})}},Ie=Xe=>{if(window.removeEventListener("mousemove",He),window.removeEventListener("mouseup",Ie),U.current=null,Ye){const at=Math.min(ge,Xe.clientX),ue=Math.min(Ce,Xe.clientY)+Me,C=Math.abs(Xe.clientX-ge),E=Math.abs(Xe.clientY-Ce),B=new Set(T.shiftKey?M:new Set);for(const O of e)O.y-Me,O.x+O.width>at&&O.x<at+C&&O.y+O.height>ue&&O.y<ue+E&&B.add(O.id);f(B)}W(null)};window.addEventListener("mousemove",He),window.addEventListener("mouseup",Ie)}},[n,c,e,t,M]),zt=_.useCallback((T,ie)=>{if(T.button!==0)return;const Me=T.target;if(Me.closest(`.${R.handle}`)||Me.closest(`.${R.deleteButton}`))return;T.preventDefault(),T.stopPropagation();let ge;T.shiftKey?(ge=new Set(M),ge.has(ie)?ge.delete(ie):ge.add(ie)):M.has(ie)?ge=new Set(M):ge=new Set([ie]),f(ge),(ge.size!==M.size||[...ge].some(K=>!M.has(K)))&&Se.current?.(ge,T.shiftKey);const Ye=T.clientX,He=T.clientY,Ie=new Map;for(const K of e)ge.has(K.id)&&Ie.set(K.id,{x:K.x,y:K.y});U.current="move",i?.(!0);let Xe=!1,at=!1,ue=e,C=0,E=0;const B=new Map;for(const K of e)Ie.has(K.id)&&B.set(K.id,{w:K.width,h:K.height});const O=K=>{const F=K.clientX-Ye,we=K.clientY-He;if((Math.abs(F)>2||Math.abs(we)>2)&&(Xe=!0),!Xe)return;if(K.altKey&&!at){at=!0;const pe=[];for(const Qe of e)Ie.has(Qe.id)&&pe.push({...Qe,id:M_(),timestamp:Date.now()});ue=[...e,...pe]}let be=1/0,ze=1/0,Ke=-1/0,ae=-1/0;for(const[pe,Qe]of Ie){const $e=B.get(pe);$e&&(be=Math.min(be,Qe.x+F),ze=Math.min(ze,Qe.y+we),Ke=Math.max(Ke,Qe.x+F+$e.w),ae=Math.max(ae,Qe.y+we+$e.h))}const We={x:be,y:ze,width:Ke-be,height:ae-ze},{dx:Oe,dy:Le,guides:re}=j_(We,ue,new Set(Ie.keys()),void 0,p);he(re);const Ge=F+Oe,je=we+Le;C=Ge,E=je,t(ue.map(pe=>{const Qe=Ie.get(pe.id);return Qe?{...pe,x:Math.max(0,Qe.x+Ge),y:Math.max(0,Qe.y+je)}:pe})),Fe.current?.(Ge,je)},se=()=>{window.removeEventListener("mousemove",O),window.removeEventListener("mouseup",se),U.current=null,i?.(!1),he([]),wt.current?.(C,E,Xe)};window.addEventListener("mousemove",O),window.addEventListener("mouseup",se)},[M,e,t,i]),Vn=_.useCallback((T,ie,Me)=>{T.preventDefault(),T.stopPropagation();const ge=e.find(B=>B.id===ie);if(!ge)return;f(new Set([ie])),U.current="resize",i?.(!0);const Ce=T.clientX,Ye=T.clientY,He=ge.width,Ie=ge.height,Xe=ge.x,at=ge.y,ue={left:Me.includes("w"),right:Me.includes("e"),top:Me.includes("n"),bottom:Me.includes("s")},C=B=>{const O=B.clientX-Ce,se=B.clientY-Ye;let K=He,F=Ie,we=Xe,be=at;Me.includes("e")&&(K=Math.max(gr,He+O)),Me.includes("w")&&(K=Math.max(gr,He-O),we=Xe+He-K),Me.includes("s")&&(F=Math.max(gr,Ie+se)),Me.includes("n")&&(F=Math.max(gr,Ie-se),be=at+Ie-F);const ze={x:we,y:be,width:K,height:F},{dx:Ke,dy:ae,guides:We}=j_(ze,G.current,new Set([ie]),ue,p);he(We),Ke!==0&&(ue.right?K+=Ke:ue.left&&(we+=Ke,K-=Ke)),ae!==0&&(ue.bottom?F+=ae:ue.top&&(be+=ae,F-=ae)),t(G.current.map(Oe=>Oe.id===ie?{...Oe,x:we,y:be,width:K,height:F}:Oe)),D({x:B.clientX+12,y:B.clientY+12,text:`${Math.round(K)} × ${Math.round(F)}`})},E=()=>{window.removeEventListener("mousemove",C),window.removeEventListener("mouseup",E),D(null),U.current=null,i?.(!1),he([])};window.addEventListener("mousemove",C),window.addEventListener("mouseup",E)},[e,t,i]),ao=_.useCallback(T=>{U.current=null,oe(ie=>{const Me=new Set(ie);return Me.add(T),Me}),f(ie=>{const Me=new Set(ie);return Me.delete(T),Me}),fe(()=>{t(G.current.filter(ie=>ie.id!==T)),oe(ie=>{const Me=new Set(ie);return Me.delete(T),Me})},180)},[t]),co={hero:"Headline text",button:"Button label",badge:"Badge label",cta:"Call to action text",toast:"Notification message",modal:"Dialog title",card:"Card title",navigation:"Brand / nav items",tabs:"Tab labels",input:"Placeholder text",search:"Search placeholder",pricing:"Plan name or price",testimonial:"Quote text",alert:"Alert message",banner:"Banner text",tag:"Tag label",notification:"Notification message",stat:"Metric value",productCard:"Product name"},on=_.useCallback(T=>{const ie=e.find(Me=>Me.id===T);ie&&(ke.current=!!ie.text,de(T),Ae(!1))},[e]),Gt=_.useCallback(()=>{q&&(Ae(!0),fe(()=>{de(null),Ae(!1)},150))},[q]);_.useEffect(()=>{l&&q&&Gt()},[l]);const _n=_.useCallback(T=>{q&&(t(e.map(ie=>ie.id===q?{...ie,text:T.trim()||void 0}:ie)),Gt())},[q,e,t,Gt]),Sn=typeof window<"u"?window.scrollY:0,uo=["nw","ne","se","sw"],Kn=j?"#f97316":"#3c82f7",_o=[{dir:"n",cls:R.edgeN,arrow:s.jsx("svg",{width:"8",height:"6",viewBox:"0 0 8 6",fill:"none",children:s.jsx("path",{d:"M4 0.5L1 4.5h6z",fill:Kn})})},{dir:"e",cls:R.edgeE,arrow:s.jsx("svg",{width:"6",height:"8",viewBox:"0 0 6 8",fill:"none",children:s.jsx("path",{d:"M5.5 4L1.5 1v6z",fill:Kn})})},{dir:"s",cls:R.edgeS,arrow:s.jsx("svg",{width:"8",height:"6",viewBox:"0 0 8 6",fill:"none",children:s.jsx("path",{d:"M4 5.5L1 1.5h6z",fill:Kn})})},{dir:"w",cls:R.edgeW,arrow:s.jsx("svg",{width:"6",height:"8",viewBox:"0 0 6 8",fill:"none",children:s.jsx("path",{d:"M0.5 4L4.5 1v6z",fill:Kn})})}];return s.jsxs(s.Fragment,{children:[s.jsx("div",{ref:I,className:`${R.overlay} ${r?"":R.light} ${n?R.placing:""} ${c?R.passthrough:""} ${l?R.overlayExiting:""} ${j?R.wireframe:""}${a?` ${a}`:""}`,"data-feedback-toolbar":!0,onMouseDown:Bt,children:e.map(T=>{const ie=M.has(T.id),Me=Nn[T.type]?.label||T.type,ge=T.y-Sn;return s.jsxs("div",{"data-design-placement":T.id,className:`${R.placement} ${ie?R.selected:""} ${Ne.has(T.id)?R.exiting:""}`,style:{left:T.x,top:ge,width:T.width,height:T.height,position:"fixed"},onMouseDown:Ce=>zt(Ce,T.id),onDoubleClick:()=>on(T.id),children:[s.jsx("span",{className:R.placementLabel,children:Me}),s.jsx("span",{className:`${R.placementAnnotation} ${T.text?R.annotationVisible:""}`,children:(T.text&&lt.current.set(T.id,T.text),T.text||lt.current.get(T.id)||"")}),s.jsx("div",{className:R.placementContent,children:s.jsx(u1,{type:T.type,width:T.width,height:T.height,text:T.text})}),s.jsx("div",{className:R.deleteButton,onMouseDown:Ce=>Ce.stopPropagation(),onClick:()=>ao(T.id),children:"✕"}),uo.map(Ce=>s.jsx("div",{className:`${R.handle} ${R[`handle${Ce.charAt(0).toUpperCase()}${Ce.slice(1)}`]}`,onMouseDown:Ye=>Vn(Ye,T.id,Ce)},Ce)),_o.map(({dir:Ce,cls:Ye,arrow:He})=>s.jsx("div",{className:`${R.edgeHandle} ${Ye}`,onMouseDown:Ie=>Vn(Ie,T.id,Ce),children:He},Ce))]},T.id)})}),q&&(()=>{const T=e.find(at=>at.id===q);if(!T)return null;const ie=T.y-Sn,Me=T.x+T.width/2,ge=ie-8,Ce=ie+T.height+8,Ye=ge>200,He=Ce<window.innerHeight-100,Ie=Math.max(160,Math.min(window.innerWidth-160,Me));let Xe;return Ye?Xe={left:Ie,bottom:window.innerHeight-ge}:He?Xe={left:Ie,top:Ce}:Xe={left:Ie,top:Math.max(80,window.innerHeight/2-80)},s.jsx(Ei,{element:Nn[T.type]?.label||T.type,placeholder:co[T.type]||"Label or content text",initialValue:T.text??"",submitLabel:ke.current?"Save":"Set",onSubmit:_n,onCancel:Gt,onDelete:ke.current?()=>{_n("")}:void 0,isExiting:Be,lightMode:!r,style:Xe})})(),y&&s.jsx("div",{className:R.drawBox,style:{left:y.x,top:y.y,width:y.w,height:y.h},"data-feedback-toolbar":!0}),N&&s.jsx("div",{className:R.selectBox,style:{left:N.x,top:N.y,width:N.w,height:N.h},"data-feedback-toolbar":!0}),Y&&s.jsx("div",{className:R.sizeIndicator,style:{left:Y.x,top:Y.y},"data-feedback-toolbar":!0,children:Y.text}),Q.map((T,ie)=>s.jsx("div",{className:R.guideLine,style:T.axis==="x"?{position:"fixed",left:T.pos,top:0,width:1,bottom:0}:{position:"fixed",left:0,top:T.pos-Sn,right:0,height:1},"data-feedback-toolbar":!0},`${T.axis}-${T.pos}-${ie}`))]})}function h1(e){if(!e)return"";const t=e.scrollTop>2,n=e.scrollTop+e.clientHeight<e.scrollHeight-2;return`${t?R.fadeTop:""} ${n?R.fadeBottom:""}`}var d="currentColor",L="0.5";function p1({type:e}){switch(e){case"navigation":return s.jsxs("svg",{viewBox:"0 0 20 16",width:"20",height:"16",fill:"none",children:[s.jsx("rect",{x:"1",y:"4",width:"18",height:"8",rx:"1",stroke:d,strokeWidth:L}),s.jsx("rect",{x:"2.5",y:"7",width:"3",height:"1.5",rx:".5",fill:d,opacity:".4"}),s.jsx("rect",{x:"7",y:"7",width:"2.5",height:"1.5",rx:".5",fill:d,opacity:".25"}),s.jsx("rect",{x:"11",y:"7",width:"2.5",height:"1.5",rx:".5",fill:d,opacity:".25"})]});case"header":return s.jsxs("svg",{viewBox:"0 0 20 16",width:"20",height:"16",fill:"none",children:[s.jsx("rect",{x:"1",y:"2",width:"18",height:"12",rx:"1",stroke:d,strokeWidth:L}),s.jsx("rect",{x:"3",y:"5.5",width:"8",height:"2",rx:".5",fill:d,opacity:".35"}),s.jsx("rect",{x:"3",y:"9",width:"12",height:"1",rx:".5",fill:d,opacity:".15"})]});case"hero":return s.jsxs("svg",{viewBox:"0 0 20 16",width:"20",height:"16",fill:"none",children:[s.jsx("rect",{x:"1",y:"1",width:"18",height:"14",rx:"1",stroke:d,strokeWidth:L}),s.jsx("rect",{x:"5",y:"5",width:"10",height:"1.5",rx:".5",fill:d,opacity:".35"}),s.jsx("rect",{x:"7",y:"8",width:"6",height:"1",rx:".5",fill:d,opacity:".15"}),s.jsx("rect",{x:"7.5",y:"10.5",width:"5",height:"2.5",rx:"1",stroke:d,strokeWidth:L})]});case"section":return s.jsxs("svg",{viewBox:"0 0 20 16",width:"20",height:"16",fill:"none",children:[s.jsx("rect",{x:"1",y:"1",width:"18",height:"14",rx:"1",stroke:d,strokeWidth:L}),s.jsx("rect",{x:"3",y:"4",width:"6",height:"1",rx:".5",fill:d,opacity:".3"}),s.jsx("rect",{x:"3",y:"6.5",width:"14",height:"1",rx:".5",fill:d,opacity:".15"}),s.jsx("rect",{x:"3",y:"9",width:"10",height:"1",rx:".5",fill:d,opacity:".15"})]});case"sidebar":return s.jsxs("svg",{viewBox:"0 0 20 16",width:"20",height:"16",fill:"none",children:[s.jsx("rect",{x:"1",y:"1",width:"7",height:"14",rx:"1",stroke:d,strokeWidth:L}),s.jsx("rect",{x:"2.5",y:"4",width:"4",height:"1",rx:".5",fill:d,opacity:".3"}),s.jsx("rect",{x:"2.5",y:"6.5",width:"3.5",height:"1",rx:".5",fill:d,opacity:".15"}),s.jsx("rect",{x:"2.5",y:"9",width:"4",height:"1",rx:".5",fill:d,opacity:".15"})]});case"footer":return s.jsxs("svg",{viewBox:"0 0 20 16",width:"20",height:"16",fill:"none",children:[s.jsx("rect",{x:"1",y:"7",width:"18",height:"8",rx:"1",stroke:d,strokeWidth:L}),s.jsx("rect",{x:"3",y:"9.5",width:"4",height:"1",rx:".5",fill:d,opacity:".25"}),s.jsx("rect",{x:"9",y:"9.5",width:"4",height:"1",rx:".5",fill:d,opacity:".25"}),s.jsx("rect",{x:"15",y:"9.5",width:"3",height:"1",rx:".5",fill:d,opacity:".2"})]});case"modal":return s.jsxs("svg",{viewBox:"0 0 20 16",width:"20",height:"16",fill:"none",children:[s.jsx("rect",{x:"3",y:"2",width:"14",height:"12",rx:"1.5",stroke:d,strokeWidth:L}),s.jsx("rect",{x:"5",y:"4.5",width:"7",height:"1",rx:".5",fill:d,opacity:".3"}),s.jsx("rect",{x:"5",y:"7",width:"10",height:"1",rx:".5",fill:d,opacity:".15"}),s.jsx("rect",{x:"11",y:"11",width:"5",height:"2",rx:".75",stroke:d,strokeWidth:L})]});case"divider":return s.jsx("svg",{viewBox:"0 0 20 16",width:"20",height:"16",fill:"none",children:s.jsx("line",{x1:"2",y1:"8",x2:"18",y2:"8",stroke:d,strokeWidth:"0.5",opacity:".3"})});case"card":return s.jsxs("svg",{viewBox:"0 0 20 16",width:"20",height:"16",fill:"none",children:[s.jsx("rect",{x:"2",y:"1",width:"16",height:"14",rx:"1.5",stroke:d,strokeWidth:L}),s.jsx("rect",{x:"2",y:"1",width:"16",height:"5.5",rx:"1",fill:d,opacity:".04"}),s.jsx("rect",{x:"4",y:"8.5",width:"8",height:"1",rx:".5",fill:d,opacity:".25"}),s.jsx("rect",{x:"4",y:"11",width:"11",height:"1",rx:".5",fill:d,opacity:".12"})]});case"text":return s.jsxs("svg",{viewBox:"0 0 20 16",width:"20",height:"16",fill:"none",children:[s.jsx("rect",{x:"2",y:"4",width:"14",height:"1.5",rx:".5",fill:d,opacity:".3"}),s.jsx("rect",{x:"2",y:"7",width:"11",height:"1",rx:".5",fill:d,opacity:".15"}),s.jsx("rect",{x:"2",y:"9.5",width:"13",height:"1",rx:".5",fill:d,opacity:".15"}),s.jsx("rect",{x:"2",y:"12",width:"8",height:"1",rx:".5",fill:d,opacity:".12"})]});case"image":return s.jsxs("svg",{viewBox:"0 0 20 16",width:"20",height:"16",fill:"none",children:[s.jsx("rect",{x:"2",y:"2",width:"16",height:"12",rx:"1",stroke:d,strokeWidth:L}),s.jsx("line",{x1:"2",y1:"2",x2:"18",y2:"14",stroke:d,strokeWidth:".3",opacity:".25"}),s.jsx("line",{x1:"18",y1:"2",x2:"2",y2:"14",stroke:d,strokeWidth:".3",opacity:".25"})]});case"video":return s.jsxs("svg",{viewBox:"0 0 20 16",width:"20",height:"16",fill:"none",children:[s.jsx("rect",{x:"2",y:"2",width:"16",height:"12",rx:"1",stroke:d,strokeWidth:L}),s.jsx("path",{d:"M8.5 5.5v5l4.5-2.5z",stroke:d,strokeWidth:L,fill:d,opacity:".15"})]});case"table":return s.jsxs("svg",{viewBox:"0 0 20 16",width:"20",height:"16",fill:"none",children:[s.jsx("rect",{x:"1",y:"2",width:"18",height:"12",rx:"1",stroke:d,strokeWidth:L}),s.jsx("line",{x1:"1",y1:"5.5",x2:"19",y2:"5.5",stroke:d,strokeWidth:".3",opacity:".25"}),s.jsx("line",{x1:"1",y1:"9",x2:"19",y2:"9",stroke:d,strokeWidth:".3",opacity:".25"}),s.jsx("line",{x1:"7",y1:"2",x2:"7",y2:"14",stroke:d,strokeWidth:".3",opacity:".25"}),s.jsx("line",{x1:"13",y1:"2",x2:"13",y2:"14",stroke:d,strokeWidth:".3",opacity:".25"})]});case"grid":return s.jsxs("svg",{viewBox:"0 0 20 16",width:"20",height:"16",fill:"none",children:[s.jsx("rect",{x:"1.5",y:"2",width:"7",height:"5.5",rx:"1",stroke:d,strokeWidth:L}),s.jsx("rect",{x:"11.5",y:"2",width:"7",height:"5.5",rx:"1",stroke:d,strokeWidth:L}),s.jsx("rect",{x:"1.5",y:"9.5",width:"7",height:"5.5",rx:"1",stroke:d,strokeWidth:L}),s.jsx("rect",{x:"11.5",y:"9.5",width:"7",height:"5.5",rx:"1",stroke:d,strokeWidth:L})]});case"list":return s.jsxs("svg",{viewBox:"0 0 20 16",width:"20",height:"16",fill:"none",children:[s.jsx("circle",{cx:"3.5",cy:"4.5",r:"1",stroke:d,strokeWidth:L}),s.jsx("rect",{x:"6.5",y:"4",width:"10",height:"1",rx:".5",fill:d,opacity:".2"}),s.jsx("circle",{cx:"3.5",cy:"8",r:"1",stroke:d,strokeWidth:L}),s.jsx("rect",{x:"6.5",y:"7.5",width:"8",height:"1",rx:".5",fill:d,opacity:".2"}),s.jsx("circle",{cx:"3.5",cy:"11.5",r:"1",stroke:d,strokeWidth:L}),s.jsx("rect",{x:"6.5",y:"11",width:"11",height:"1",rx:".5",fill:d,opacity:".2"})]});case"chart":return s.jsxs("svg",{viewBox:"0 0 20 16",width:"20",height:"16",fill:"none",children:[s.jsx("rect",{x:"3",y:"9",width:"2.5",height:"4",rx:".5",fill:d,opacity:".2"}),s.jsx("rect",{x:"7",y:"6",width:"2.5",height:"7",rx:".5",fill:d,opacity:".25"}),s.jsx("rect",{x:"11",y:"3",width:"2.5",height:"10",rx:".5",fill:d,opacity:".3"}),s.jsx("rect",{x:"15",y:"5",width:"2.5",height:"8",rx:".5",fill:d,opacity:".2"})]});case"accordion":return s.jsxs("svg",{viewBox:"0 0 20 16",width:"20",height:"16",fill:"none",children:[s.jsx("rect",{x:"1.5",y:"2",width:"17",height:"4",rx:"1",stroke:d,strokeWidth:L}),s.jsx("rect",{x:"3",y:"3.5",width:"6",height:"1",rx:".5",fill:d,opacity:".25"}),s.jsx("rect",{x:"1.5",y:"7.5",width:"17",height:"3",rx:"1",stroke:d,strokeWidth:L}),s.jsx("rect",{x:"1.5",y:"12",width:"17",height:"3",rx:"1",stroke:d,strokeWidth:L})]});case"carousel":return s.jsxs("svg",{viewBox:"0 0 20 16",width:"20",height:"16",fill:"none",children:[s.jsx("rect",{x:"3",y:"2",width:"14",height:"10",rx:"1",stroke:d,strokeWidth:L}),s.jsx("path",{d:"M1.5 7L3 8.5 1.5 10",stroke:d,strokeWidth:L,opacity:".35"}),s.jsx("path",{d:"M18.5 7L17 8.5 18.5 10",stroke:d,strokeWidth:L,opacity:".35"}),s.jsx("circle",{cx:"8.5",cy:"14",r:".6",fill:d,opacity:".35"}),s.jsx("circle",{cx:"10",cy:"14",r:".6",fill:d,opacity:".15"}),s.jsx("circle",{cx:"11.5",cy:"14",r:".6",fill:d,opacity:".15"})]});case"button":return s.jsxs("svg",{viewBox:"0 0 20 16",width:"20",height:"16",fill:"none",children:[s.jsx("rect",{x:"3",y:"5",width:"14",height:"6",rx:"2",stroke:d,strokeWidth:L}),s.jsx("rect",{x:"6.5",y:"7.5",width:"7",height:"1",rx:".5",fill:d,opacity:".25"})]});case"input":return s.jsxs("svg",{viewBox:"0 0 20 16",width:"20",height:"16",fill:"none",children:[s.jsx("rect",{x:"2",y:"4",width:"5.5",height:"1",rx:".5",fill:d,opacity:".25"}),s.jsx("rect",{x:"2",y:"6.5",width:"16",height:"5.5",rx:"1",stroke:d,strokeWidth:L}),s.jsx("rect",{x:"3.5",y:"8.5",width:"7",height:"1",rx:".5",fill:d,opacity:".12"})]});case"search":return s.jsxs("svg",{viewBox:"0 0 20 16",width:"20",height:"16",fill:"none",children:[s.jsx("rect",{x:"2",y:"4.5",width:"16",height:"7",rx:"3.5",stroke:d,strokeWidth:L}),s.jsx("circle",{cx:"6",cy:"8",r:"2",stroke:d,strokeWidth:L,opacity:".3"}),s.jsx("line",{x1:"7.5",y1:"9.5",x2:"9",y2:"11",stroke:d,strokeWidth:L,opacity:".3"}),s.jsx("rect",{x:"9.5",y:"7.5",width:"6",height:"1",rx:".5",fill:d,opacity:".12"})]});case"form":return s.jsxs("svg",{viewBox:"0 0 20 16",width:"20",height:"16",fill:"none",children:[s.jsx("rect",{x:"2",y:"1.5",width:"5.5",height:"1",rx:".5",fill:d,opacity:".25"}),s.jsx("rect",{x:"2",y:"3.5",width:"16",height:"3",rx:".75",stroke:d,strokeWidth:L}),s.jsx("rect",{x:"2",y:"8",width:"7",height:"1",rx:".5",fill:d,opacity:".25"}),s.jsx("rect",{x:"2",y:"10",width:"16",height:"3",rx:".75",stroke:d,strokeWidth:L}),s.jsx("rect",{x:"12",y:"14",width:"6",height:"2",rx:".75",stroke:d,strokeWidth:L})]});case"tabs":return s.jsxs("svg",{viewBox:"0 0 20 16",width:"20",height:"16",fill:"none",children:[s.jsx("rect",{x:"1",y:"5",width:"18",height:"10",rx:"1",stroke:d,strokeWidth:L}),s.jsx("rect",{x:"1",y:"2",width:"6",height:"3.5",rx:".75",stroke:d,strokeWidth:L}),s.jsx("rect",{x:"2.5",y:"3.25",width:"3",height:"1",rx:".5",fill:d,opacity:".25"}),s.jsx("rect",{x:"7",y:"2",width:"6",height:"3.5",rx:".75",stroke:d,strokeWidth:L})]});case"dropdown":return s.jsxs("svg",{viewBox:"0 0 20 16",width:"20",height:"16",fill:"none",children:[s.jsx("rect",{x:"2",y:"2",width:"16",height:"4",rx:"1",stroke:d,strokeWidth:L}),s.jsx("rect",{x:"3.5",y:"3.5",width:"7",height:"1",rx:".5",fill:d,opacity:".2"}),s.jsx("path",{d:"M15 3.5l1.5 1.5L18 3.5",stroke:d,strokeWidth:L,opacity:".3"}),s.jsx("rect",{x:"2",y:"7",width:"16",height:"7",rx:"1",stroke:d,strokeWidth:L,strokeDasharray:"2 1",opacity:".3"})]});case"toggle":return s.jsxs("svg",{viewBox:"0 0 20 16",width:"20",height:"16",fill:"none",children:[s.jsx("rect",{x:"4",y:"5",width:"12",height:"6",rx:"3",stroke:d,strokeWidth:L}),s.jsx("circle",{cx:"13",cy:"8",r:"2",fill:d,opacity:".3"})]});case"avatar":return s.jsxs("svg",{viewBox:"0 0 20 16",width:"20",height:"16",fill:"none",children:[s.jsx("circle",{cx:"10",cy:"8",r:"6",stroke:d,strokeWidth:L}),s.jsx("circle",{cx:"10",cy:"6.5",r:"2",stroke:d,strokeWidth:L}),s.jsx("path",{d:"M6.5 13c0-2 1.5-3.5 3.5-3.5s3.5 1.5 3.5 3.5",stroke:d,strokeWidth:L})]});case"badge":return s.jsxs("svg",{viewBox:"0 0 20 16",width:"20",height:"16",fill:"none",children:[s.jsx("rect",{x:"3",y:"5",width:"14",height:"6",rx:"3",stroke:d,strokeWidth:L}),s.jsx("rect",{x:"6",y:"7.5",width:"8",height:"1",rx:".5",fill:d,opacity:".25"})]});case"breadcrumb":return s.jsxs("svg",{viewBox:"0 0 20 16",width:"20",height:"16",fill:"none",children:[s.jsx("rect",{x:"1.5",y:"7",width:"3.5",height:"1",rx:".5",fill:d,opacity:".3"}),s.jsx("path",{d:"M6.5 7l1 1-1 1",stroke:d,strokeWidth:L,opacity:".2"}),s.jsx("rect",{x:"9",y:"7",width:"3.5",height:"1",rx:".5",fill:d,opacity:".2"}),s.jsx("path",{d:"M14 7l1 1-1 1",stroke:d,strokeWidth:L,opacity:".2"}),s.jsx("rect",{x:"16.5",y:"7",width:"2",height:"1",rx:".5",fill:d,opacity:".15"})]});case"pagination":return s.jsxs("svg",{viewBox:"0 0 20 16",width:"20",height:"16",fill:"none",children:[s.jsx("rect",{x:"2",y:"5.5",width:"3.5",height:"5",rx:"1",stroke:d,strokeWidth:L}),s.jsx("rect",{x:"6.5",y:"5.5",width:"3.5",height:"5",rx:"1",stroke:d,strokeWidth:L}),s.jsx("rect",{x:"11",y:"5.5",width:"3.5",height:"5",rx:"1",fill:d,opacity:".15",stroke:d,strokeWidth:L}),s.jsx("rect",{x:"15.5",y:"5.5",width:"3.5",height:"5",rx:"1",stroke:d,strokeWidth:L})]});case"progress":return s.jsxs("svg",{viewBox:"0 0 20 16",width:"20",height:"16",fill:"none",children:[s.jsx("rect",{x:"2",y:"7",width:"16",height:"2",rx:"1",stroke:d,strokeWidth:L}),s.jsx("rect",{x:"2",y:"7",width:"10",height:"2",rx:"1",fill:d,opacity:".2"})]});case"toast":return s.jsxs("svg",{viewBox:"0 0 20 16",width:"20",height:"16",fill:"none",children:[s.jsx("rect",{x:"2",y:"4",width:"16",height:"8",rx:"1.5",stroke:d,strokeWidth:L}),s.jsx("circle",{cx:"5",cy:"8",r:"1.5",stroke:d,strokeWidth:L,opacity:".3"}),s.jsx("rect",{x:"8",y:"6.5",width:"7",height:"1",rx:".5",fill:d,opacity:".25"}),s.jsx("rect",{x:"8",y:"9",width:"5",height:"1",rx:".5",fill:d,opacity:".12"})]});case"tooltip":return s.jsxs("svg",{viewBox:"0 0 20 16",width:"20",height:"16",fill:"none",children:[s.jsx("rect",{x:"3",y:"3",width:"14",height:"7",rx:"1.5",stroke:d,strokeWidth:L}),s.jsx("rect",{x:"5.5",y:"5.5",width:"9",height:"1",rx:".5",fill:d,opacity:".25"}),s.jsx("path",{d:"M9 10l1 2.5 1-2.5",stroke:d,strokeWidth:L})]});case"pricing":return s.jsxs("svg",{viewBox:"0 0 20 16",width:"20",height:"16",fill:"none",children:[s.jsx("rect",{x:"2",y:"1",width:"16",height:"14",rx:"1.5",stroke:d,strokeWidth:L}),s.jsx("rect",{x:"6",y:"3",width:"8",height:"1.5",rx:".5",fill:d,opacity:".25"}),s.jsx("rect",{x:"7",y:"5.5",width:"6",height:"2",rx:".5",fill:d,opacity:".15"}),s.jsx("rect",{x:"5",y:"9",width:"10",height:"1",rx:".5",fill:d,opacity:".1"}),s.jsx("rect",{x:"5",y:"11",width:"10",height:"1",rx:".5",fill:d,opacity:".1"}),s.jsx("rect",{x:"6",y:"13",width:"8",height:"1.5",rx:".5",fill:d,opacity:".2"})]});case"testimonial":return s.jsxs("svg",{viewBox:"0 0 20 16",width:"20",height:"16",fill:"none",children:[s.jsx("rect",{x:"2",y:"1",width:"16",height:"14",rx:"1.5",stroke:d,strokeWidth:L}),s.jsx("text",{x:"4",y:"5.5",fontSize:"4",fill:d,opacity:".2",fontFamily:"serif",children:"“"}),s.jsx("rect",{x:"4",y:"7",width:"12",height:"1",rx:".5",fill:d,opacity:".15"}),s.jsx("rect",{x:"4",y:"9",width:"9",height:"1",rx:".5",fill:d,opacity:".12"}),s.jsx("circle",{cx:"5.5",cy:"12.5",r:"1.5",stroke:d,strokeWidth:L,opacity:".25"}),s.jsx("rect",{x:"8",y:"12",width:"5",height:"1",rx:".5",fill:d,opacity:".15"})]});case"cta":return s.jsxs("svg",{viewBox:"0 0 20 16",width:"20",height:"16",fill:"none",children:[s.jsx("rect",{x:"1",y:"2",width:"18",height:"12",rx:"1",stroke:d,strokeWidth:L}),s.jsx("rect",{x:"5",y:"4.5",width:"10",height:"1.5",rx:".5",fill:d,opacity:".3"}),s.jsx("rect",{x:"6",y:"7.5",width:"8",height:"1",rx:".5",fill:d,opacity:".15"}),s.jsx("rect",{x:"7",y:"10",width:"6",height:"2.5",rx:"1",stroke:d,strokeWidth:L})]});case"alert":return s.jsxs("svg",{viewBox:"0 0 20 16",width:"20",height:"16",fill:"none",children:[s.jsx("rect",{x:"2",y:"4",width:"16",height:"8",rx:"1.5",stroke:d,strokeWidth:L}),s.jsx("circle",{cx:"6",cy:"8",r:"2",stroke:d,strokeWidth:L,opacity:".3"}),s.jsx("line",{x1:"6",y1:"7",x2:"6",y2:"8.5",stroke:d,strokeWidth:"0.6",opacity:".5"}),s.jsx("circle",{cx:"6",cy:"9.3",r:".3",fill:d,opacity:".5"}),s.jsx("rect",{x:"9.5",y:"7",width:"6",height:"1",rx:".5",fill:d,opacity:".2"})]});case"banner":return s.jsxs("svg",{viewBox:"0 0 20 16",width:"20",height:"16",fill:"none",children:[s.jsx("rect",{x:"1",y:"5",width:"18",height:"6",rx:"1",stroke:d,strokeWidth:L}),s.jsx("rect",{x:"4",y:"7.5",width:"8",height:"1",rx:".5",fill:d,opacity:".25"}),s.jsx("rect",{x:"14",y:"7",width:"3.5",height:"2",rx:".75",stroke:d,strokeWidth:L})]});case"stat":return s.jsxs("svg",{viewBox:"0 0 20 16",width:"20",height:"16",fill:"none",children:[s.jsx("rect",{x:"3",y:"2",width:"14",height:"12",rx:"1.5",stroke:d,strokeWidth:L}),s.jsx("rect",{x:"6",y:"4.5",width:"8",height:"1",rx:".5",fill:d,opacity:".15"}),s.jsx("rect",{x:"5",y:"7",width:"10",height:"2.5",rx:".5",fill:d,opacity:".3"}),s.jsx("rect",{x:"7",y:"11",width:"6",height:"1",rx:".5",fill:d,opacity:".12"})]});case"stepper":return s.jsxs("svg",{viewBox:"0 0 20 16",width:"20",height:"16",fill:"none",children:[s.jsx("circle",{cx:"4",cy:"8",r:"2",fill:d,opacity:".2",stroke:d,strokeWidth:L}),s.jsx("line",{x1:"6",y1:"8",x2:"8",y2:"8",stroke:d,strokeWidth:".4",opacity:".3"}),s.jsx("circle",{cx:"10",cy:"8",r:"2",stroke:d,strokeWidth:L}),s.jsx("line",{x1:"12",y1:"8",x2:"14",y2:"8",stroke:d,strokeWidth:".4",opacity:".3"}),s.jsx("circle",{cx:"16",cy:"8",r:"2",stroke:d,strokeWidth:L})]});case"tag":return s.jsxs("svg",{viewBox:"0 0 20 16",width:"20",height:"16",fill:"none",children:[s.jsx("rect",{x:"3",y:"5",width:"14",height:"6",rx:"1.5",stroke:d,strokeWidth:L}),s.jsx("rect",{x:"5.5",y:"7.5",width:"6",height:"1",rx:".5",fill:d,opacity:".25"}),s.jsx("line",{x1:"14",y1:"6.5",x2:"15.5",y2:"9.5",stroke:d,strokeWidth:L,opacity:".2"}),s.jsx("line",{x1:"15.5",y1:"6.5",x2:"14",y2:"9.5",stroke:d,strokeWidth:L,opacity:".2"})]});case"rating":return s.jsxs("svg",{viewBox:"0 0 20 16",width:"20",height:"16",fill:"none",children:[s.jsx("path",{d:"M4 5.5l1 2 2.2.3-1.6 1.5.4 2.2L4 10.3l-2 1.2.4-2.2L.8 7.8 3 7.5z",fill:d,opacity:".25"}),s.jsx("path",{d:"M10 5.5l1 2 2.2.3-1.6 1.5.4 2.2L10 10.3l-2 1.2.4-2.2L6.8 7.8 9 7.5z",fill:d,opacity:".25"}),s.jsx("path",{d:"M16 5.5l1 2 2.2.3-1.6 1.5.4 2.2L16 10.3l-2 1.2.4-2.2-1.6-1.5 2.2-.3z",stroke:d,strokeWidth:L,opacity:".25"})]});case"map":return s.jsxs("svg",{viewBox:"0 0 20 16",width:"20",height:"16",fill:"none",children:[s.jsx("rect",{x:"2",y:"2",width:"16",height:"12",rx:"1",stroke:d,strokeWidth:L}),s.jsx("line",{x1:"2",y1:"6",x2:"18",y2:"10",stroke:d,strokeWidth:".3",opacity:".15"}),s.jsx("line",{x1:"7",y1:"2",x2:"11",y2:"14",stroke:d,strokeWidth:".3",opacity:".15"}),s.jsx("path",{d:"M10 5c-1.7 0-3 1.3-3 3 0 2.5 3 5 3 5s3-2.5 3-5c0-1.7-1.3-3-3-3z",fill:d,opacity:".15",stroke:d,strokeWidth:L})]});case"timeline":return s.jsxs("svg",{viewBox:"0 0 20 16",width:"20",height:"16",fill:"none",children:[s.jsx("line",{x1:"5",y1:"2",x2:"5",y2:"14",stroke:d,strokeWidth:".4",opacity:".25"}),s.jsx("circle",{cx:"5",cy:"4",r:"1.5",fill:d,opacity:".2",stroke:d,strokeWidth:L}),s.jsx("rect",{x:"8",y:"3",width:"8",height:"1",rx:".5",fill:d,opacity:".25"}),s.jsx("circle",{cx:"5",cy:"8.5",r:"1.5",stroke:d,strokeWidth:L}),s.jsx("rect",{x:"8",y:"7.5",width:"6",height:"1",rx:".5",fill:d,opacity:".15"}),s.jsx("circle",{cx:"5",cy:"13",r:"1.5",stroke:d,strokeWidth:L}),s.jsx("rect",{x:"8",y:"12",width:"7",height:"1",rx:".5",fill:d,opacity:".15"})]});case"fileUpload":return s.jsxs("svg",{viewBox:"0 0 20 16",width:"20",height:"16",fill:"none",children:[s.jsx("rect",{x:"3",y:"2",width:"14",height:"12",rx:"1.5",stroke:d,strokeWidth:L,strokeDasharray:"2 1"}),s.jsx("path",{d:"M10 10V5.5m0 0L7.5 8m2.5-2.5L12.5 8",stroke:d,strokeWidth:L,opacity:".3"}),s.jsx("rect",{x:"7",y:"11.5",width:"6",height:"1",rx:".5",fill:d,opacity:".15"})]});case"codeBlock":return s.jsxs("svg",{viewBox:"0 0 20 16",width:"20",height:"16",fill:"none",children:[s.jsx("rect",{x:"2",y:"2",width:"16",height:"12",rx:"1",stroke:d,strokeWidth:L}),s.jsx("circle",{cx:"4",cy:"4",r:".6",fill:d,opacity:".3"}),s.jsx("circle",{cx:"5.5",cy:"4",r:".6",fill:d,opacity:".3"}),s.jsx("circle",{cx:"7",cy:"4",r:".6",fill:d,opacity:".3"}),s.jsx("rect",{x:"4",y:"7",width:"7",height:"1",rx:".5",fill:d,opacity:".2"}),s.jsx("rect",{x:"6",y:"9",width:"5",height:"1",rx:".5",fill:d,opacity:".15"}),s.jsx("rect",{x:"4",y:"11",width:"8",height:"1",rx:".5",fill:d,opacity:".12"})]});case"calendar":return s.jsxs("svg",{viewBox:"0 0 20 16",width:"20",height:"16",fill:"none",children:[s.jsx("rect",{x:"2",y:"3",width:"16",height:"12",rx:"1",stroke:d,strokeWidth:L}),s.jsx("line",{x1:"2",y1:"6.5",x2:"18",y2:"6.5",stroke:d,strokeWidth:".4",opacity:".25"}),s.jsx("rect",{x:"5",y:"4",width:"1",height:"1.5",rx:".3",fill:d,opacity:".2"}),s.jsx("rect",{x:"14",y:"4",width:"1",height:"1.5",rx:".3",fill:d,opacity:".2"}),s.jsx("circle",{cx:"7",cy:"9",r:".6",fill:d,opacity:".2"}),s.jsx("circle",{cx:"10",cy:"9",r:".6",fill:d,opacity:".2"}),s.jsx("circle",{cx:"13",cy:"9",r:".6",fill:d,opacity:".3"}),s.jsx("circle",{cx:"7",cy:"12",r:".6",fill:d,opacity:".2"}),s.jsx("circle",{cx:"10",cy:"12",r:".6",fill:d,opacity:".2"})]});case"notification":return s.jsxs("svg",{viewBox:"0 0 20 16",width:"20",height:"16",fill:"none",children:[s.jsx("rect",{x:"2",y:"3",width:"16",height:"10",rx:"1.5",stroke:d,strokeWidth:L}),s.jsx("circle",{cx:"5.5",cy:"8",r:"2",stroke:d,strokeWidth:L,opacity:".25"}),s.jsx("rect",{x:"9",y:"6",width:"6",height:"1",rx:".5",fill:d,opacity:".25"}),s.jsx("rect",{x:"9",y:"8.5",width:"4.5",height:"1",rx:".5",fill:d,opacity:".12"}),s.jsx("circle",{cx:"16.5",cy:"4.5",r:"1.5",fill:d,opacity:".25"})]});case"productCard":return s.jsxs("svg",{viewBox:"0 0 20 16",width:"20",height:"16",fill:"none",children:[s.jsx("rect",{x:"3",y:"1",width:"14",height:"14",rx:"1.5",stroke:d,strokeWidth:L}),s.jsx("rect",{x:"3",y:"1",width:"14",height:"6",rx:"1",fill:d,opacity:".04"}),s.jsx("rect",{x:"5",y:"8.5",width:"7",height:"1",rx:".5",fill:d,opacity:".25"}),s.jsx("rect",{x:"5",y:"10.5",width:"4",height:"1.5",rx:".5",fill:d,opacity:".15"}),s.jsx("rect",{x:"12",y:"12",width:"4",height:"2",rx:".75",stroke:d,strokeWidth:L})]});case"profile":return s.jsxs("svg",{viewBox:"0 0 20 16",width:"20",height:"16",fill:"none",children:[s.jsx("circle",{cx:"10",cy:"5",r:"3",stroke:d,strokeWidth:L}),s.jsx("rect",{x:"5",y:"10",width:"10",height:"1.5",rx:".5",fill:d,opacity:".25"}),s.jsx("rect",{x:"7",y:"12.5",width:"6",height:"1",rx:".5",fill:d,opacity:".12"})]});case"drawer":return s.jsxs("svg",{viewBox:"0 0 20 16",width:"20",height:"16",fill:"none",children:[s.jsx("rect",{x:"9",y:"1",width:"10",height:"14",rx:"1",stroke:d,strokeWidth:L}),s.jsx("rect",{x:"10.5",y:"4",width:"5",height:"1",rx:".5",fill:d,opacity:".25"}),s.jsx("rect",{x:"10.5",y:"6.5",width:"7",height:"1",rx:".5",fill:d,opacity:".15"}),s.jsx("rect",{x:"10.5",y:"9",width:"6",height:"1",rx:".5",fill:d,opacity:".15"}),s.jsx("rect",{x:"1",y:"1",width:"7",height:"14",rx:"1",stroke:d,strokeWidth:L,opacity:".15"})]});case"popover":return s.jsxs("svg",{viewBox:"0 0 20 16",width:"20",height:"16",fill:"none",children:[s.jsx("rect",{x:"3",y:"2",width:"14",height:"9",rx:"1.5",stroke:d,strokeWidth:L}),s.jsx("rect",{x:"5",y:"4.5",width:"8",height:"1",rx:".5",fill:d,opacity:".25"}),s.jsx("rect",{x:"5",y:"7",width:"6",height:"1",rx:".5",fill:d,opacity:".15"}),s.jsx("path",{d:"M9 11l1 2.5 1-2.5",stroke:d,strokeWidth:L})]});case"logo":return s.jsxs("svg",{viewBox:"0 0 20 16",width:"20",height:"16",fill:"none",children:[s.jsx("rect",{x:"2",y:"3",width:"10",height:"10",rx:"2",stroke:d,strokeWidth:L}),s.jsx("path",{d:"M5 9.5l2-4 2 4",stroke:d,strokeWidth:L,opacity:".3"}),s.jsx("rect",{x:"14",y:"6",width:"4",height:"1",rx:".5",fill:d,opacity:".2"}),s.jsx("rect",{x:"14",y:"8.5",width:"3",height:"1",rx:".5",fill:d,opacity:".12"})]});case"faq":return s.jsxs("svg",{viewBox:"0 0 20 16",width:"20",height:"16",fill:"none",children:[s.jsx("text",{x:"2.5",y:"5.5",fontSize:"4",fill:d,opacity:".3",fontWeight:"bold",children:"?"}),s.jsx("rect",{x:"7",y:"3",width:"10",height:"1",rx:".5",fill:d,opacity:".25"}),s.jsx("rect",{x:"7",y:"5.5",width:"8",height:"1",rx:".5",fill:d,opacity:".12"}),s.jsx("text",{x:"2.5",y:"11.5",fontSize:"4",fill:d,opacity:".3",fontWeight:"bold",children:"?"}),s.jsx("rect",{x:"7",y:"9",width:"9",height:"1",rx:".5",fill:d,opacity:".25"}),s.jsx("rect",{x:"7",y:"11.5",width:"7",height:"1",rx:".5",fill:d,opacity:".12"})]});case"gallery":return s.jsxs("svg",{viewBox:"0 0 20 16",width:"20",height:"16",fill:"none",children:[s.jsx("rect",{x:"1.5",y:"1.5",width:"5",height:"5",rx:".75",stroke:d,strokeWidth:L}),s.jsx("rect",{x:"7.5",y:"1.5",width:"5",height:"5",rx:".75",stroke:d,strokeWidth:L}),s.jsx("rect",{x:"13.5",y:"1.5",width:"5",height:"5",rx:".75",stroke:d,strokeWidth:L}),s.jsx("rect",{x:"1.5",y:"9.5",width:"5",height:"5",rx:".75",stroke:d,strokeWidth:L}),s.jsx("rect",{x:"7.5",y:"9.5",width:"5",height:"5",rx:".75",stroke:d,strokeWidth:L}),s.jsx("rect",{x:"13.5",y:"9.5",width:"5",height:"5",rx:".75",stroke:d,strokeWidth:L})]});case"checkbox":return s.jsxs("svg",{viewBox:"0 0 20 16",width:"20",height:"16",fill:"none",children:[s.jsx("rect",{x:"5",y:"4",width:"8",height:"8",rx:"1.5",stroke:d,strokeWidth:L}),s.jsx("path",{d:"M7.5 8l1.5 1.5 3-3",stroke:d,strokeWidth:L,opacity:".35"})]});case"radio":return s.jsxs("svg",{viewBox:"0 0 20 16",width:"20",height:"16",fill:"none",children:[s.jsx("circle",{cx:"10",cy:"8",r:"4",stroke:d,strokeWidth:L}),s.jsx("circle",{cx:"10",cy:"8",r:"2",fill:d,opacity:".3"})]});case"slider":return s.jsxs("svg",{viewBox:"0 0 20 16",width:"20",height:"16",fill:"none",children:[s.jsx("rect",{x:"2",y:"7.5",width:"16",height:"1",rx:".5",fill:d,opacity:".15"}),s.jsx("rect",{x:"2",y:"7.5",width:"10",height:"1",rx:".5",fill:d,opacity:".25"}),s.jsx("circle",{cx:"12",cy:"8",r:"2.5",stroke:d,strokeWidth:L})]});case"datePicker":return s.jsxs("svg",{viewBox:"0 0 20 16",width:"20",height:"16",fill:"none",children:[s.jsx("rect",{x:"2",y:"1",width:"16",height:"5",rx:"1",stroke:d,strokeWidth:L}),s.jsx("rect",{x:"3.5",y:"3",width:"5",height:"1",rx:".5",fill:d,opacity:".2"}),s.jsx("rect",{x:"14",y:"2.5",width:"2.5",height:"2",rx:".5",fill:d,opacity:".12"}),s.jsx("rect",{x:"2",y:"7",width:"16",height:"8",rx:"1",stroke:d,strokeWidth:L,strokeDasharray:"2 1",opacity:".3"}),s.jsx("circle",{cx:"6",cy:"10",r:".6",fill:d,opacity:".2"}),s.jsx("circle",{cx:"10",cy:"10",r:".6",fill:d,opacity:".3"}),s.jsx("circle",{cx:"14",cy:"10",r:".6",fill:d,opacity:".2"}),s.jsx("circle",{cx:"6",cy:"13",r:".6",fill:d,opacity:".2"}),s.jsx("circle",{cx:"10",cy:"13",r:".6",fill:d,opacity:".2"})]});case"skeleton":return s.jsxs("svg",{viewBox:"0 0 20 16",width:"20",height:"16",fill:"none",children:[s.jsx("rect",{x:"2",y:"2",width:"16",height:"3",rx:"1",fill:d,opacity:".08"}),s.jsx("rect",{x:"2",y:"7",width:"10",height:"2",rx:".75",fill:d,opacity:".08"}),s.jsx("rect",{x:"2",y:"11",width:"13",height:"2",rx:".75",fill:d,opacity:".08"})]});case"chip":return s.jsxs("svg",{viewBox:"0 0 20 16",width:"20",height:"16",fill:"none",children:[s.jsx("rect",{x:"1.5",y:"5",width:"10",height:"6",rx:"3",fill:d,opacity:".08",stroke:d,strokeWidth:L}),s.jsx("rect",{x:"4",y:"7.5",width:"4",height:"1",rx:".5",fill:d,opacity:".25"}),s.jsx("line",{x1:"9.5",y1:"6.5",x2:"10.5",y2:"9.5",stroke:d,strokeWidth:L,opacity:".2"}),s.jsx("line",{x1:"10.5",y1:"6.5",x2:"9.5",y2:"9.5",stroke:d,strokeWidth:L,opacity:".2"}),s.jsx("rect",{x:"13",y:"5",width:"5.5",height:"6",rx:"3",stroke:d,strokeWidth:L,opacity:".25"})]});case"icon":return s.jsx("svg",{viewBox:"0 0 20 16",width:"20",height:"16",fill:"none",children:s.jsx("path",{d:"M10 3l1.5 3 3.5.5-2.5 2.5.5 3.5L10 11l-3 1.5.5-3.5L5 6.5l3.5-.5z",stroke:d,strokeWidth:L,opacity:".3"})});case"spinner":return s.jsxs("svg",{viewBox:"0 0 20 16",width:"20",height:"16",fill:"none",children:[s.jsx("circle",{cx:"10",cy:"8",r:"5",stroke:d,strokeWidth:L,opacity:".12"}),s.jsx("path",{d:"M10 3a5 5 0 0 1 5 5",stroke:d,strokeWidth:L,opacity:".35",strokeLinecap:"round"})]});case"feature":return s.jsxs("svg",{viewBox:"0 0 20 16",width:"20",height:"16",fill:"none",children:[s.jsx("rect",{x:"2",y:"2",width:"5",height:"5",rx:"1.5",stroke:d,strokeWidth:L}),s.jsx("path",{d:"M4.5 3.5v3m-1.5-1.5h3",stroke:d,strokeWidth:L,opacity:".25"}),s.jsx("rect",{x:"9",y:"2.5",width:"8",height:"1.5",rx:".5",fill:d,opacity:".25"}),s.jsx("rect",{x:"9",y:"5.5",width:"6",height:"1",rx:".5",fill:d,opacity:".12"}),s.jsx("rect",{x:"2",y:"10",width:"5",height:"5",rx:"1.5",stroke:d,strokeWidth:L}),s.jsx("rect",{x:"9",y:"10.5",width:"7",height:"1.5",rx:".5",fill:d,opacity:".25"}),s.jsx("rect",{x:"9",y:"13.5",width:"5",height:"1",rx:".5",fill:d,opacity:".12"})]});case"team":return s.jsxs("svg",{viewBox:"0 0 20 16",width:"20",height:"16",fill:"none",children:[s.jsx("circle",{cx:"5",cy:"5",r:"2.5",stroke:d,strokeWidth:L}),s.jsx("rect",{x:"2.5",y:"9",width:"5",height:"1",rx:".5",fill:d,opacity:".2"}),s.jsx("circle",{cx:"15",cy:"5",r:"2.5",stroke:d,strokeWidth:L}),s.jsx("rect",{x:"12.5",y:"9",width:"5",height:"1",rx:".5",fill:d,opacity:".2"}),s.jsx("circle",{cx:"10",cy:"5",r:"2.5",stroke:d,strokeWidth:L,opacity:".5"}),s.jsx("rect",{x:"7.5",y:"9",width:"5",height:"1",rx:".5",fill:d,opacity:".15"}),s.jsx("rect",{x:"4",y:"12",width:"12",height:"1",rx:".5",fill:d,opacity:".1"})]});case"login":return s.jsxs("svg",{viewBox:"0 0 20 16",width:"20",height:"16",fill:"none",children:[s.jsx("rect",{x:"3",y:"1",width:"14",height:"14",rx:"1.5",stroke:d,strokeWidth:L}),s.jsx("rect",{x:"6",y:"3",width:"8",height:"1.5",rx:".5",fill:d,opacity:".25"}),s.jsx("rect",{x:"5",y:"5.5",width:"10",height:"3",rx:".75",stroke:d,strokeWidth:L}),s.jsx("rect",{x:"5",y:"9.5",width:"10",height:"3",rx:".75",stroke:d,strokeWidth:L}),s.jsx("rect",{x:"6.5",y:"13.5",width:"7",height:"2",rx:".75",fill:d,opacity:".2"})]});case"contact":return s.jsxs("svg",{viewBox:"0 0 20 16",width:"20",height:"16",fill:"none",children:[s.jsx("rect",{x:"2",y:"1",width:"16",height:"14",rx:"1.5",stroke:d,strokeWidth:L}),s.jsx("rect",{x:"4",y:"3",width:"5",height:"1",rx:".5",fill:d,opacity:".2"}),s.jsx("rect",{x:"4",y:"5",width:"12",height:"2.5",rx:".75",stroke:d,strokeWidth:L}),s.jsx("rect",{x:"4",y:"8.5",width:"12",height:"4",rx:".75",stroke:d,strokeWidth:L}),s.jsx("rect",{x:"11",y:"13.5",width:"5",height:"1.5",rx:".5",fill:d,opacity:".2"})]});default:return null}}function m1({activeType:e,onSelect:t,onDragStart:n,scrollRef:o,fadeClass:r,blankCanvas:l}){return s.jsx("div",{ref:o,className:`${R.placeScroll} ${r||""}`,children:dp.map(i=>s.jsxs("div",{className:R.paletteSection,children:[s.jsx("div",{className:R.paletteSectionTitle,children:i.section}),i.items.map(a=>s.jsxs("div",{className:`${R.paletteItem} ${e===a.type?R.active:""} ${l?R.wireframe:""}`,onClick:()=>t(a.type),onMouseDown:c=>{c.button===0&&n(a.type,c)},children:[s.jsx("div",{className:R.paletteItemIcon,children:s.jsx(p1,{type:a.type})}),s.jsx("span",{className:R.paletteItemLabel,children:a.label})]},a.type))]},i.section))})}function g1({value:e,suffix:t}){const[n,o]=_.useState(null),[r,l]=_.useState(t),[i,a]=_.useState("up"),c=_.useRef(e),p=_.useRef(t),m=_.useRef(),w=n!==null&&r!==t;return _.useEffect(()=>{if(e!==c.current){if(e===0){c.current=e,p.current=t,o(null);return}a(e>c.current?"up":"down"),o(c.current),l(p.current),c.current=e,p.current=t,clearTimeout(m.current),m.current=fe(()=>o(null),250)}else p.current=t},[e,t]),n===null?s.jsxs(s.Fragment,{children:[e,t?` ${t}`:""]}):w?s.jsxs("span",{className:R.rollingWrap,children:[s.jsxs("span",{style:{visibility:"hidden"},children:[e," ",t]}),s.jsxs("span",{className:`${R.rollingNum} ${i==="up"?R.exitUp:R.exitDown}`,children:[n," ",r]},`o${n}-${e}`),s.jsxs("span",{className:`${R.rollingNum} ${i==="up"?R.enterUp:R.enterDown}`,children:[e," ",t]},`n${e}`)]}):s.jsxs(s.Fragment,{children:[s.jsxs("span",{className:R.rollingWrap,children:[s.jsx("span",{style:{visibility:"hidden"},children:e}),s.jsx("span",{className:`${R.rollingNum} ${i==="up"?R.exitUp:R.exitDown}`,children:n},`o${n}-${e}`),s.jsx("span",{className:`${R.rollingNum} ${i==="up"?R.enterUp:R.enterDown}`,children:e},`n${e}`)]}),t?` ${t}`:""]})}function y1({activeType:e,onSelect:t,isDarkMode:n,sectionCount:o,onDetectSections:r,visible:l,onExited:i,placementCount:a,onClearPlacements:c,onDragStart:p,blankCanvas:m,onBlankCanvasChange:w,wireframePurpose:g,onWireframePurposeChange:$,Tooltip:k}){const[j,M]=_.useState(!1),[f,y]=_.useState("exit"),[b,N]=_.useState(!1),[W,Y]=_.useState(!0),D=_.useRef(0),Q=_.useRef(""),he=_.useRef(0),q=_.useRef(),de=_.useRef(null),[Be,Ae]=_.useState("");_.useEffect(()=>(l?(M(!0),clearTimeout(q.current),cancelAnimationFrame(he.current),he.current=Lr(()=>{he.current=Lr(()=>{y("enter")})})):(cancelAnimationFrame(he.current),y("exit"),clearTimeout(q.current),q.current=fe(()=>{M(!1),i?.()},200)),()=>cancelAnimationFrame(he.current)),[l]);const ke=a>0||o>0,Ne=a+o;return Ne>0&&(D.current=Ne,Q.current=m?Ne===1?"Component":"Components":Ne===1?"Change":"Changes"),_.useEffect(()=>{if(ke)b?Y(!1):(Y(!0),N(!0),Lr(()=>{Lr(()=>{Y(!1)})}));else{Y(!0);const oe=fe(()=>N(!1),300);return()=>clearTimeout(oe)}},[ke]),_.useEffect(()=>{if(!j)return;const oe=de.current;if(!oe)return;const lt=()=>Ae(h1(oe));lt(),oe.addEventListener("scroll",lt,{passive:!0});const I=new ResizeObserver(lt);return I.observe(oe),()=>{oe.removeEventListener("scroll",lt),I.disconnect()}},[j]),j?s.jsxs("div",{className:`${R.palette} ${R[f]} ${n?"":R.light}`,"data-feedback-toolbar":!0,"data-agentation-palette":!0,onClick:oe=>oe.stopPropagation(),onMouseDown:oe=>oe.stopPropagation(),onTransitionEnd:oe=>{oe.target===oe.currentTarget&&(l||(clearTimeout(q.current),M(!1),y("exit"),i?.()))},children:[s.jsxs("div",{className:R.paletteHeader,children:[s.jsx("div",{className:R.paletteHeaderTitle,children:"Layout Mode"}),s.jsxs("div",{className:R.paletteHeaderDesc,children:["Rearrange and resize existing elements, add new components, and explore layout ideas. Agent results may vary."," ",s.jsx("a",{href:"https://agentation.dev/features#layout-mode",target:"_blank",rel:"noopener noreferrer",children:"Learn more."})]})]}),s.jsxs("div",{className:`${R.canvasToggle} ${m?R.active:""}`,onClick:()=>w(!m),children:[s.jsx("span",{className:R.canvasToggleIcon,children:s.jsxs("svg",{viewBox:"0 0 14 14",width:"14",height:"14",fill:"none",children:[s.jsx("rect",{x:"1",y:"1",width:"12",height:"12",rx:"2",stroke:"currentColor",strokeWidth:"1"}),s.jsx("circle",{cx:"4.5",cy:"4.5",r:"0.8",fill:"currentColor",opacity:".6"}),s.jsx("circle",{cx:"7",cy:"4.5",r:"0.8",fill:"currentColor",opacity:".6"}),s.jsx("circle",{cx:"9.5",cy:"4.5",r:"0.8",fill:"currentColor",opacity:".6"}),s.jsx("circle",{cx:"4.5",cy:"7",r:"0.8",fill:"currentColor",opacity:".6"}),s.jsx("circle",{cx:"7",cy:"7",r:"0.8",fill:"currentColor",opacity:".6"}),s.jsx("circle",{cx:"9.5",cy:"7",r:"0.8",fill:"currentColor",opacity:".6"}),s.jsx("circle",{cx:"4.5",cy:"9.5",r:"0.8",fill:"currentColor",opacity:".6"}),s.jsx("circle",{cx:"7",cy:"9.5",r:"0.8",fill:"currentColor",opacity:".6"}),s.jsx("circle",{cx:"9.5",cy:"9.5",r:"0.8",fill:"currentColor",opacity:".6"})]})}),s.jsx("span",{className:R.canvasToggleLabel,children:"Wireframe New Page"})]}),s.jsx("div",{className:`${R.wireframePurposeWrap} ${m?"":R.collapsed}`,children:s.jsx("div",{className:R.wireframePurposeInner,children:s.jsx("textarea",{className:R.wireframePurposeInput,placeholder:"Describe this page to provide additional context for your agent.",value:g,onChange:oe=>$(oe.target.value),rows:2})})}),s.jsx(m1,{activeType:e,onSelect:t,onDragStart:p,scrollRef:de,fadeClass:Be,blankCanvas:m}),b&&s.jsx("div",{className:`${R.paletteFooterWrap} ${W?R.footerHidden:""}`,children:s.jsx("div",{className:R.paletteFooterInner,children:s.jsx("div",{className:R.paletteFooterInnerContent,children:s.jsxs("div",{className:R.paletteFooter,children:[s.jsx("span",{className:R.paletteFooterCount,children:s.jsx(g1,{value:D.current,suffix:Q.current})}),s.jsx("button",{className:R.paletteFooterClear,onClick:c,children:"Clear"})]})})})})]}):null}function Qr(e){if(e.parentElement)return e.parentElement;const t=e.getRootNode();return t instanceof ShadowRoot?t.host:null}function Ut(e,t){let n=e;for(;n;){if(n.matches(t))return n;n=Qr(n)}return null}function x1(e,t=4){const n=[];let o=e,r=0;for(;o&&r<t;){const l=o.tagName.toLowerCase();if(l==="html"||l==="body")break;let i=l;if(o.id)i=`#${o.id}`;else if(o.className&&typeof o.className=="string"){const c=o.className.split(/\s+/).find(p=>p.length>2&&!p.match(/^[a-z]{1,2}$/)&&!p.match(/[A-Z0-9]{5,}/));c&&(i=`.${c.split("_")[0]}`)}const a=Qr(o);!o.parentElement&&a&&(i=`⟨shadow⟩ ${i}`),n.unshift(i),o=a,r++}return n.join(" > ")}function Or(e){const t=x1(e);if(e.dataset.element)return{name:e.dataset.element,path:t};const n=e.tagName.toLowerCase();if(["path","circle","rect","line","g"].includes(n)){const o=Ut(e,"svg");if(o){const r=Qr(o);if(r instanceof HTMLElement)return{name:`graphic in ${Or(r).name}`,path:t}}return{name:"graphic element",path:t}}if(n==="svg"){const o=Qr(e);if(o?.tagName.toLowerCase()==="button"){const r=o.textContent?.trim();return{name:r?`icon in "${r}" button`:"button icon",path:t}}return{name:"icon",path:t}}if(n==="button"){const o=e.textContent?.trim(),r=e.getAttribute("aria-label");return r?{name:`button [${r}]`,path:t}:{name:o?`button "${o.slice(0,25)}"`:"button",path:t}}if(n==="a"){const o=e.textContent?.trim(),r=e.getAttribute("href");return o?{name:`link "${o.slice(0,25)}"`,path:t}:r?{name:`link to ${r.slice(0,30)}`,path:t}:{name:"link",path:t}}if(n==="input"){const o=e.getAttribute("type")||"text",r=e.getAttribute("placeholder"),l=e.getAttribute("name");return r?{name:`input "${r}"`,path:t}:l?{name:`input [${l}]`,path:t}:{name:`${o} input`,path:t}}if(["h1","h2","h3","h4","h5","h6"].includes(n)){const o=e.textContent?.trim();return{name:o?`${n} "${o.slice(0,35)}"`:n,path:t}}if(n==="p"){const o=e.textContent?.trim();return o?{name:`paragraph: "${o.slice(0,40)}${o.length>40?"...":""}"`,path:t}:{name:"paragraph",path:t}}if(n==="span"||n==="label"){const o=e.textContent?.trim();return o&&o.length<40?{name:`"${o}"`,path:t}:{name:n,path:t}}if(n==="li"){const o=e.textContent?.trim();return o&&o.length<40?{name:`list item: "${o.slice(0,35)}"`,path:t}:{name:"list item",path:t}}if(n==="blockquote")return{name:"blockquote",path:t};if(n==="code"){const o=e.textContent?.trim();return o&&o.length<30?{name:`code: \`${o}\``,path:t}:{name:"code",path:t}}if(n==="pre")return{name:"code block",path:t};if(n==="img"){const o=e.getAttribute("alt");return{name:o?`image "${o.slice(0,30)}"`:"image",path:t}}if(n==="video")return{name:"video",path:t};if(["div","section","article","nav","header","footer","aside","main"].includes(n)){const o=e.className,r=e.getAttribute("role"),l=e.getAttribute("aria-label");if(l)return{name:`${n} [${l}]`,path:t};if(r)return{name:`${r}`,path:t};if(typeof o=="string"&&o){const i=o.split(/[\s_-]+/).map(a=>a.replace(/[A-Z0-9]{5,}.*$/,"")).filter(a=>a.length>2&&!/^[a-z]{1,2}$/.test(a)).slice(0,2);if(i.length>0)return{name:i.join(" "),path:t}}return{name:n==="div"?"container":n,path:t}}return{name:n,path:t}}function ms(e){const t=[],n=e.textContent?.trim();n&&n.length<100&&t.push(n);const o=e.previousElementSibling;if(o){const l=o.textContent?.trim();l&&l.length<50&&t.unshift(`[before: "${l.slice(0,40)}"]`)}const r=e.nextElementSibling;if(r){const l=r.textContent?.trim();l&&l.length<50&&t.push(`[after: "${l.slice(0,40)}"]`)}return t.join(" ")}function Pl(e){const t=Qr(e);if(!t)return"";const r=(e.getRootNode()instanceof ShadowRoot&&e.parentElement?Array.from(e.parentElement.children):Array.from(t.children)).filter(m=>m!==e&&m instanceof HTMLElement);if(r.length===0)return"";const l=r.slice(0,4).map(m=>{const w=m.tagName.toLowerCase(),g=m.className;let $="";if(typeof g=="string"&&g){const k=g.split(/\s+/).map(j=>j.replace(/[_][a-zA-Z0-9]{5,}.*$/,"")).find(j=>j.length>2&&!/^[a-z]{1,2}$/.test(j));k&&($=`.${k}`)}if(w==="button"||w==="a"){const k=m.textContent?.trim().slice(0,15);if(k)return`${w}${$} "${k}"`}return`${w}${$}`});let a=t.tagName.toLowerCase();if(typeof t.className=="string"&&t.className){const m=t.className.split(/\s+/).map(w=>w.replace(/[_][a-zA-Z0-9]{5,}.*$/,"")).find(w=>w.length>2&&!/^[a-z]{1,2}$/.test(w));m&&(a=`.${m}`)}const c=t.children.length,p=c>l.length+1?` (${c} total in ${a})`:"";return l.join(", ")+p}function gs(e){const t=e.className;return typeof t!="string"||!t?"":t.split(/\s+/).filter(o=>o.length>0).map(o=>{const r=o.match(/^([a-zA-Z][a-zA-Z0-9_-]*?)(?:_[a-zA-Z0-9]{5,})?$/);return r?r[1]:o}).filter((o,r,l)=>l.indexOf(o)===r).join(", ")}var _p=new Set(["none","normal","auto","0px","rgba(0, 0, 0, 0)","transparent","static","visible"]),v1=new Set(["p","span","h1","h2","h3","h4","h5","h6","label","li","td","th","blockquote","figcaption","caption","legend","dt","dd","pre","code","em","strong","b","i","a","time","cite","q"]),w1=new Set(["input","textarea","select"]),b1=new Set(["img","video","canvas","svg"]),k1=new Set(["div","section","article","nav","header","footer","aside","main","ul","ol","form","fieldset"]);function Dl(e){if(typeof window>"u")return{};const t=window.getComputedStyle(e),n={},o=e.tagName.toLowerCase();let r;v1.has(o)?r=["color","fontSize","fontWeight","fontFamily","lineHeight"]:o==="button"||o==="a"&&e.getAttribute("role")==="button"?r=["backgroundColor","color","padding","borderRadius","fontSize"]:w1.has(o)?r=["backgroundColor","color","padding","borderRadius","fontSize"]:b1.has(o)?r=["width","height","objectFit","borderRadius"]:k1.has(o)?r=["display","padding","margin","gap","backgroundColor"]:r=["color","fontSize","margin","padding","backgroundColor"];for(const l of r){const i=l.replace(/([A-Z])/g,"-$1").toLowerCase(),a=t.getPropertyValue(i);a&&!_p.has(a)&&(n[l]=a)}return n}var S1=["color","backgroundColor","borderColor","fontSize","fontWeight","fontFamily","lineHeight","letterSpacing","textAlign","width","height","padding","margin","border","borderRadius","display","position","top","right","bottom","left","zIndex","flexDirection","justifyContent","alignItems","gap","opacity","visibility","overflow","boxShadow","transform"];function Bl(e){if(typeof window>"u")return"";const t=window.getComputedStyle(e),n=[];for(const o of S1){const r=o.replace(/([A-Z])/g,"-$1").toLowerCase(),l=t.getPropertyValue(r);l&&!_p.has(l)&&n.push(`${r}: ${l}`)}return n.join("; ")}function C1(e){if(!e)return;const t={},n=e.split(";").map(o=>o.trim()).filter(Boolean);for(const o of n){const r=o.indexOf(":");if(r>0){const l=o.slice(0,r).trim(),i=o.slice(r+1).trim();l&&i&&(t[l]=i)}}return Object.keys(t).length>0?t:void 0}function zl(e){const t=[],n=e.getAttribute("role"),o=e.getAttribute("aria-label"),r=e.getAttribute("aria-describedby"),l=e.getAttribute("tabindex"),i=e.getAttribute("aria-hidden");return n&&t.push(`role="${n}"`),o&&t.push(`aria-label="${o}"`),r&&t.push(`aria-describedby="${r}"`),l&&t.push(`tabindex=${l}`),i==="true"&&t.push("aria-hidden"),e.matches("a, button, input, select, textarea, [tabindex]")&&t.push("focusable"),t.join(", ")}function Ol(e){const t=[];let n=e;for(;n&&n.tagName.toLowerCase()!=="html";){const o=n.tagName.toLowerCase();let r=o;if(n.id)r=`${o}#${n.id}`;else if(n.className&&typeof n.className=="string"){const i=n.className.split(/\s+/).map(a=>a.replace(/[_][a-zA-Z0-9]{5,}.*$/,"")).find(a=>a.length>2);i&&(r=`${o}.${i}`)}const l=Qr(n);!n.parentElement&&l&&(r=`⟨shadow⟩ ${r}`),t.unshift(r),n=l}return t.join(" > ")}var j1=new Set(["nav","header","main","section","article","footer","aside"]),Ac={banner:"Header",navigation:"Navigation",main:"Main Content",contentinfo:"Footer",complementary:"Sidebar",region:"Section"},E_={nav:"Navigation",header:"Header",main:"Main Content",section:"Section",article:"Article",footer:"Footer",aside:"Sidebar"},M1=new Set(["script","style","noscript","link","meta"]),E1=40;function fp(e){let t=e;for(;t&&t!==document.body&&t!==document.documentElement;){const n=window.getComputedStyle(t).position;if(n==="fixed"||n==="sticky")return!0;t=t.parentElement}return!1}function sr(e){const t=e.tagName.toLowerCase();if(["nav","header","footer","main"].includes(t)&&document.querySelectorAll(t).length===1)return t;if(e.id)return`#${CSS.escape(e.id)}`;if(e.className&&typeof e.className=="string"){const r=e.className.split(/\s+/).filter(l=>l.length>0).find(l=>l.length>2&&!/^[a-zA-Z0-9]{6,}$/.test(l)&&!/^[a-z]{1,2}$/.test(l));if(r){const l=`${t}.${CSS.escape(r)}`;if(document.querySelectorAll(l).length===1)return l}}const n=e.parentElement;if(n){const r=Array.from(n.children).indexOf(e)+1;return`${n===document.body?"body":sr(n)} > ${t}:nth-child(${r})`}return t}function Ii(e){const t=e.tagName.toLowerCase(),n=e.getAttribute("aria-label");if(n)return n;const o=e.getAttribute("role");if(o&&Ac[o])return Ac[o];if(E_[t])return E_[t];const r=e.querySelector("h1, h2, h3, h4, h5, h6");if(r){const i=r.textContent?.trim();if(i&&i.length<=50)return i;if(i)return i.slice(0,47)+"..."}const{name:l}=Or(e);return l.charAt(0).toUpperCase()+l.slice(1)}function hp(e){const t=e.className;return typeof t!="string"||!t?null:t.split(/\s+/).map(o=>o.replace(/[_][a-zA-Z0-9]{5,}.*$/,"")).find(o=>o.length>2&&!/^[a-z]{1,2}$/.test(o))||null}function pp(e){const t=e.textContent?.trim();if(!t)return null;const n=t.replace(/\s+/g," ");return n.length<=30?n:n.slice(0,30)+"…"}function I1(){const e=document.querySelector("main")||document.body,t=Array.from(e.children);let n=t;e!==document.body&&t.length<3&&(n=Array.from(document.body.children));const o=[];return n.forEach((r,l)=>{if(!(r instanceof HTMLElement))return;const i=r.tagName.toLowerCase();if(M1.has(i)||r.hasAttribute("data-feedback-toolbar")||r.closest("[data-feedback-toolbar]"))return;const a=window.getComputedStyle(r);if(a.display==="none"||a.visibility==="hidden")return;const c=r.getBoundingClientRect();if(c.height<E1)return;const p=j1.has(i),m=r.getAttribute("role")&&Ac[r.getAttribute("role")],w=i==="div"&&c.height>=60;if(!p&&!m&&!w)return;const g=window.scrollY,$=fp(r),k={x:c.x,y:$?c.y:c.y+g,width:c.width,height:c.height};o.push({id:`rs-${Date.now()}-${Math.random().toString(36).slice(2,7)}`,label:Ii(r),tagName:i,selector:sr(r),role:r.getAttribute("role"),className:hp(r),textSnippet:pp(r),originalRect:k,currentRect:{...k},originalIndex:l,isFixed:$})}),o}function $1(e){const t=window.scrollY,n=e.getBoundingClientRect(),o=fp(e),r={x:n.x,y:o?n.y:n.y+t,width:n.width,height:n.height},l=e.parentElement;let i=0;return l&&(i=Array.from(l.children).indexOf(e)),{id:`rs-${Date.now()}-${Math.random().toString(36).slice(2,7)}`,label:Ii(e),tagName:e.tagName.toLowerCase(),selector:sr(e),role:e.getAttribute("role"),className:hp(e),textSnippet:pp(e),originalRect:r,currentRect:{...r},originalIndex:i,isFixed:o}}var I_={bg:"rgba(59, 130, 246, 0.08)",border:"rgba(59, 130, 246, 0.5)",pill:"#3b82f6"},$_=["nw","n","ne","e","se","s","sw","w"],Al=24,N_=16,Wl=5;function L_(e,t,n,o){let r=1/0,l=1/0;const i=e.x,a=e.x+e.width,c=e.x+e.width/2,p=e.y,m=e.y+e.height,w=e.y+e.height/2,g=[];for(const D of t)n.has(D.id)||g.push(D.currentRect);o&&g.push(...o);for(const D of g){const Q=D.x,he=D.x+D.width,q=D.x+D.width/2,de=D.y,Be=D.y+D.height,Ae=D.y+D.height/2;for(const ke of[i,a,c])for(const Ne of[Q,he,q]){const oe=Ne-ke;Math.abs(oe)<Wl&&Math.abs(oe)<Math.abs(r)&&(r=oe)}for(const ke of[p,m,w])for(const Ne of[de,Be,Ae]){const oe=Ne-ke;Math.abs(oe)<Wl&&Math.abs(oe)<Math.abs(l)&&(l=oe)}}const $=Math.abs(r)<Wl?r:0,k=Math.abs(l)<Wl?l:0,j=[],M=new Set,f=i+$,y=a+$,b=c+$,N=p+k,W=m+k,Y=w+k;for(const D of g){const Q=D.x,he=D.x+D.width,q=D.x+D.width/2,de=D.y,Be=D.y+D.height,Ae=D.y+D.height/2;for(const ke of[Q,q,he])for(const Ne of[f,b,y])if(Math.abs(Ne-ke)<.5){const oe=`x:${Math.round(ke)}`;M.has(oe)||(M.add(oe),j.push({axis:"x",pos:ke}))}for(const ke of[de,Ae,Be])for(const Ne of[N,Y,W])if(Math.abs(Ne-ke)<.5){const oe=`y:${Math.round(ke)}`;M.has(oe)||(M.add(oe),j.push({axis:"y",pos:ke}))}}return{dx:$,dy:k,guides:j}}var N1=new Set(["script","style","noscript","link","meta","br","hr"]);function R_(e){let t=e;for(;t&&t!==document.body&&t!==document.documentElement;){if(t.closest("[data-feedback-toolbar]"))return null;if(N1.has(t.tagName.toLowerCase())){t=t.parentElement;continue}const n=t.getBoundingClientRect();if(n.width>=N_&&n.height>=N_)return t;t=t.parentElement}return null}function L1({rearrangeState:e,onChange:t,isDarkMode:n,exiting:o,className:r,blankCanvas:l,extraSnapRects:i,onSelectionChange:a,deselectSignal:c,onDragMove:p,onDragEnd:m,clearSignal:w}){const{sections:g}=e,$=_.useRef(e);$.current=e;const[k,j]=_.useState(new Set),[M,f]=_.useState(!1),y=_.useRef(w);_.useEffect(()=>{w!==void 0&&w!==y.current&&(y.current=w,g.length>0&&f(!0))},[w,g.length]);const b=_.useRef(c);_.useEffect(()=>{c!==b.current&&(b.current=c,j(new Set))},[c]);const[N,W]=_.useState(null),[Y,D]=_.useState(!1),Q=_.useRef(!1),he=_.useCallback(C=>{const E=g.find(B=>B.id===C);E&&(Q.current=!!E.note,W(C),D(!1))},[g]),q=_.useCallback(()=>{N&&(D(!0),fe(()=>{W(null),D(!1)},150))},[N]),de=_.useCallback(C=>{N&&(t({...e,sections:g.map(E=>E.id===N?{...E,note:C.trim()||void 0}:E)}),q())},[N,g,e,t,q]);_.useEffect(()=>{o&&N&&q()},[o]);const[Be,Ae]=_.useState(new Set),ke=_.useRef(new Map),[Ne,oe]=_.useState(null),[lt,I]=_.useState(null),[U,G]=_.useState([]),[Se,Fe]=_.useState(0),wt=_.useRef(null),Pt=_.useRef(new Set),Dt=_.useRef(new Map),[Bt,zt]=_.useState(new Map),[Vn,ao]=_.useState(new Map),co=_.useRef(new Set),on=_.useRef(new Map),Gt=_.useRef(a);Gt.current=a;const _n=_.useRef(p);_n.current=p;const Sn=_.useRef(m);Sn.current=m,_.useEffect(()=>{l&&j(new Set)},[l]);const[uo,Kn]=_.useState(()=>!e.sections.some(C=>{const E=C.originalRect,B=C.currentRect;return Math.abs(E.x-B.x)>1||Math.abs(E.y-B.y)>1||Math.abs(E.width-B.width)>1||Math.abs(E.height-B.height)>1}));_.useEffect(()=>{if(!uo){const C=fe(()=>Kn(!0),380);return()=>clearTimeout(C)}},[]);const _o=_.useRef(new Set);_.useEffect(()=>{_o.current=new Set(g.map(C=>C.selector))},[g]),_.useEffect(()=>{const C=()=>Fe(window.scrollY);return C(),window.addEventListener("scroll",C,{passive:!0}),window.addEventListener("resize",C,{passive:!0}),()=>{window.removeEventListener("scroll",C),window.removeEventListener("resize",C)}},[]),_.useEffect(()=>{const C=E=>{if(wt.current){oe(null);return}const B=document.elementFromPoint(E.clientX,E.clientY);if(!B){oe(null);return}if(B.closest("[data-feedback-toolbar]")){oe(null);return}if(B.closest("[data-design-placement]")){oe(null);return}if(B.closest("[data-annotation-popup]")){oe(null);return}const O=R_(B);if(!O){oe(null);return}for(const K of _o.current)try{const F=document.querySelector(K);if(F&&(F===O||O.contains(F))){oe(null);return}}catch{}const se=O.getBoundingClientRect();oe({x:se.x,y:se.y,w:se.width,h:se.height})};return document.addEventListener("mousemove",C,{passive:!0}),()=>document.removeEventListener("mousemove",C)},[g]),_.useEffect(()=>{const C=document.body.style.userSelect;return document.body.style.userSelect="none",()=>{document.body.style.userSelect=C}},[]),_.useEffect(()=>{const C=E=>{if(wt.current||E.button!==0)return;const B=E.target;if(!B||B.closest("[data-feedback-toolbar]")||B.closest("[data-design-placement]")||B.closest("[data-annotation-popup]"))return;const O=R_(B);let se=!1;if(O)for(const F of _o.current)try{const we=document.querySelector(F);if(we&&(we===O||O.contains(we))){se=!0;break}}catch{}const K=!!(E.shiftKey||E.metaKey||E.ctrlKey);if(O&&!se){E.preventDefault(),E.stopPropagation();const F=$1(O),we=[...g,F],be=[...e.originalOrder,F.id];t({...e,sections:we,originalOrder:be});const ze=new Set([F.id]);j(ze),Gt.current?.(ze,K),oe(null);const Ke=E.clientX,ae=E.clientY,We={x:F.currentRect.x,y:F.currentRect.y};F.originalRect;let Oe=!1,Le=0,re=0;wt.current="move";const Ge=pe=>{const Qe=pe.clientX-Ke,$e=pe.clientY-ae;if(!Oe&&(Math.abs(Qe)>2||Math.abs($e)>2)&&(Oe=!0),!Oe)return;const fn={x:We.x+Qe,y:We.y+$e,width:F.currentRect.width,height:F.currentRect.height},qt=L_(fn,we,new Set([F.id]),i);G(qt.guides);const rn=Qe+qt.dx,Bn=$e+qt.dy;Le=rn,re=Bn;const hn=document.querySelector(`[data-rearrange-section="${F.id}"]`);hn&&(hn.style.transform=`translate(${rn}px, ${Bn}px)`),zt(new Map([[F.id,{x:We.x+rn,y:We.y+Bn,width:F.currentRect.width,height:F.currentRect.height}]])),_n.current?.(rn,Bn)},je=()=>{window.removeEventListener("mousemove",Ge),window.removeEventListener("mouseup",je),wt.current=null,G([]),zt(new Map);const pe=document.querySelector(`[data-rearrange-section="${F.id}"]`);pe&&(pe.style.transform=""),Oe&&t({...e,sections:we.map(Qe=>Qe.id===F.id?{...Qe,currentRect:{...Qe.currentRect,x:Math.max(0,We.x+Le),y:Math.max(0,We.y+re)}}:Qe),originalOrder:be}),Sn.current?.(Le,re,Oe)};window.addEventListener("mousemove",Ge),window.addEventListener("mouseup",je)}else if(se&&O){E.preventDefault();for(const F of g)try{const we=document.querySelector(F.selector);if(we&&we===O){const be=new Set([F.id]);j(be),Gt.current?.(be,K);return}}catch{}K||(j(new Set),Gt.current?.(new Set,!1))}else K||(j(new Set),Gt.current?.(new Set,!1))};return document.addEventListener("mousedown",C,!0),()=>document.removeEventListener("mousedown",C,!0)},[g,e,t]),_.useEffect(()=>{const C=E=>{const B=E.target;if(!(B.tagName==="INPUT"||B.tagName==="TEXTAREA"||B.isContentEditable)){if((E.key==="Backspace"||E.key==="Delete")&&k.size>0){E.preventDefault();const O=new Set(k);Ae(se=>{const K=new Set(se);for(const F of O)K.add(F);return K}),j(new Set),fe(()=>{const se=$.current;t({...se,sections:se.sections.filter(K=>!O.has(K.id)),originalOrder:se.originalOrder.filter(K=>!O.has(K))}),Ae(K=>{const F=new Set(K);for(const we of O)F.delete(we);return F})},180);return}if(["ArrowUp","ArrowDown","ArrowLeft","ArrowRight"].includes(E.key)&&k.size>0){E.preventDefault();const O=E.shiftKey?20:1,se=E.key==="ArrowLeft"?-O:E.key==="ArrowRight"?O:0,K=E.key==="ArrowUp"?-O:E.key==="ArrowDown"?O:0;t({...e,sections:g.map(F=>k.has(F.id)?{...F,currentRect:{...F.currentRect,x:Math.max(0,F.currentRect.x+se),y:Math.max(0,F.currentRect.y+K)}}:F)});return}E.key==="Escape"&&k.size>0&&j(new Set)}};return document.addEventListener("keydown",C),()=>document.removeEventListener("keydown",C)},[k,g,e,t]);const T=_.useCallback((C,E)=>{if(C.button!==0)return;const B=C.target;if(B.closest(`.${R.handle}`)||B.closest(`.${R.deleteButton}`))return;C.preventDefault(),C.stopPropagation();let O;C.shiftKey||C.metaKey||C.ctrlKey?(O=new Set(k),O.has(E)?O.delete(E):O.add(E)):k.has(E)?O=new Set(k):O=new Set([E]),j(O),(O.size!==k.size||[...O].some(Le=>!k.has(Le)))&&Gt.current?.(O,!!(C.shiftKey||C.metaKey||C.ctrlKey));const K=C.clientX,F=C.clientY,we=new Map;for(const Le of g)O.has(Le.id)&&we.set(Le.id,{x:Le.currentRect.x,y:Le.currentRect.y});wt.current="move";let be=!1,ze=0,Ke=0;const ae=new Map;for(const Le of g)if(O.has(Le.id)){const re=document.querySelector(`[data-rearrange-section="${Le.id}"]`);ae.set(Le.id,{outlineEl:re,curW:Le.currentRect.width,curH:Le.currentRect.height})}const We=Le=>{const re=Le.clientX-K,Ge=Le.clientY-F;if(re===0&&Ge===0)return;be=!0;let je=1/0,pe=1/0,Qe=-1/0,$e=-1/0;for(const[hn,{curW:ar,curH:sl}]of ae){const mt=we.get(hn);if(!mt)continue;const Gn=mt.x+re,ll=mt.y+Ge;je=Math.min(je,Gn),pe=Math.min(pe,ll),Qe=Math.max(Qe,Gn+ar),$e=Math.max($e,ll+sl)}const fn=L_({x:je,y:pe,width:Qe-je,height:$e-pe},g,O,i),qt=re+fn.dx,rn=Ge+fn.dy;ze=qt,Ke=rn,G(fn.guides);for(const[,{outlineEl:hn}]of ae)hn&&(hn.style.transform=`translate(${qt}px, ${rn}px)`);const Bn=new Map;for(const[hn,{curW:ar,curH:sl}]of ae){const mt=we.get(hn);if(mt){const Gn={x:Math.max(0,mt.x+qt),y:Math.max(0,mt.y+rn),width:ar,height:sl};Bn.set(hn,Gn)}}zt(Bn),_n.current?.(qt,rn)},Oe=Le=>{window.removeEventListener("mousemove",We),window.removeEventListener("mouseup",Oe),wt.current=null,G([]),zt(new Map);for(const[,{outlineEl:re}]of ae)re&&(re.style.transform="");if(be){const re=Le.clientX-K,Ge=Le.clientY-F;if(Math.abs(re)<5&&Math.abs(Ge)<5)t({...e,sections:g.map(je=>{const pe=we.get(je.id);return pe?{...je,currentRect:{...je.currentRect,x:pe.x,y:pe.y}}:je})});else{t({...e,sections:g.map(je=>{const pe=we.get(je.id);return pe?{...je,currentRect:{...je.currentRect,x:Math.max(0,pe.x+ze),y:Math.max(0,pe.y+Ke)}}:je})}),Sn.current?.(ze,Ke,!0);return}}Sn.current?.(0,0,!1)};window.addEventListener("mousemove",We),window.addEventListener("mouseup",Oe)},[k,g,e,t]),ie=_.useCallback((C,E,B)=>{C.preventDefault(),C.stopPropagation();const O=g.find(We=>We.id===E);if(!O)return;j(new Set([E])),wt.current="resize";const se=C.clientX,K=C.clientY,F={...O.currentRect};O.originalRect;const we=F.width/F.height;let be={...F};const ze=document.querySelector(`[data-rearrange-section="${E}"]`),Ke=We=>{const Oe=We.clientX-se,Le=We.clientY-K;let re=F.x,Ge=F.y,je=F.width,pe=F.height;if(B.includes("e")&&(je=Math.max(Al,F.width+Oe)),B.includes("w")&&(je=Math.max(Al,F.width-Oe),re=F.x+F.width-je),B.includes("s")&&(pe=Math.max(Al,F.height+Le)),B.includes("n")&&(pe=Math.max(Al,F.height-Le),Ge=F.y+F.height-pe),We.shiftKey)if(B.length===2){const $e=Math.abs(je-F.width),fn=Math.abs(pe-F.height);$e>fn?pe=je/we:je=pe*we,B.includes("w")&&(re=F.x+F.width-je),B.includes("n")&&(Ge=F.y+F.height-pe)}else B==="e"||B==="w"?pe=je/we:je=pe*we,B==="w"&&(re=F.x+F.width-je),B==="n"&&(Ge=F.y+F.height-pe);be={x:re,y:Ge,width:je,height:pe},ze&&(ze.style.left=`${re}px`,ze.style.top=`${Ge-Se}px`,ze.style.width=`${je}px`,ze.style.height=`${pe}px`),I({x:We.clientX+12,y:We.clientY+12,text:`${Math.round(je)} × ${Math.round(pe)}`}),zt(new Map([[E,be]]))},ae=()=>{window.removeEventListener("mousemove",Ke),window.removeEventListener("mouseup",ae),I(null),wt.current=null,zt(new Map),t({...e,sections:g.map(We=>We.id===E?{...We,currentRect:be}:We)})};window.addEventListener("mousemove",Ke),window.addEventListener("mouseup",ae)},[g,e,t,Se]),Me=_.useCallback(C=>{Ae(E=>{const B=new Set(E);return B.add(C),B}),j(E=>{const B=new Set(E);return B.delete(C),B}),fe(()=>{const E=$.current;t({...E,sections:E.sections.filter(B=>B.id!==C),originalOrder:E.originalOrder.filter(B=>B!==C)}),Ae(B=>{const O=new Set(B);return O.delete(C),O})},180)},[t]),ge=C=>{const E=C.originalRect,B=C.currentRect;return Math.abs(E.x-B.x)>1||Math.abs(E.y-B.y)>1||Math.abs(E.width-B.width)>1||Math.abs(E.height-B.height)>1},Ce=C=>{const E=C.originalRect,B=C.currentRect;return Math.abs(E.x-B.x)>1||Math.abs(E.y-B.y)>1},Ye=C=>{const E=C.originalRect,B=C.currentRect;return Math.abs(E.width-B.width)>1||Math.abs(E.height-B.height)>1};for(const C of g)Dt.current.has(C.id)||(Ce(C)?Dt.current.set(C.id,"move"):Ye(C)&&Dt.current.set(C.id,"resize"));for(const C of Dt.current.keys())g.some(E=>E.id===C)||Dt.current.delete(C);const He=g.filter(C=>{try{if(Be.has(C.id)||k.has(C.id))return!0;const E=document.querySelector(C.selector);if(!E)return!1;const B=E.getBoundingClientRect(),O=C.originalRect;return Math.abs(B.width-O.width)+Math.abs(B.height-O.height)<200}catch{return!1}}),Ie=He.filter(C=>ge(C)),Xe=He.filter(C=>!ge(C)),at=new Set(Ie.map(C=>C.id));for(const C of Pt.current)at.has(C)||Pt.current.delete(C);const ue=[...at].sort().join(",");for(const C of Ie)on.current.set(C.id,{currentRect:C.currentRect,originalRect:C.originalRect,isFixed:C.isFixed});return _.useEffect(()=>{const C=co.current;co.current=at;const E=new Map;for(const B of C)if(!at.has(B)){if(!g.some(se=>se.id===B))continue;const O=on.current.get(B);O&&(E.set(B,{orig:O.originalRect,target:O.currentRect,isFixed:O.isFixed}),on.current.delete(B))}if(E.size>0){ao(O=>{const se=new Map(O);for(const[K,F]of E)se.set(K,F);return se});const B=fe(()=>{ao(O=>{const se=new Map(O);for(const K of E.keys())se.delete(K);return se})},250);return()=>clearTimeout(B)}},[ue,g]),s.jsxs(s.Fragment,{children:[s.jsxs("div",{className:`${R.rearrangeOverlay} ${n?"":R.light} ${o?R.overlayExiting:""}${r?` ${r}`:""}`,"data-feedback-toolbar":!0,children:[Ne&&s.jsx("div",{className:R.hoverHighlight,style:{left:Ne.x,top:Ne.y,width:Ne.w,height:Ne.h}}),Xe.map(C=>{const E=C.currentRect,B=C.isFixed?E.y:E.y-Se,O=I_,se=k.has(C.id);return s.jsxs("div",{"data-rearrange-section":C.id,className:`${R.sectionOutline} ${se?R.selected:""} ${M||o||Be.has(C.id)?R.exiting:""}`,style:{left:E.x,top:B,width:E.width,height:E.height,borderColor:O.border,backgroundColor:O.bg,...uo?{}:{opacity:0,animation:"none",transition:"none"}},onMouseDown:K=>T(K,C.id),onDoubleClick:()=>he(C.id),children:[s.jsx("span",{className:R.sectionLabel,style:{backgroundColor:O.pill},children:C.label}),s.jsx("span",{className:`${R.sectionAnnotation} ${C.note?R.annotationVisible:""}`,children:(C.note&&ke.current.set(C.id,C.note),C.note||ke.current.get(C.id)||"")}),s.jsxs("span",{className:R.sectionDimensions,children:[Math.round(E.width)," × ",Math.round(E.height)]}),s.jsx("div",{className:R.deleteButton,onMouseDown:K=>K.stopPropagation(),onClick:()=>Me(C.id),children:"✕"}),$_.map(K=>s.jsx("div",{className:`${R.handle} ${R[`handle${K.charAt(0).toUpperCase()}${K.slice(1)}`]}`,onMouseDown:F=>ie(F,C.id,K)},K))]},C.id)}),Ie.map(C=>{const E=C.currentRect,B=C.isFixed?E.y:E.y-Se,O=k.has(C.id),se=Ce(C),K=Ye(C);if(l&&!O)return null;const we=!Pt.current.has(C.id);return we&&Pt.current.add(C.id),s.jsxs("div",{"data-rearrange-section":C.id,className:`${R.ghostOutline} ${O?R.selected:""} ${M||o||Be.has(C.id)?R.exiting:""}`,style:{left:E.x,top:B,width:E.width,height:E.height,...uo?{}:{opacity:0,animation:"none",transition:"none"},...we?{}:{animation:"none"}},onMouseDown:be=>T(be,C.id),onDoubleClick:()=>he(C.id),children:[s.jsx("span",{className:R.sectionLabel,style:{backgroundColor:I_.pill},children:C.label}),s.jsx("span",{className:`${R.sectionAnnotation} ${C.note?R.annotationVisible:""}`,children:(C.note&&ke.current.set(C.id,C.note),C.note||ke.current.get(C.id)||"")}),s.jsxs("span",{className:R.sectionDimensions,children:[Math.round(E.width)," × ",Math.round(E.height)]}),s.jsx("div",{className:R.deleteButton,onMouseDown:be=>be.stopPropagation(),onClick:()=>Me(C.id),children:"✕"}),$_.map(be=>s.jsx("div",{className:`${R.handle} ${R[`handle${be.charAt(0).toUpperCase()}${be.slice(1)}`]}`,onMouseDown:ze=>ie(ze,C.id,be)},be)),s.jsx("span",{className:R.ghostBadge,children:(()=>{const be=Dt.current.get(C.id);if(se&&K){const[ze,Ke]=be==="resize"?["Resize","Move"]:["Move","Resize"];return s.jsxs(s.Fragment,{children:["Suggested ",ze," ",s.jsxs("span",{className:R.ghostBadgeExtra,children:["& ",Ke]})]})}return`Suggested ${K?"Resize":"Move"}`})()})]},C.id)})]}),!l&&(()=>{const C=[];for(const E of Ie){const B=Bt.get(E.id);C.push({id:E.id,orig:E.originalRect,target:B||E.currentRect,isFixed:E.isFixed,isSelected:k.has(E.id),isExiting:Be.has(E.id)})}for(const[E,B]of Bt)if(!C.some(O=>O.id===E)){const O=g.find(se=>se.id===E);O&&C.push({id:E,orig:O.originalRect,target:B,isFixed:O.isFixed,isSelected:k.has(E)})}for(const[E,B]of Vn)C.some(O=>O.id===E)||C.push({id:E,orig:B.orig,target:B.target,isFixed:B.isFixed,isSelected:!1,isExiting:!0});return C.length===0?null:s.jsxs("svg",{className:`${R.connectorSvg} ${M||o?R.connectorExiting:""}`,children:[C.map(({id:E,orig:B,target:O,isFixed:se,isSelected:K,isExiting:F})=>{const we=B.x+B.width/2,be=(se?B.y:B.y-Se)+B.height/2,ze=O.x+O.width/2,Ke=(se?O.y:O.y-Se)+O.height/2,ae=ze-we,We=Ke-be,Oe=Math.sqrt(ae*ae+We*We);if(Oe<2)return null;const Le=Math.min(1,Oe/40),re=Math.min(Oe*.3,60),Ge=Oe>0?-We/Oe:0,je=Oe>0?ae/Oe:0,pe=(we+ze)/2+Ge*re,Qe=(be+Ke)/2+je*re,$e=Bt.has(E),fn=$e||K?1:.4,qt=$e||K?1:.5;return s.jsxs("g",{className:F?R.connectorExiting:"",children:[s.jsx("path",{className:R.connectorLine,d:`M ${we} ${be} Q ${pe} ${Qe} ${ze} ${Ke}`,fill:"none",stroke:"rgba(59, 130, 246, 0.45)",strokeWidth:"1.5",opacity:fn*Le}),s.jsx("circle",{className:R.connectorDot,cx:we,cy:be,r:4*Le,fill:"rgba(59, 130, 246, 0.8)",stroke:"#fff",strokeWidth:"1.5",opacity:qt*Le,filter:"url(#connDotShadow)"}),s.jsx("circle",{className:R.connectorDot,cx:ze,cy:Ke,r:4*Le,fill:"rgba(59, 130, 246, 0.8)",stroke:"#fff",strokeWidth:"1.5",opacity:qt*Le,filter:"url(#connDotShadow)"})]},`conn-${E}`)}),s.jsx("defs",{children:s.jsx("filter",{id:"connDotShadow",x:"-50%",y:"-50%",width:"200%",height:"200%",children:s.jsx("feDropShadow",{dx:"0",dy:"0.5",stdDeviation:"1",floodOpacity:"0.15"})})})]})})(),N&&(()=>{const C=g.find(Ke=>Ke.id===N);if(!C)return null;const E=C.currentRect,B=C.isFixed?E.y:E.y-Se,O=E.x+E.width/2,se=B-8,K=B+E.height+8,F=se>200,we=K<window.innerHeight-100,be=Math.max(160,Math.min(window.innerWidth-160,O));let ze;return F?ze={left:be,bottom:window.innerHeight-se}:we?ze={left:be,top:K}:ze={left:be,top:Math.max(80,window.innerHeight/2-80)},s.jsx(Ei,{element:C.label,placeholder:"Add a note about this section",initialValue:C.note??"",submitLabel:Q.current?"Save":"Set",onSubmit:de,onCancel:q,onDelete:Q.current?()=>{de("")}:void 0,isExiting:Y,lightMode:!n,style:ze})})(),lt&&s.jsx("div",{className:R.sizeIndicator,style:{left:lt.x,top:lt.y},"data-feedback-toolbar":!0,children:lt.text}),U.map((C,E)=>s.jsx("div",{className:R.guideLine,style:C.axis==="x"?{position:"fixed",left:C.pos,top:0,width:1,height:"100vh"}:{position:"fixed",left:0,top:C.pos-Se,width:"100vw",height:1}},`${C.axis}-${C.pos}-${E}`))]})}var Wc=new Set(["script","style","noscript","link","meta","br","hr"]);function R1(){const e=document.querySelector("main")||document.body,t=[],n=Array.from(e.children),o=e!==document.body&&n.length<3?Array.from(document.body.children):n;for(const r of o){if(!(r instanceof HTMLElement)||Wc.has(r.tagName.toLowerCase())||r.hasAttribute("data-feedback-toolbar"))continue;const l=window.getComputedStyle(r);if(l.display==="none"||l.visibility==="hidden")continue;const i=r.getBoundingClientRect();if(!(i.height<10||i.width<10)){t.push({label:Ii(r),selector:sr(r),top:i.top,bottom:i.bottom,left:i.left,right:i.right,area:i.width*i.height});for(const a of Array.from(r.children)){if(!(a instanceof HTMLElement)||Wc.has(a.tagName.toLowerCase())||a.hasAttribute("data-feedback-toolbar"))continue;const c=window.getComputedStyle(a);if(c.display==="none"||c.visibility==="hidden")continue;const p=a.getBoundingClientRect();p.height<10||p.width<10||t.push({label:Ii(a),selector:sr(a),top:p.top,bottom:p.bottom,left:p.left,right:p.right,area:p.width*p.height})}}}return t}function T1(e){const t=window.scrollY;return e.map(({label:n,selector:o,rect:r})=>{const l=r.y-t;return{label:n,selector:o,top:l,bottom:l+r.height,left:r.x,right:r.x+r.width,area:r.width*r.height}})}function P1(e){const t=window.scrollY,n=e.y-t,o=e.x;return{top:n,bottom:n+e.height,left:o,right:o+e.width,area:e.width*e.height}}function Fc(e,t){const n=t?T1(t):R1(),o=P1(e);let r=null,l=null,i=null,a=null,c=null;for(const k of n){if(Math.abs(k.left-o.left)<2&&Math.abs(k.top-o.top)<2&&Math.abs(k.right-k.left-e.width)<2&&Math.abs(k.bottom-k.top-e.height)<2)continue;k.left<=o.left+2&&k.right>=o.right-2&&k.top<=o.top+2&&k.bottom>=o.bottom-2&&k.area>o.area*1.5&&(!c||k.area<c._area)&&(c={label:k.label,selector:k.selector,_area:k.area});const j=o.right>k.left+5&&o.left<k.right-5,M=o.bottom>k.top+5&&o.top<k.bottom-5;if(j&&k.bottom<=o.top+5){const f=Math.round(o.top-k.bottom);(!r||f<r._dist)&&(r={label:k.label,selector:k.selector,gap:Math.max(0,f),_dist:f})}if(j&&k.top>=o.bottom-5){const f=Math.round(k.top-o.bottom);(!l||f<l._dist)&&(l={label:k.label,selector:k.selector,gap:Math.max(0,f),_dist:f})}if(M&&k.right<=o.left+5){const f=Math.round(o.left-k.right);(!i||f<i._dist)&&(i={label:k.label,selector:k.selector,gap:Math.max(0,f),_dist:f})}if(M&&k.left>=o.right-5){const f=Math.round(k.left-o.right);(!a||f<a._dist)&&(a={label:k.label,selector:k.selector,gap:Math.max(0,f),_dist:f})}}const p=window.innerWidth,m=window.innerHeight,w=B1(e,p),g=k=>k?{label:k.label,selector:k.selector,gap:k.gap}:null,$=D1(o,e,p,m,c?{label:c.label,selector:c.selector,_area:c._area}:null,n);return{above:g(r),below:g(l),left:g(i),right:g(a),alignment:w,containedIn:c?{label:c.label,selector:c.selector}:null,outOfBounds:$}}function D1(e,t,n,o,r,l){const i={};let a=!1;const c=[];if(e.left<-2&&c.push("left"),e.right>n+2&&c.push("right"),e.top<-2&&c.push("top"),e.bottom>o+2&&c.push("bottom"),c.length>0&&(i.viewport=c,a=!0),r){const p=l.find(m=>m.label===r.label&&m.selector===r.selector&&Math.abs(m.area-r._area)<10);if(p){const m=[];e.left<p.left-2&&m.push("left"),e.right>p.right+2&&m.push("right"),e.top<p.top-2&&m.push("top"),e.bottom>p.bottom+2&&m.push("bottom"),m.length>0&&(i.container={label:r.label,edges:m},a=!0)}}return a?i:null}function B1(e,t){if(e.width/t>.85)return"full-width";const o=e.x+e.width/2,r=t/2,l=o-r,i=t*.08;return Math.abs(l)<i?"center":l<0?"left":"right"}function mp(e){switch(e){case"full-width":return"full-width";case"center":return"centered";case"left":return"left-aligned";case"right":return"right-aligned"}}function gp(e,t={}){const n=[];e.above&&n.push(`Below \`${e.above.label}\`${e.above.gap>0?` (${e.above.gap}px gap)`:""}`),e.below&&n.push(`Above \`${e.below.label}\`${e.below.gap>0?` (${e.below.gap}px gap)`:""}`),t.includeLeftRight&&(e.left&&n.push(`Right of \`${e.left.label}\`${e.left.gap>0?` (${e.left.gap}px gap)`:""}`),e.right&&n.push(`Left of \`${e.right.label}\`${e.right.gap>0?` (${e.right.gap}px gap)`:""}`));const o=mp(e.alignment);return e.containedIn?n.push(`${o.charAt(0).toUpperCase()+o.slice(1)} in \`${e.containedIn.label}\``):n.push(`${o.charAt(0).toUpperCase()+o.slice(1)} in page`),t.includePixelRef&&t.pixelRef&&n.push(`Pixel ref: \`${t.pixelRef}\``),e.outOfBounds&&(e.outOfBounds.viewport&&n.push(`**Outside viewport** (${e.outOfBounds.viewport.join(", ")} edge${e.outOfBounds.viewport.length>1?"s":""})`),e.outOfBounds.container&&n.push(`**Outside \`${e.outOfBounds.container.label}\`** (${e.outOfBounds.container.edges.join(", ")} edge${e.outOfBounds.container.edges.length>1?"s":""})`)),n}function z1(e,t,n){const o=[];e.above&&o.push(`below \`${e.above.label}\``),e.below&&o.push(`above \`${e.below.label}\``),e.left&&o.push(`right of \`${e.left.label}\``),e.right&&o.push(`left of \`${e.right.label}\``),e.containedIn&&o.push(`inside \`${e.containedIn.label}\``),o.push(mp(e.alignment)),e.outOfBounds?.viewport&&o.push(`**outside viewport** (${e.outOfBounds.viewport.join(", ")})`),e.outOfBounds?.container&&o.push(`**outside \`${e.outOfBounds.container.label}\`** (${e.outOfBounds.container.edges.join(", ")})`);const r=n?`, ${Math.round(n.width)}×${Math.round(n.height)}px`:"";return`at (${Math.round(t.x)}, ${Math.round(t.y)})${r}: ${o.join(", ")}`}var T_=15;function P_(e){if(e.length<2)return[];const t=[],n=new Set;for(let o=0;o<e.length;o++){if(n.has(o))continue;const r=[o];for(let l=o+1;l<e.length;l++)n.has(l)||Math.abs(e[o].rect.y-e[l].rect.y)<T_&&r.push(l);if(r.length>=2){const l=r.map(c=>e[c]);l.sort((c,p)=>c.rect.x-p.rect.x);const i=[];for(let c=0;c<l.length-1;c++)i.push(Math.round(l[c+1].rect.x-(l[c].rect.x+l[c].rect.width)));const a=Math.round(l.reduce((c,p)=>c+p.rect.y,0)/l.length);t.push({labels:l.map(c=>c.label),type:"row",sharedEdge:a,gaps:i,avgGap:i.length?Math.round(i.reduce((c,p)=>c+p,0)/i.length):0}),r.forEach(c=>n.add(c))}}for(let o=0;o<e.length;o++){if(n.has(o))continue;const r=[o];for(let l=o+1;l<e.length;l++)n.has(l)||Math.abs(e[o].rect.x-e[l].rect.x)<T_&&r.push(l);if(r.length>=2){const l=r.map(c=>e[c]);l.sort((c,p)=>c.rect.y-p.rect.y);const i=[];for(let c=0;c<l.length-1;c++)i.push(Math.round(l[c+1].rect.y-(l[c].rect.y+l[c].rect.height)));const a=Math.round(l.reduce((c,p)=>c+p.rect.x,0)/l.length);t.push({labels:l.map(c=>c.label),type:"column",sharedEdge:a,gaps:i,avgGap:i.length?Math.round(i.reduce((c,p)=>c+p,0)/i.length):0}),r.forEach(c=>n.add(c))}}return t}function O1(e){if(e.length<2)return[];const t=P_(e.map(i=>({label:i.label,rect:i.originalRect}))),n=P_(e.map(i=>({label:i.label,rect:i.currentRect}))),o=[],r=new Set;for(const i of t){const a=new Set(i.labels);let c=null,p=0;for(const m of n){const w=m.labels.filter(g=>a.has(g)).length;w>=2&&w>p&&(c=m,p=w)}if(c){const m=c.labels.filter(g=>a.has(g)),w=m.join(", ");if(c.type!==i.type){const g=i.type==="row"?"y":"x",$=c.type==="row"?"y":"x";o.push(`**${w}**: ${i.type} (${g}≈${i.sharedEdge}, ${i.avgGap}px gaps) → ${c.type} (${$}≈${c.sharedEdge}, ${c.avgGap}px gaps)`)}else if(Math.abs(i.sharedEdge-c.sharedEdge)>20||Math.abs(i.avgGap-c.avgGap)>5){const g=i.type==="row"?"y":"x",$=Math.abs(i.sharedEdge-c.sharedEdge)>20?` ${g}: ${i.sharedEdge} → ${c.sharedEdge}`:"",k=Math.abs(i.avgGap-c.avgGap)>5?` gaps: ${i.avgGap}px → ${c.avgGap}px`:"";o.push(`**${w}**: ${i.type} shifted —${$}${k}`)}m.forEach(g=>r.add(g))}else{const m=i.labels.join(", "),w=i.type==="row"?"y":"x";o.push(`**${m}**: ${i.type} (${w}≈${i.sharedEdge}) dissolved`),i.labels.forEach(g=>r.add(g))}}for(const i of n){if(i.labels.every(p=>r.has(p))||i.labels.filter(p=>!r.has(p)).length<2)continue;if(!t.some(p=>p.labels.filter(w=>i.labels.includes(w)).length>=2)){const p=i.type==="row"?"y":"x";o.push(`**${i.labels.join(", ")}**: new ${i.type} (${p}≈${i.sharedEdge}, ${i.avgGap}px gaps)`),i.labels.forEach(m=>r.add(m))}}const l=e.filter(i=>!r.has(i.label));if(l.length>=2){const i={};for(const a of l){const c=Math.round(a.currentRect.x/5)*5;(i[c]??(i[c]=[])).push(a.label)}for(const[a,c]of Object.entries(i))c.length>=2&&o.push(`**${c.join(", ")}**: shared left edge at x≈${a}`)}return o}function yp(e){if(typeof document>"u")return{viewport:e,contentArea:null};const t=[],n=new Set,o=a=>{n.has(a)||a instanceof HTMLElement&&(a.hasAttribute("data-feedback-toolbar")||Wc.has(a.tagName.toLowerCase())||(n.add(a),t.push(a)))},r=document.querySelector("main");r&&o(r);const l=document.querySelector("[role='main']");l&&o(l);for(const a of Array.from(document.body.children))if(o(a),a.children){for(const c of Array.from(a.children))if(o(c),c.children)for(const p of Array.from(c.children))o(p)}let i=null;for(const a of t){const c=a.getBoundingClientRect();if(c.height<50)continue;const p=getComputedStyle(a);if(p.maxWidth&&p.maxWidth!=="none"&&p.maxWidth!=="0px"){(!i||c.width<i.rect.width)&&(i={el:a,rect:c});continue}!i&&c.width<e.width-20&&c.width>100&&(i={el:a,rect:c})}if(i){const{el:a,rect:c}=i;return{viewport:e,contentArea:{width:Math.round(c.width),left:Math.round(c.left),right:Math.round(c.right),centerX:Math.round(c.left+c.width/2),selector:sr(a)}}}return{viewport:e,contentArea:null}}function A1(e){if(typeof document>"u")return null;const t=document.querySelector(e);if(!t?.parentElement)return null;const n=getComputedStyle(t.parentElement),o={parentDisplay:n.display,parentSelector:sr(t.parentElement)};return n.display.includes("flex")&&(o.flexDirection=n.flexDirection),n.display.includes("grid")&&n.gridTemplateColumns!=="none"&&(o.gridCols=n.gridTemplateColumns),n.gap&&n.gap!=="normal"&&n.gap!=="0px"&&(o.gap=n.gap),o}function xp(e,t){const n=t.contentArea,o=n?n.width:t.viewport.width,r=n?n.left:0,l=n?n.centerX:Math.round(t.viewport.width/2),i=Math.round(e.x-r),a=Math.round(r+o-(e.x+e.width)),c=(e.width/o*100).toFixed(1),p=e.x+e.width/2,m=Math.abs(p-l)<20,w=e.width/o>.95,g=[];return w?g.push("`width: 100%` of container"):g.push(`left \`${i}px\` in container, right \`${a}px\`, width \`${c}%\` (\`${Math.round(e.width)}px\`)`),m&&!w&&g.push("centered — `margin-inline: auto`"),g.join(" — ")}function vp(e){const{viewport:t,contentArea:n}=e;let o=`### Reference Frame
...
`,r.forEach((M,f)=>{const y=Nn[M.type]?.label||M.type;l+=`${f+1}. **${y}** — \`${Math.round(M.width)}×${Math.round(M.height)}px\` at \`(${Math.round(M.x)}, ${Math.round(M.y)})\`
`}),l;const i=yp(t);l+=vp(i),l+=`### Components
`,r.forEach((M,f)=>{const y=Nn[M.type]?.label||M.type,b={x:M.x,y:M.y,width:M.width,height:M.height};l+=`${f+1}. **${y}** — \`${Math.round(M.width)}×${Math.round(M.height)}px\` at \`(${Math.round(M.x)}, ${Math.round(M.y)})\`
`;const N=Fc(b),Y=gp(N,{includeLeftRight:o==="detailed"||o==="forensic"});for(const Q of Y)l+=`   - ${Q}
`;const D=xp(b,i);D&&(l+=`   - CSS: ${D}
`)}),l+=`
### Layout Analysis
`;const a=[];for(const M of r){const f=a.find(y=>Math.abs(y.y-M.y)<30);f?f.items.push(M):a.push({y:M.y,items:[M]})}if(a.sort((M,f)=>M.y-f.y),a.forEach((M,f)=>{M.items.sort((b,N)=>b.x-N.x);const y=M.items.map(b=>Nn[b.type]?.label||b.type);if(M.items.length===1){const N=M.items[0].width>t.width*.8;l+=`- Row ${f+1} (y≈${Math.round(M.y)}): ${y[0]}${N?" — full width":""}
`}else l+=`- Row ${f+1} (y≈${Math.round(M.y)}): ${y.join(" | ")} — ${M.items.length} items side by side
`}),o==="detailed"||o==="forensic"){l+=`
### Spacing & Gaps
`;for(let M=0;M<r.length-1;M++){const f=r[M],y=r[M+1],b=Nn[f.type]?.label||f.type,N=Nn[y.type]?.label||y.type,W=Math.round(y.y-(f.y+f.height)),Y=Math.round(y.x-(f.x+f.width));Math.abs(f.y-y.y)<30?l+=`- ${b} → ${N}: \`${Y}px\` horizontal gap
`:l+=`- ${b} → ${N}: \`${W}px\` vertical gap
`}if(o==="forensic"&&r.length>2){l+=`
### All Pairwise Gaps
`;for(let M=0;M<r.length;M++)for(let f=M+1;f<r.length;f++){const y=r[M],b=r[f],N=Nn[y.type]?.label||y.type,W=Nn[b.type]?.label||b.type,Y=Math.round(b.y-(y.y+y.height)),D=Math.round(b.x-(y.x+y.width));l+=`- ${N} ↔ ${W}: h=\`${D}px\` v=\`${Y}px\`
`}}o==="forensic"&&(l+=`
### Z-Order (placement order)
`,e.forEach((M,f)=>{const y=Nn[M.type]?.label||M.type;l+=`${f}. ${y} at \`(${Math.round(M.x)}, ${Math.round(M.y)})\`
`}))}l+=`
### Suggested Implementation
`;const c=r.some(M=>M.type==="navigation"),p=r.some(M=>M.type==="hero"),m=r.some(M=>M.type==="sidebar"),w=r.some(M=>M.type==="footer"),g=r.filter(M=>M.type==="card"),$=r.filter(M=>M.type==="form"),k=r.filter(M=>M.type==="table"),j=r.filter(M=>M.type==="modal");if(c&&(l+=`- Top navigation bar with logo + nav links + CTA
`),p&&(l+=`- Hero section with heading, subtext, and call-to-action
`),m&&(l+=`- Sidebar layout — use CSS Grid with sidebar + main content area
...
`),w&&(l+=`- Multi-column footer with links
`),o==="detailed"||o==="forensic"){if(l+=`
### CSS Suggestions
`,m){const M=r.find(f=>f.type==="sidebar");l+=`- \`display: grid; grid-template-columns: ${Math.round(M.width)}px 1fr;\`
`}if(g.length>1){const M=Math.round(g[0].width);l+=`- \`display: grid; grid-template-columns: repeat(${g.length}, ${M}px); gap: 16px;\`
`}c&&(l+="- Navigation: `position: sticky; top: 0; z-index: 50;`\n")}return l}function B_(e,t="standard",n){const{sections:o}=e,r=[];for(const m of o){const w=m.originalRect,g=m.currentRect,$=Math.abs(w.x-g.x)>1||Math.abs(w.y-g.y)>1,k=Math.abs(w.width-g.width)>1||Math.abs(w.height-g.height)>1;if(!$&&!k){t==="forensic"&&r.push({section:m,posMoved:!1,sizeChanged:!1});continue}r.push({section:m,posMoved:$,sizeChanged:k})}if(r.length===0||t!=="forensic"&&r.every(m=>!m.posMoved&&!m.sizeChanged))return"";let l=`## Suggested Layout Changes
...
`);const p=m=>o.map(w=>({label:w.label,selector:w.selector,rect:m==="original"?w.originalRect:w.currentRect}));l+=`**Changes:**
`;for(const{section:m,posMoved:w,sizeChanged:g}of r){const $=m.originalRect,k=m.currentRect;if(!w&&!g){l+=`- ${m.label} — unchanged at (${Math.round(k.x)}, ${Math.round(k.y)}) ${Math.round(k.width)}×${Math.round(k.height)}px
`;continue}if(t==="compact"){w&&g?l+=`- Suggested: move **${m.label}** to (${Math.round(k.x)}, ${Math.round(k.y)}) ${Math.round(k.width)}×${Math.round(k.height)}px
`:w?l+=`- Suggested: move **${m.label}** to (${Math.round(k.x)}, ${Math.round(k.y)})
`:l+=`- Suggested: resize **${m.label}** to ${Math.round(k.width)}×${Math.round(k.height)}px
`;continue}if(w&&g?l+=`- Suggested: move and resize **${m.label}**
`:w?l+=`- Suggested: move **${m.label}**
`:l+=`- Suggested: resize **${m.label}** from ${Math.round($.width)}×${Math.round($.height)}px to ${Math.round(k.width)}×${Math.round(k.height)}px
`,w){const M=Fc($,p("original")),f=Fc(k,p("current")),y=g?{width:$.width,height:$.height}:void 0;l+=`  - Currently ${z1(M,{x:$.x,y:$.y},y)}
`;const b=g?{width:k.width,height:k.height}:void 0,N=`at (${Math.round(k.x)}, ${Math.round(k.y)})`,W=b?`, ${Math.round(b.width)}×${Math.round(b.height)}px`:"",D=gp(f,{includeLeftRight:t==="detailed"||t==="forensic"});if(D.length>0){l+=`  - Suggested position ${N}${W}: ${D[0]}
`;for(let he=1;he<D.length;he++)l+=`    ${D[he]}
`}else l+=`  - Suggested position ${N}${W}
`;const Q=xp(k,c);Q&&(l+=`  - CSS: ${Q}
`)}const j=W1(m.selector);if(j&&(l+=`  - ${j}
`),l+=`  - Selector: \`${m.selector}\`
`,t==="detailed"||t==="forensic"){const M=m.className?`${m.tagName}.${m.className.split(" ")[0]}`:m.tagName;M!==m.selector&&(l+=`  - Element: \`${M}\`
`),m.role&&(l+=`  - Role: \`${m.role}\`
`),t==="forensic"&&m.textSnippet&&(l+=`  - Text: "${m.textSnippet}"
...
[data-agentation-theme=light] .styles-module__markerTooltip___-VUm- .styles-module__markerNote___Rh4eI {
  color: rgba(0, 0, 0, 0.85);
}`,Mx={marker:"styles-module__marker___9CKF7",enter:"styles-module__enter___8kI3q",exit:"styles-module__exit___KBdR3",clearing:"styles-module__clearing___8rM7K",pending:"styles-module__pending___BiY-U",fixed:"styles-module__fixed___aKrQO",multiSelect:"styles-module__multiSelect___CPfTC",hovered:"styles-module__hovered___-mg2N",renumber:"styles-module__renumber___16lvD",markerTooltip:"styles-module__markerTooltip___-VUm-",markerQuote:"styles-module__markerQuote___tQake",markerNote:"styles-module__markerNote___Rh4eI"};if(typeof document<"u"){let e=document.getElementById("feedback-tool-styles-annotation-marker-styles");e||(e=document.createElement("style"),e.id="feedback-tool-styles-annotation-marker-styles",document.head.appendChild(e)),e.textContent=jx}var xt=Mx;function U_({annotation:e,globalIndex:t,layerIndex:n,layerSize:o,isExiting:r,isClearing:l,isAnimated:i,isHovered:a,isDeleting:c,isEditingAny:p,renumberFrom:m,markerClickBehavior:w,tooltipStyle:g,onHoverEnter:$,onHoverLeave:k,onClick:j,onContextMenu:M}){const f=(a||c)&&!p,y=f&&w==="delete",b=e.isMultiSelect,N=b?"var(--agentation-color-green)":"var(--agentation-color-accent)",W=r?xt.exit:l?xt.clearing:i?"":xt.enter,Y=r?`${(o-1-n)*20}ms`:`${n*20}ms`;return s.jsxs("div",{className:`${xt.marker} ${b?xt.multiSelect:""} ${W} ${y?xt.hovered:""}`,"data-annotation-marker":!0,style:{left:`${e.x}%`,top:e.y,backgroundColor:y?void 0:N,animationDelay:Y},onMouseEnter:()=>$(e),onMouseLeave:k,onClick:D=>{D.stopPropagation(),r||j(e)},onContextMenu:M?D=>{w==="delete"&&(D.preventDefault(),D.stopPropagation(),r||M(e))}:void 0,children:[f?y?s.jsx(cp,{size:b?18:16}):s.jsx(Ag,{size:16}):s.jsx("span",{className:m!==null&&t>=m?xt.renumber:void 0,children:t+1}),a&&!p&&s.jsxs("div",{className:`${xt.markerTooltip} ${xt.enter}`,style:g,children:[s.jsxs("span",{className:xt.markerQuote,children:[e.element,e.selectedText&&` "${e.selectedText.slice(0,30)}${e.selectedText.length>30?"...":""}"`]}),s.jsx("span",{className:xt.markerNote,children:e.comment})]})]})}function Ex({x:e,y:t,isMultiSelect:n,isExiting:o}){return s.jsx("div",{className:`${xt.marker} ${xt.pending} ${n?xt.multiSelect:""} ${o?xt.exit:xt.enter}`,style:{left:`${e}%`,top:t,backgroundColor:n?"var(--agentation-color-green)":"var(--agentation-color-accent)"},children:s.jsx(Eg,{size:12})})}function Y_({annotation:e,fixed:t}){const n=e.isMultiSelect;return s.jsx("div",{className:`${xt.marker} ${t?xt.fixed:""} ${xt.hovered} ${n?xt.multiSelect:""} ${xt.exit}`,"data-annotation-marker":!0,style:{left:`${e.x}%`,top:e.y},children:s.jsx(cp,{size:n?12:10})})}var Ix=`.styles-module__switchContainer___Ka-AB {
  display: flex;
  align-items: center;
  position: relative;
  padding: 2px;
...
`)}
    ...
    }`].join(""),document.head.appendChild(e)};Ox();function Uo(e,t){let n=document.elementFromPoint(e,t);if(!n)return null;for(;n?.shadowRoot;){const o=n.shadowRoot.elementFromPoint(e,t);if(!o||o===n)break;n=o}return n}function Xa(e){let t=e;for(;t&&t!==document.body;){const o=window.getComputedStyle(t).position;if(o==="fixed"||o==="sticky")return!0;t=t.parentElement}return!1}function Yo(e){return e.status!=="resolved"&&e.status!=="dismissed"}function Yl(e){const t=Uc(e),n=t.found?t:kx(e);if(n.found&&n.source)return bx(n.source,"path")}function Ax({demoAnnotations:e,demoDelay:t=1e3,enableDemoMode:n=!1,onAnnotationAdd:o,onAnnotationDelete:r,onAnnotationUpdate:l,onAnnotationsClear:i,onCopy:a,onSubmit:c,copyToClipboard:p=!0,endpoint:m,sessionId:w,onSessionCreated:g,webhookUrl:$,className:k}={}){const[j,M]=_.useState(!1),[f,y]=_.useState([]),[b,N]=_.useState(!0),[W,Y]=_.useState(()=>J1()),[D,Q]=_.useState(!1),he=_.useRef(null);_.useEffect(()=>{const u=x=>{const v=he.current;v&&v.contains(x.target)&&x.stopPropagation()},h=["mousedown","click","pointerdown"];return h.forEach(x=>document.body.addEventListener(x,u)),()=>{h.forEach(x=>document.body.removeEventListener(x,u))}},[]);const[q,de]=_.useState(!1),[Be,Ae]=_.useState(!1),[ke,Ne]=_.useState(null),[oe,lt]=_.useState({x:0,y:0}),[I,U]=_.useState(null),[G,Se]=_.useState(!1),[Fe,wt]=_.useState("idle"),[Pt,Dt]=_.useState(!1),[Bt,zt]=_.useState(!1),[Vn,ao]=_.useState(null),[co,on]=_.useState(null),[Gt,_n]=_.useState([]),[Sn,uo]=_.useState(null),[Kn,_o]=_.useState(null),[T,ie]=_.useState(null),[Me,ge]=_.useState(null),[Ce,Ye]=_.useState([]),[He,Ie]=_.useState(0),[Xe,at]=_.useState(!1),[ue,C]=_.useState(!1),[E,B]=_.useState(!1),[O,se]=_.useState(!1),[K,F]=_.useState(!1),[we,be]=_.useState("main"),[ze,Ke]=_.useState(!1),[ae,We]=_.useState(!1),[Oe,Le]=_.useState(!1),[re,Ge]=_.useState([]),[je,pe]=_.useState(null),Qe=_.useRef(!1),[$e,fn]=_.useState(!1),[qt,rn]=_.useState(!1),[Bn,hn]=_.useState(1),[ar,sl]=_.useState("new-page"),[mt,Gn]=_.useState(""),[ll,Cp]=_.useState(!1),[xe,pn]=_.useState(null),Qi=_.useRef(!1),Vi=_.useRef({rearrange:null,placements:[]}),Do=_.useRef({rearrange:null,placements:[]}),[jp,Uu]=_.useState(0),[Mp,Ep]=_.useState(0),[Ip,Ki]=_.useState(0),[$p,Yu]=_.useState(0),qr=_.useRef(new Set),il=_.useRef(new Set),Cn=_.useRef(null),al=_.useRef(),Xu=ae&&j&&!Oe&&$e;_.useEffect(()=>{if(Xu){rn(!1);const u=Lr(()=>{rn(!0)});return()=>cancelAnimationFrame(u)}else rn(!1)},[Xu]);const Jr=_.useRef(new Map),Zr=_.useRef(new Map),es=_.useRef(),[jn,Gi]=_.useState(!1),[mn,Np]=_.useState([]),Lp=_.useRef(mn);Lp.current=mn;const[Qu,Fx]=_.useState(null),qi=_.useRef(null);_.useRef(!1),_.useRef([]),_.useRef(0),_.useRef(null),_.useRef(null),_.useRef(1);const[Vu,Ku]=_.useState(!1),cr=_.useRef(null),[bt,ur]=_.useState([]),zn=_.useRef({cmd:!1,shift:!1}),Ot=()=>{Ke(!0)},Rp=()=>{Ke(!1)},Tp=()=>{Vu||(cr.current=fe(()=>Ku(!0),850))},Pp=()=>{cr.current&&(clearTimeout(cr.current),cr.current=null),Ku(!1),Rp()};_.useEffect(()=>()=>{cr.current&&clearTimeout(cr.current)},[]);const[De,Dp]=_.useState(()=>{try{const u=JSON.parse(localStorage.getItem("feedback-toolbar-settings")??"");return{...Ya,...u,annotationColorId:Ps.find(h=>h.id===u.annotationColorId)?u.annotationColorId:Ya.annotationColorId}}catch{return Ya}}),[On,Gu]=_.useState(!0),[qu,Ju]=_.useState(!1),Bp=()=>{he.current?.classList.add(A.disableTransitions),Gu(u=>!u),Lr(()=>{he.current?.classList.remove(A.disableTransitions)})},zp=!1,Bo="off",[Ct,Ji]=_.useState(w??null),Zu=_.useRef(!1),[Mn,zo]=_.useState(m?"connecting":"disconnected"),[ct,Zi]=_.useState(null),[Oo,ed]=_.useState(!1),[dr,td]=_.useState(null),ea=_.useRef(!1),[nd,ts]=_.useState(new Set),[od,cl]=_.useState(new Set),[ns,ul]=_.useState(!1),[Op,_r]=_.useState(!1),[qn,rd]=_.useState(!1),fr=_.useRef(null),An=_.useRef(null),os=_.useRef(null),rs=_.useRef(null),dl=_.useRef(!1),sd=_.useRef(0),_l=_.useRef(null),ld=_.useRef(null),ta=8,Ap=50,id=_.useRef(null),ad=_.useRef(null),ss=_.useRef(null),me=typeof window<"u"?window.location.pathname:"/";_.useEffect(()=>{if(O)F(!0);else{Ke(!1),be("main");const u=fe(()=>F(!1),0);return()=>clearTimeout(u)}},[O]);const na=j&&b&&!ae;_.useEffect(()=>{if(na){Ae(!1),de(!0),ts(new Set);const u=fe(()=>{ts(h=>{const x=new Set(h);return f.forEach(v=>x.add(v.id)),x})},350);return()=>clearTimeout(u)}else if(q){Ae(!0);const u=fe(()=>{de(!1),Ae(!1)},250);return()=>clearTimeout(u)}},[na]),_.useEffect(()=>{C(!0),Ie(window.scrollY);const u=za(me);y(u.filter(Yo)),V_||(Ju(!0),V_=!0,fe(()=>Ju(!1),750));try{const h=localStorage.getItem("feedback-toolbar-theme");h!==null&&Gu(h==="dark")}catch{}try{const h=localStorage.getItem("feedback-toolbar-position");if(h){const x=JSON.parse(h);typeof x.x=="number"&&typeof x.y=="number"&&Zi(x)}}catch{}},[me]),_.useEffect(()=>{ue&&localStorage.setItem("feedback-toolbar-settings",JSON.stringify(De))},[De,ue]),_.useEffect(()=>{ue&&localStorage.setItem("feedback-toolbar-theme",On?"dark":"light")},[On,ue]);const cd=_.useRef(!1);_.useEffect(()=>{const u=cd.current;cd.current=Oo,u&&!Oo&&ct&&ue&&localStorage.setItem("feedback-toolbar-position",JSON.stringify(ct))},[Oo,ct,ue]),_.useEffect(()=>{if(!m||!ue||Zu.current)return;Zu.current=!0,zo("connecting"),(async()=>{try{const h=G1(me),x=w||h;let v=!1;if(x)try{const S=await O_(m,x);Ji(S.id),zo("connected"),Oa(me,S.id),v=!0;const P=za(me),X=new Set(S.annotations.map(ne=>ne.id)),V=P.filter(ne=>!X.has(ne.id));if(V.length>0){const le=`${typeof window<"u"?window.location.origin:""}${me}`,ve=(await Promise.allSettled(V.map(_e=>yr(m,S.id,{..._e,sessionId:S.id,url:le})))).map((_e,Z)=>_e.status==="fulfilled"?_e.value:(console.warn("[Agentation] Failed to sync annotation:",_e.reason),V[Z])),Te=[...S.annotations,...ve];y(Te.filter(Yo)),ys(me,Te.filter(Yo),S.id)}else y(S.annotations.filter(Yo)),ys(me,S.annotations.filter(Yo),S.id)}catch(S){console.warn("[Agentation] Could not join session, creating new:",S),q1(me)}if(!v){const S=typeof window<"u"?window.location.href:"/",P=await Aa(m,S);Ji(P.id),zo("connected"),Oa(me,P.id),g?.(P.id);const X=F1(),V=typeof window<"u"?window.location.origin:"",ne=[];for(const[le,ce]of X){const ve=ce.filter(Z=>!Z._syncedTo);if(ve.length===0)continue;const Te=`${V}${le}`,_e=le===me;ne.push((async()=>{try{const Z=_e?P:await Aa(m,Te),jt=(await Promise.allSettled(ve.map(qe=>yr(m,Z.id,{...qe,sessionId:Z.id,url:Te})))).map((qe,yt)=>qe.status==="fulfilled"?qe.value:(console.warn("[Agentation] Failed to sync annotation:",qe.reason),ve[yt])).filter(Yo);if(ys(le,jt,Z.id),_e){const qe=new Set(ve.map(yt=>yt.id));y(yt=>{const ye=yt.filter(Ee=>!qe.has(Ee.id));return[...jt,...ye]})}}catch(Z){console.warn(`[Agentation] Failed to sync annotations for ${le}:`,Z)}})())}await Promise.allSettled(ne)}}catch(h){zo("disconnected"),console.warn("[Agentation] Failed to initialize session, using local storage:",h)}})()},[m,w,ue,g,me]),_.useEffect(()=>{if(!m||!ue)return;const u=async()=>{try{(await fetch(`${m}/health`)).ok?zo("connected"):zo("disconnected")}catch{zo("disconnected")}};u();const h=Yg(u,1e4);return()=>clearInterval(h)},[m,ue]),_.useEffect(()=>{if(!m||!ue||!Ct)return;const u=new EventSource(`${m}/sessions/${Ct}/events`),h=["resolved","dismissed"],x=v=>{try{const S=JSON.parse(v.data);if(h.includes(S.payload?.status)){const P=S.payload.id,X=S.payload.kind;if(X==="placement"){for(const[V,ne]of Jr.current)if(ne===P){Jr.current.delete(V),Ge(le=>le.filter(ce=>ce.id!==V));break}}else if(X==="rearrange"){for(const[V,ne]of Zr.current)if(ne===P){Zr.current.delete(V),pn(le=>{if(!le)return null;const ce=le.sections.filter(ve=>ve.id!==V);return ce.length===0?null:{...le,sections:ce}});break}}else cl(V=>new Set(V).add(P)),fe(()=>{y(V=>V.filter(ne=>ne.id!==P)),cl(V=>{const ne=new Set(V);return ne.delete(P),ne})},150)}}catch{}};return u.addEventListener("annotation.updated",x),()=>{u.removeEventListener("annotation.updated",x),u.close()}},[m,ue,Ct]),_.useEffect(()=>{if(!m||!ue)return;const u=ld.current==="disconnected",h=Mn==="connected";ld.current=Mn,u&&h&&(async()=>{try{const v=za(me);if(v.length===0)return;const P=`${typeof window<"u"?window.location.origin:""}${me}`;let X=Ct,V=[];if(X)try{V=(await O_(m,X)).annotations}catch{X=null}X||(X=(await Aa(m,P)).id,Ji(X),Oa(me,X));const ne=new Set(V.map(ce=>ce.id)),le=v.filter(ce=>!ne.has(ce.id));if(le.length>0){const ve=(await Promise.allSettled(le.map(Z=>yr(m,X,{...Z,sessionId:X,url:P})))).map((Z,gt)=>Z.status==="fulfilled"?Z.value:(console.warn("[Agentation] Failed to sync annotation on reconnect:",Z.reason),le[gt])),_e=[...V,...ve].filter(Yo);y(_e),ys(me,_e,X)}}catch(v){console.warn("[Agentation] Failed to sync on reconnect:",v)}})()},[Mn,m,ue,Ct,me]);const Wp=_.useCallback(()=>{D||(Q(!0),se(!1),M(!1),fe(()=>{Z1(!0),Y(!0),Q(!1)},400))},[D]);_.useEffect(()=>{if(!n||!ue||!e||e.length===0||f.length>0)return;const u=[];return u.push(fe(()=>{M(!0)},t-200)),e.forEach((h,x)=>{const v=t+x*300;u.push(fe(()=>{const S=document.querySelector(h.selector);if(!S)return;const P=S.getBoundingClientRect(),{name:X,path:V}=Or(S),ne={id:`demo-${Date.now()}-${x}`,x:(P.left+P.width/2)/window.innerWidth*100,y:P.top+P.height/2+window.scrollY,comment:h.comment,element:X,elementPath:V,timestamp:Date.now(),selectedText:h.selectedText,boundingBox:{x:P.left,y:P.top+window.scrollY,width:P.width,height:P.height},nearbyText:ms(S),cssClasses:gs(S)};y(le=>[...le,ne])},v))}),()=>{u.forEach(clearTimeout)}},[n,ue,e,t]),_.useEffect(()=>{const u=()=>{Ie(window.scrollY),at(!0),ss.current&&clearTimeout(ss.current),ss.current=fe(()=>{at(!1)},150)};return window.addEventListener("scroll",u,{passive:!0}),()=>{window.removeEventListener("scroll",u),ss.current&&clearTimeout(ss.current)}},[]),_.useEffect(()=>{ue&&f.length>0?Ct?ys(me,f,Ct):bp(me,f):ue&&f.length===0&&localStorage.removeItem($i(me))},[f,me,ue,Ct]),_.useEffect(()=>{if(ue&&!Qe.current){Qe.current=!0;const u=H1(me);u.length>0&&Ge(u)}},[ue,me]),_.useEffect(()=>{ue&&Qe.current&&!$e&&(re.length>0?U1(me,re):Y1(me))},[re,me,ue,$e]),_.useEffect(()=>{if(ue&&!Qi.current){Qi.current=!0;const u=X1(me);if(u){const h={...u,sections:u.sections.map(x=>({...x,currentRect:x.currentRect??{...x.originalRect}}))};pn(h)}}},[ue,me]),_.useEffect(()=>{ue&&Qi.current&&!$e&&(xe?Q1(me,xe):V1(me))},[xe,me,ue,$e]);const oa=_.useRef(!1);_.useEffect(()=>{if(ue&&!oa.current){oa.current=!0;const u=K1(me);u&&(Do.current={rearrange:u.rearrange,placements:u.placements||[]},u.purpose&&Gn(u.purpose))}},[ue,me]),_.useEffect(()=>{if(!ue||!oa.current)return;const u=Do.current;$e?(xe?.sections?.length??0)>0||re.length>0||mt?z_(me,{rearrange:xe,placements:re,purpose:mt}):Fl(me):(u.rearrange?.sections?.length??0)>0||u.placements.length>0||mt?z_(me,{rearrange:u.rearrange,placements:u.placements,purpose:mt}):Fl(me)},[xe,re,mt,$e,me,ue]),_.useEffect(()=>{ae&&!xe&&pn({sections:[],originalOrder:[],detectedAt:Date.now()})},[ae,xe]),_.useEffect(()=>{if(!m||!Ct)return;const u=Jr.current,h=new Set(re.map(x=>x.id));for(const x of re){if(u.has(x.id))continue;u.set(x.id,"");const v=typeof window<"u"?window.location.pathname+window.location.search+window.location.hash:me;yr(m,Ct,{id:x.id,x:x.x/window.innerWidth*100,y:x.y,comment:`Place ${x.type} at (${Math.round(x.x)}, ${Math.round(x.y)}), ${x.width}×${x.height}px${x.text?` — "${x.text}"`:""}`,element:`[design:${x.type}]`,elementPath:"[placement]",timestamp:x.timestamp,url:v,intent:"change",severity:"important",kind:"placement",placement:{componentType:x.type,width:x.width,height:x.height,scrollY:x.scrollY,text:x.text}}).then(S=>{u.has(x.id)&&u.set(x.id,S.id)}).catch(S=>{console.warn("[Agentation] Failed to sync placement annotation:",S),u.delete(x.id)})}for(const[x,v]of u)h.has(x)||(u.delete(x),v&&mo(m,v).catch(()=>{}))},[re,m,Ct,me]),_.useEffect(()=>{if(!(!m||!Ct))return es.current&&clearTimeout(es.current),es.current=fe(()=>{const u=Zr.current;if(!xe||xe.sections.length===0){for(const[,v]of u)v&&mo(m,v).catch(()=>{});u.clear();return}const h=new Set(xe.sections.map(v=>v.id)),x=typeof window<"u"?window.location.pathname+window.location.search+window.location.hash:me;for(const v of xe.sections){const S=v.originalRect,P=v.currentRect;if(!(Math.abs(S.x-P.x)>1||Math.abs(S.y-P.y)>1||Math.abs(S.width-P.width)>1||Math.abs(S.height-P.height)>1)){const ne=u.get(v.id);ne&&(u.delete(v.id),mo(m,ne).catch(()=>{}));continue}const V=u.get(v.id);V?A_(m,V,{comment:`Move ${v.label} section (${v.tagName}) — from (${Math.round(S.x)},${Math.round(S.y)}) ${Math.round(S.width)}×${Math.round(S.height)} to (${Math.round(P.x)},${Math.round(P.y)}) ${Math.round(P.width)}×${Math.round(P.height)}`}).catch(ne=>{console.warn("[Agentation] Failed to update rearrange annotation:",ne)}):(u.set(v.id,""),yr(m,Ct,{id:v.id,x:P.x/window.innerWidth*100,y:P.y,comment:`Move ${v.label} section (${v.tagName}) — from (${Math.round(S.x)},${Math.round(S.y)}) ${Math.round(S.width)}×${Math.round(S.height)} to (${Math.round(P.x)},${Math.round(P.y)}) ${Math.round(P.width)}×${Math.round(P.height)}`,element:v.selector,elementPath:"[rearrange]",timestamp:Date.now(),url:x,intent:"change",severity:"important",kind:"rearrange",rearrange:{selector:v.selector,label:v.label,tagName:v.tagName,originalRect:S,currentRect:P}}).then(ne=>{u.has(v.id)&&u.set(v.id,ne.id)}).catch(ne=>{console.warn("[Agentation] Failed to sync rearrange annotation:",ne),u.delete(v.id)}))}for(const[v,S]of u)h.has(v)||(u.delete(v),S&&mo(m,S).catch(()=>{}))},300),()=>{es.current&&clearTimeout(es.current)}},[xe,m,Ct,me]);const hr=_.useRef(new Map);_.useLayoutEffect(()=>{const u=xe?.sections??[],h=new Set;if((ae||Oe)&&j)for(const x of u){h.add(x.id);try{const v=document.querySelector(x.selector);if(!v)continue;if(!hr.current.has(x.id)){const S={transform:v.style.transform,transformOrigin:v.style.transformOrigin,opacity:v.style.opacity,position:v.style.position,zIndex:v.style.zIndex,display:v.style.display},P=[];let X=v.parentElement;for(;X&&X!==document.body;){const ne=getComputedStyle(X);(ne.overflow!=="visible"||ne.overflowX!=="visible"||ne.overflowY!=="visible")&&(P.push({el:X,overflow:X.style.overflow}),X.style.overflow="visible"),X=X.parentElement}getComputedStyle(v).display==="inline"&&(v.style.display="inline-block"),hr.current.set(x.id,{el:v,origStyles:S,ancestors:P}),v.style.transformOrigin="top left",v.style.zIndex="9999"}}catch{}}for(const[x,v]of hr.current)if(!h.has(x)){const{el:S,origStyles:P,ancestors:X}=v;S.style.transition="transform 0.4s cubic-bezier(0.22, 1, 0.36, 1), opacity 0.4s cubic-bezier(0.22, 1, 0.36, 1)",S.style.transform=P.transform,S.style.transformOrigin=P.transformOrigin,S.style.opacity=P.opacity,S.style.position=P.position,S.style.zIndex=P.zIndex,hr.current.delete(x),fe(()=>{S.style.transition="",S.style.display=P.display;for(const V of X)V.el.style.overflow=V.overflow},450)}},[xe,ae,Oe,j]),_.useEffect(()=>()=>{for(const[,u]of hr.current){const{el:h,origStyles:x,ancestors:v}=u;h.style.transition="transform 0.4s cubic-bezier(0.22, 1, 0.36, 1), opacity 0.4s cubic-bezier(0.22, 1, 0.36, 1)",h.style.transform=x.transform,h.style.transformOrigin=x.transformOrigin,h.style.opacity=x.opacity,h.style.position=x.position,h.style.zIndex=x.zIndex,fe(()=>{h.style.transition="",h.style.display=x.display;for(const S of v)S.el.style.overflow=S.overflow},450)}hr.current.clear()},[]);const fl=_.useCallback(()=>{Le(!0),We(!1),pe(null),clearTimeout(al.current),al.current=fe(()=>{Le(!1)},300)},[]),ud=_.useCallback(()=>{ae&&(Le(!0),We(!1),pe(null),clearTimeout(al.current),al.current=fe(()=>{Le(!1)},300)),M(!1)},[ae]),dd=_.useCallback(()=>{E||(Qg(),B(!0))},[E]),hl=_.useCallback(()=>{E&&(S_(),B(!1))},[E]),ra=_.useCallback(()=>{E?hl():dd()},[E,dd,hl]),_d=_.useCallback(()=>{if(bt.length===0)return;const u=bt[0],h=u.element,x=bt.length>1,v=bt.map(S=>S.element.getBoundingClientRect());if(x){const S={left:Math.min(...v.map(Z=>Z.left)),top:Math.min(...v.map(Z=>Z.top)),right:Math.max(...v.map(Z=>Z.right)),bottom:Math.max(...v.map(Z=>Z.bottom))},P=bt.slice(0,5).map(Z=>Z.name).join(", "),X=bt.length>5?` +${bt.length-5} more`:"",V=v.map(Z=>({x:Z.left,y:Z.top+window.scrollY,width:Z.width,height:Z.height})),le=bt[bt.length-1].element,ce=v[v.length-1],ve=ce.left+ce.width/2,Te=ce.top+ce.height/2,_e=Xa(le);U({x:ve/window.innerWidth*100,y:_e?Te:Te+window.scrollY,clientY:Te,element:`${bt.length} elements: ${P}${X}`,elementPath:"multi-select",boundingBox:{x:S.left,y:S.top+window.scrollY,width:S.right-S.left,height:S.bottom-S.top},isMultiSelect:!0,isFixed:_e,elementBoundingBoxes:V,multiSelectElements:bt.map(Z=>Z.element),targetElement:le,fullPath:Ol(h),accessibility:zl(h),computedStyles:Bl(h),computedStylesObj:Dl(h),nearbyElements:Pl(h),cssClasses:gs(h),nearbyText:ms(h),sourceFile:Yl(h)})}else{const S=v[0],P=Xa(h);U({x:S.left/window.innerWidth*100,y:P?S.top:S.top+window.scrollY,clientY:S.top,element:u.name,elementPath:u.path,boundingBox:{x:S.left,y:P?S.top:S.top+window.scrollY,width:S.width,height:S.height},isFixed:P,fullPath:Ol(h),accessibility:zl(h),computedStyles:Bl(h),computedStylesObj:Dl(h),nearbyElements:Pl(h),cssClasses:gs(h),nearbyText:ms(h),reactComponents:u.reactComponents,sourceFile:Yl(h)})}ur([]),Ne(null)},[bt]);_.useEffect(()=>{j||(U(null),ie(null),ge(null),Ye([]),Ne(null),se(!1),ur([]),zn.current={cmd:!1,shift:!1},E&&hl())},[j,E,hl]),_.useEffect(()=>()=>{S_()},[]),_.useEffect(()=>{if(!j)return;const u=["p","span","h1","h2","h3","h4","h5","h6","li","td","th","label","blockquote","figcaption","caption","legend","dt","dd","pre","code","em","strong","b","i","u","s","a","time","address","cite","q","abbr","dfn","mark","small","sub","sup","[contenteditable]"].join(", "),h=":not([data-agentation-root]):not([data-agentation-root] *)",x=document.createElement("style");return x.id="feedback-cursor-styles",x.textContent=`
      body ${h} {
        cursor: crosshair !important;
      }
    ...
    `,document.head.appendChild(x),()=>{const v=document.getElementById("feedback-cursor-styles");v&&v.remove()}},[j]),_.useEffect(()=>{if(Qu!==null&&j)return document.documentElement.setAttribute("data-drawing-hover",""),()=>document.documentElement.removeAttribute("data-drawing-hover")},[Qu,j]),_.useEffect(()=>{if(!j||I||jn||ae)return;const u=h=>{const x=h.composedPath()[0]||h.target;if(Ut(x,"[data-feedback-toolbar]")){Ne(null);return}const v=Uo(h.clientX,h.clientY);if(!v||Ut(v,"[data-feedback-toolbar]")){Ne(null);return}const{name:S,elementName:P,path:X,reactComponents:V}=Ua(v,Bo),ne=v.getBoundingClientRect();Ne({element:S,elementName:P,elementPath:X,rect:ne,reactComponents:V}),lt({x:h.clientX,y:h.clientY})};return document.addEventListener("mousemove",u),()=>document.removeEventListener("mousemove",u)},[j,I,jn,ae,Bo,mn]);const pl=_.useCallback(u=>{if(ie(u),ao(null),on(null),_n([]),u.elementBoundingBoxes?.length){const h=[];for(const x of u.elementBoundingBoxes){const v=x.x+x.width/2,S=x.y+x.height/2-window.scrollY,P=Uo(v,S);P&&h.push(P)}Ye(h),ge(null)}else if(u.boundingBox){const h=u.boundingBox,x=h.x+h.width/2,v=u.isFixed?h.y+h.height/2:h.y+h.height/2-window.scrollY,S=Uo(x,v);if(S){const P=S.getBoundingClientRect(),X=P.width/h.width,V=P.height/h.height;X<.5||V<.5?ge(null):ge(S)}else ge(null);Ye([])}else ge(null),Ye([])},[]);_.useEffect(()=>{if(!j||jn||ae)return;const u=h=>{if(dl.current){dl.current=!1;return}const x=h.composedPath()[0]||h.target;if(Ut(x,"[data-feedback-toolbar]")||Ut(x,"[data-annotation-popup]")||Ut(x,"[data-annotation-marker]"))return;if(h.metaKey&&h.shiftKey&&!I&&!T){h.preventDefault(),h.stopPropagation();const et=Uo(h.clientX,h.clientY);if(!et)return;const jt=et.getBoundingClientRect(),{name:qe,path:yt,reactComponents:ye}=Ua(et,Bo),Ee=bt.findIndex(ut=>ut.element===et);Ee>=0?ur(ut=>ut.filter((ht,En)=>En!==Ee)):ur(ut=>[...ut,{element:et,rect:jt,name:qe,path:yt,reactComponents:ye??void 0}]);return}const v=Ut(x,"button, a, input, select, textarea, [role='button'], [onclick]");if(De.blockInteractions&&v&&(h.preventDefault(),h.stopPropagation()),I){if(v&&!De.blockInteractions)return;h.preventDefault(),id.current?.shake();return}if(T){if(v&&!De.blockInteractions)return;h.preventDefault(),ad.current?.shake();return}h.preventDefault();const S=Uo(h.clientX,h.clientY);if(!S)return;const{name:P,path:X,reactComponents:V}=Ua(S,Bo),ne=S.getBoundingClientRect(),le=h.clientX/window.innerWidth*100,ce=Xa(S),ve=ce?h.clientY:h.clientY+window.scrollY,Te=window.getSelection();let _e;Te&&Te.toString().trim().length>0&&(_e=Te.toString().trim().slice(0,500));const Z=Dl(S),gt=Bl(S);U({x:le,y:ve,clientY:h.clientY,element:P,elementPath:X,selectedText:_e,boundingBox:{x:ne.left,y:ce?ne.top:ne.top+window.scrollY,width:ne.width,height:ne.height},nearbyText:ms(S),cssClasses:gs(S),isFixed:ce,fullPath:Ol(S),accessibility:zl(S),computedStyles:gt,computedStylesObj:Z,nearbyElements:Pl(S),reactComponents:V??void 0,sourceFile:Yl(S),targetElement:S}),Ne(null)};return document.addEventListener("click",u,!0),()=>document.removeEventListener("click",u,!0)},[j,jn,ae,I,T,De.blockInteractions,Bo,bt]),_.useEffect(()=>{if(!j)return;const u=v=>{v.key==="Meta"&&(zn.current.cmd=!0),v.key==="Shift"&&(zn.current.shift=!0)},h=v=>{const S=zn.current.cmd&&zn.current.shift;v.key==="Meta"&&(zn.current.cmd=!1),v.key==="Shift"&&(zn.current.shift=!1);const P=zn.current.cmd&&zn.current.shift;S&&!P&&bt.length>0&&_d()},x=()=>{zn.current={cmd:!1,shift:!1},ur([])};return document.addEventListener("keydown",u),document.addEventListener("keyup",h),window.addEventListener("blur",x),()=>{document.removeEventListener("keydown",u),document.removeEventListener("keyup",h),window.removeEventListener("blur",x)}},[j,bt,_d]),_.useEffect(()=>{if(!j||I||jn||ae)return;const u=h=>{const x=h.composedPath()[0]||h.target;Ut(x,"[data-feedback-toolbar]")||Ut(x,"[data-annotation-marker]")||Ut(x,"[data-annotation-popup]")||new Set(["P","SPAN","H1","H2","H3","H4","H5","H6","LI","TD","TH","LABEL","BLOCKQUOTE","FIGCAPTION","CAPTION","LEGEND","DT","DD","PRE","CODE","EM","STRONG","B","I","U","S","A","TIME","ADDRESS","CITE","Q","ABBR","DFN","MARK","SMALL","SUB","SUP"]).has(x.tagName)||x.isContentEditable||(h.preventDefault(),fr.current={x:h.clientX,y:h.clientY})};return document.addEventListener("mousedown",u),()=>document.removeEventListener("mousedown",u)},[j,I,jn,ae]),_.useEffect(()=>{if(!j||I)return;const u=h=>{if(!fr.current)return;const x=h.clientX-fr.current.x,v=h.clientY-fr.current.y,S=x*x+v*v,P=ta*ta;if(!qn&&S>=P&&(An.current=fr.current,rd(!0),h.preventDefault()),(qn||S>=P)&&An.current){if(os.current){const ye=Math.min(An.current.x,h.clientX),Ee=Math.min(An.current.y,h.clientY),ut=Math.abs(h.clientX-An.current.x),ht=Math.abs(h.clientY-An.current.y);os.current.style.transform=`translate(${ye}px, ${Ee}px)`,os.current.style.width=`${ut}px`,os.current.style.height=`${ht}px`}const X=Date.now();if(X-sd.current<Ap)return;sd.current=X;const V=An.current.x,ne=An.current.y,le=Math.min(V,h.clientX),ce=Math.min(ne,h.clientY),ve=Math.max(V,h.clientX),Te=Math.max(ne,h.clientY),_e=(le+ve)/2,Z=(ce+Te)/2,gt=new Set,et=[[le,ce],[ve,ce],[le,Te],[ve,Te],[_e,Z],[_e,ce],[_e,Te],[le,Z],[ve,Z]];for(const[ye,Ee]of et){const ut=document.elementsFromPoint(ye,Ee);for(const ht of ut)ht instanceof HTMLElement&&gt.add(ht)}const jt=document.querySelectorAll("button, a, input, img, p, h1, h2, h3, h4, h5, h6, li, label, td, th, div, span, section, article, aside, nav");for(const ye of jt)if(ye instanceof HTMLElement){const Ee=ye.getBoundingClientRect(),ut=Ee.left+Ee.width/2,ht=Ee.top+Ee.height/2,En=ut>=le&&ut<=ve&&ht>=ce&&ht<=Te,gn=Math.min(Ee.right,ve)-Math.max(Ee.left,le),Nt=Math.min(Ee.bottom,Te)-Math.max(Ee.top,ce),is=gn>0&&Nt>0?gn*Nt:0,Wo=Ee.width*Ee.height,fo=Wo>0?is/Wo:0;(En||fo>.5)&&gt.add(ye)}const qe=[],yt=new Set(["BUTTON","A","INPUT","IMG","P","H1","H2","H3","H4","H5","H6","LI","LABEL","TD","TH","SECTION","ARTICLE","ASIDE","NAV"]);for(const ye of gt){if(Ut(ye,"[data-feedback-toolbar]")||Ut(ye,"[data-annotation-marker]"))continue;const Ee=ye.getBoundingClientRect();if(!(Ee.width>window.innerWidth*.8&&Ee.height>window.innerHeight*.5)&&!(Ee.width<10||Ee.height<10)&&Ee.left<ve&&Ee.right>le&&Ee.top<Te&&Ee.bottom>ce){const ut=ye.tagName;let ht=yt.has(ut);if(!ht&&(ut==="DIV"||ut==="SPAN")){const En=ye.textContent&&ye.textContent.trim().length>0,gn=ye.onclick!==null||ye.getAttribute("role")==="button"||ye.getAttribute("role")==="link"||ye.classList.contains("clickable")||ye.hasAttribute("data-clickable");(En||gn)&&!ye.querySelector("p, h1, h2, h3, h4, h5, h6, button, a")&&(ht=!0)}if(ht){let En=!1;for(const gn of qe)if(gn.left<=Ee.left&&gn.right>=Ee.right&&gn.top<=Ee.top&&gn.bottom>=Ee.bottom){En=!0;break}En||qe.push(Ee)}}}if(rs.current){const ye=rs.current;for(;ye.children.length>qe.length;)ye.removeChild(ye.lastChild);qe.forEach((Ee,ut)=>{let ht=ye.children[ut];ht||(ht=document.createElement("div"),ht.className=A.selectedElementHighlight,ye.appendChild(ht)),ht.style.transform=`translate(${Ee.left}px, ${Ee.top}px)`,ht.style.width=`${Ee.width}px`,ht.style.height=`${Ee.height}px`})}}};return document.addEventListener("mousemove",u,{passive:!0}),()=>document.removeEventListener("mousemove",u)},[j,I,qn,ta]),_.useEffect(()=>{if(!j)return;const u=h=>{const x=qn,v=An.current;if(qn&&v){dl.current=!0;const S=Math.min(v.x,h.clientX),P=Math.min(v.y,h.clientY),X=Math.max(v.x,h.clientX),V=Math.max(v.y,h.clientY),ne=[];document.querySelectorAll("button, a, input, img, p, h1, h2, h3, h4, h5, h6, li, label, td, th").forEach(_e=>{if(!(_e instanceof HTMLElement)||Ut(_e,"[data-feedback-toolbar]")||Ut(_e,"[data-annotation-marker]"))return;const Z=_e.getBoundingClientRect();Z.width>window.innerWidth*.8&&Z.height>window.innerHeight*.5||Z.width<10||Z.height<10||Z.left<X&&Z.right>S&&Z.top<V&&Z.bottom>P&&ne.push({element:_e,rect:Z})});const ce=ne.filter(({element:_e})=>!ne.some(({element:Z})=>Z!==_e&&_e.contains(Z))),ve=h.clientX/window.innerWidth*100,Te=h.clientY+window.scrollY;if(ce.length>0){const _e=ce.reduce((yt,{rect:ye})=>({left:Math.min(yt.left,ye.left),top:Math.min(yt.top,ye.top),right:Math.max(yt.right,ye.right),bottom:Math.max(yt.bottom,ye.bottom)}),{left:1/0,top:1/0,right:-1/0,bottom:-1/0}),Z=ce.slice(0,5).map(({element:yt})=>Or(yt).name).join(", "),gt=ce.length>5?` +${ce.length-5} more`:"",et=ce[0].element,jt=Dl(et),qe=Bl(et);U({x:ve,y:Te,clientY:h.clientY,element:`${ce.length} elements: ${Z}${gt}`,elementPath:"multi-select",boundingBox:{x:_e.left,y:_e.top+window.scrollY,width:_e.right-_e.left,height:_e.bottom-_e.top},isMultiSelect:!0,fullPath:Ol(et),accessibility:zl(et),computedStyles:qe,computedStylesObj:jt,nearbyElements:Pl(et),cssClasses:gs(et),nearbyText:ms(et),sourceFile:Yl(et)})}else{const _e=Math.abs(X-S),Z=Math.abs(V-P);_e>20&&Z>20&&U({x:ve,y:Te,clientY:h.clientY,element:"Area selection",elementPath:`region at (${Math.round(S)}, ${Math.round(P)})`,boundingBox:{x:S,y:P+window.scrollY,width:_e,height:Z},isMultiSelect:!0})}Ne(null)}else x&&(dl.current=!0);fr.current=null,An.current=null,rd(!1),rs.current&&(rs.current.innerHTML="")};return document.addEventListener("mouseup",u),()=>document.removeEventListener("mouseup",u)},[j,qn]);const Wn=_.useCallback(async(u,h,x)=>{const v=De.webhookUrl||$;if(!v||!De.webhooksEnabled&&!x)return!1;try{return(await fetch(v,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({event:u,timestamp:Date.now(),url:typeof window<"u"?window.location.href:void 0,...h})})).ok}catch(S){return console.warn("[Agentation] Webhook failed:",S),!1}},[$,De.webhookUrl,De.webhooksEnabled]),Fp=_.useCallback(u=>{if(!I)return;const h={id:Date.now().toString(),x:I.x,y:I.y,comment:u,element:I.element,elementPath:I.elementPath,timestamp:Date.now(),selectedText:I.selectedText,boundingBox:I.boundingBox,nearbyText:I.nearbyText,cssClasses:I.cssClasses,isMultiSelect:I.isMultiSelect,isFixed:I.isFixed,fullPath:I.fullPath,accessibility:I.accessibility,computedStyles:I.computedStyles,nearbyElements:I.nearbyElements,reactComponents:I.reactComponents,sourceFile:I.sourceFile,elementBoundingBoxes:I.elementBoundingBoxes,...m&&Ct?{sessionId:Ct,url:typeof window<"u"?window.location.href:void 0,status:"pending"}:{}};y(x=>[...x,h]),_l.current=h.id,fe(()=>{_l.current=null},300),fe(()=>{ts(x=>new Set(x).add(h.id))},250),o?.(h),Wn("annotation.add",{annotation:h}),ul(!0),fe(()=>{U(null),ul(!1)},150),window.getSelection()?.removeAllRanges(),m&&Ct&&yr(m,Ct,h).then(x=>{x.id!==h.id&&(y(v=>v.map(S=>S.id===h.id?{...S,id:x.id}:S)),ts(v=>{const S=new Set(v);return S.delete(h.id),S.add(x.id),S}))}).catch(x=>{console.warn("[Agentation] Failed to sync annotation:",x)})},[I,o,Wn,m,Ct]),sa=_.useCallback(()=>{ul(!0),fe(()=>{U(null),ul(!1)},150)},[]),la=_.useCallback(u=>{const h=f.findIndex(v=>v.id===u),x=f[h];T?.id===u&&(_r(!0),fe(()=>{ie(null),ge(null),Ye([]),_r(!1)},150)),uo(u),cl(v=>new Set(v).add(u)),x&&(r?.(x),Wn("annotation.delete",{annotation:x})),m&&mo(m,u).catch(v=>{console.warn("[Agentation] Failed to delete annotation from server:",v)}),fe(()=>{y(v=>v.filter(S=>S.id!==u)),cl(v=>{const S=new Set(v);return S.delete(u),S}),uo(null),h<f.length-1&&(_o(h),fe(()=>_o(null),200))},150)},[f,T,r,Wn,m]),ml=_.useCallback(u=>{if(!u){ao(null),on(null),_n([]);return}if(ao(u.id),u.elementBoundingBoxes?.length){const h=[];for(const x of u.elementBoundingBoxes){const v=x.x+x.width/2,S=x.y+x.height/2-window.scrollY,X=document.elementsFromPoint(v,S).find(V=>!V.closest("[data-annotation-marker]")&&!V.closest("[data-agentation-root]"));X&&h.push(X)}_n(h),on(null)}else if(u.boundingBox){const h=u.boundingBox,x=h.x+h.width/2,v=u.isFixed?h.y+h.height/2:h.y+h.height/2-window.scrollY,S=Uo(x,v);if(S){const P=S.getBoundingClientRect(),X=P.width/h.width,V=P.height/h.height;X<.5||V<.5?on(null):on(S)}else on(null);_n([])}else on(null),_n([])},[]),Hp=_.useCallback(u=>{if(!T)return;const h={...T,comment:u};y(x=>x.map(v=>v.id===T.id?h:v)),l?.(h),Wn("annotation.update",{annotation:h}),m&&A_(m,T.id,{comment:u}).catch(x=>{console.warn("[Agentation] Failed to update annotation on server:",x)}),_r(!0),fe(()=>{ie(null),ge(null),Ye([]),_r(!1)},150)},[T,l,Wn,m]),Up=_.useCallback(()=>{_r(!0),fe(()=>{ie(null),ge(null),Ye([]),_r(!1)},150)},[]),Ao=_.useCallback(()=>{const u=f.length,h=re.length>0||!!xe;if(u===0&&mn.length===0&&!h)return;if(i?.(f),Wn("annotations.clear",{annotations:f}),m){Promise.all(f.map(S=>mo(m,S.id).catch(P=>{console.warn("[Agentation] Failed to delete annotation from server:",P)})));for(const[,S]of Jr.current)S&&mo(m,S).catch(()=>{});Jr.current.clear();for(const[,S]of Zr.current)S&&mo(m,S).catch(()=>{});Zr.current.clear()}zt(!0),Dt(!0),Np([]);const x=qi.current;if(x){const S=x.getContext("2d");S&&S.clearRect(0,0,x.width,x.height)}(re.length>0||xe)&&(Ki(S=>S+1),Yu(S=>S+1),fe(()=>{Ge([]),pn(null)},200)),$e&&fn(!1),mt&&Gn(""),Do.current={rearrange:null,placements:[]},Fl(me);const v=u*30+200;fe(()=>{y([]),ts(new Set),localStorage.removeItem($i(me)),zt(!1)},v),fe(()=>Dt(!1),1500)},[me,f,mn,re,xe,$e,mt,i,Wn,m]),ia=_.useCallback(async()=>{const u=typeof window<"u"?window.location.pathname+window.location.search+window.location.hash:me,h=ae&&$e;let x;if(h){if(re.length===0&&!xe&&!mt)return;x=""}else{if(x=H_(f,u,De.outputDetail),!x&&mn.length===0&&re.length===0&&!xe)return;x||(x=`## Page Feedback: ${u}
`)}if(!h&&mn.length>0){const v=new Set;for(const V of f)V.drawingIndex!=null&&v.add(V.drawingIndex);const S=qi.current;S&&(S.style.visibility="hidden");const P=[],X=window.scrollY;for(let V=0;V<mn.length;V++){if(v.has(V))continue;const ne=mn[V];if(ne.points.length<2)continue;const le=ne.fixed?ne.points:ne.points.map(kt=>({x:kt.x,y:kt.y-X}));let ce=1/0,ve=1/0,Te=-1/0,_e=-1/0;for(const kt of le)ce=Math.min(ce,kt.x),ve=Math.min(ve,kt.y),Te=Math.max(Te,kt.x),_e=Math.max(_e,kt.y);const Z=Te-ce,gt=_e-ve,et=Math.hypot(Z,gt),jt=le[0],qe=le[le.length-1],yt=Math.hypot(qe.x-jt.x,qe.y-jt.y);let ye;const Ee=yt<et*.35,ut=Z/Math.max(gt,1);if(Ee&&et>20){const kt=Math.max(Z,gt)*.15;let ho=0;for(const Fo of le){const Qp=Fo.x-ce<kt,Vp=Te-Fo.x<kt,Kp=Fo.y-ve<kt,Gp=_e-Fo.y<kt;(Qp||Vp)&&(Kp||Gp)&&ho++}ye=ho>le.length*.15?"box":"circle"}else ut>3&&gt<40?ye="underline":yt>et*.5?ye="arrow":ye="drawing";const ht=Math.min(10,le.length),En=Math.max(1,Math.floor(le.length/ht)),gn=new Set,Nt=[],is=[jt];for(let kt=En;kt<le.length-1;kt+=En)is.push(le[kt]);is.push(qe);for(const kt of is){const ho=Uo(kt.x,kt.y);if(!ho||gn.has(ho)||Ut(ho,"[data-feedback-toolbar]"))continue;gn.add(ho);const{name:Fo}=Or(ho);Nt.includes(Fo)||Nt.push(Fo)}const Wo=`${Math.round(ce)},${Math.round(ve)} → ${Math.round(Te)},${Math.round(_e)}`;let fo;(ye==="circle"||ye==="box")&&Nt.length>0?fo=`${ye==="box"?"Boxed":"Circled"} **${Nt[0]}**${Nt.length>1?` (and ${Nt.slice(1).join(", ")})`:""} (region: ${Wo})`:ye==="underline"&&Nt.length>0?fo=`Underlined **${Nt[0]}** (${Wo})`:ye==="arrow"&&Nt.length>=2?fo=`Arrow from **${Nt[0]}** to **${Nt[Nt.length-1]}** (${Math.round(jt.x)},${Math.round(jt.y)} → ${Math.round(qe.x)},${Math.round(qe.y)})`:Nt.length>0?fo=`${ye==="arrow"?"Arrow":"Drawing"} near **${Nt.join("**, **")}** (region: ${Wo})`:fo=`Drawing at ${Wo}`,P.push(fo)}S&&(S.style.visibility=""),P.length>0&&(x+=`
**Drawings:**
`,P.forEach((V,ne)=>{x+=`${ne+1}. ${V}
`}))}if((re.length>0||h&&mt)&&(x+=`
`+D_(re,{width:window.innerWidth,height:window.innerHeight},{blankCanvas:$e,wireframePurpose:mt||void 0},De.outputDetail)),xe){const v=B_(xe,De.outputDetail,{width:window.innerWidth,height:window.innerHeight});v&&(x+=`
`+v)}if(p)try{await navigator.clipboard.writeText(x)}catch{}a?.(x),Se(!0),fe(()=>Se(!1),2e3),De.autoClearAfterCopy&&fe(()=>Ao(),500)},[f,mn,re,xe,$e,ae,ar,mt,me,De.outputDetail,Bo,De.autoClearAfterCopy,Ao,p,a]),aa=_.useCallback(async()=>{const u=typeof window<"u"?window.location.pathname+window.location.search+window.location.hash:me;let h=H_(f,u,De.outputDetail);if(!h&&re.length===0&&!xe)return;if(h||(h=`## Page Feedback: ${u}
`),re.length>0&&(h+=`
`+D_(re,{width:window.innerWidth,height:window.innerHeight},{blankCanvas:$e,wireframePurpose:mt||void 0},De.outputDetail)),xe){const v=B_(xe,De.outputDetail,{width:window.innerWidth,height:window.innerHeight});v&&(h+=`
`+v)}c&&c(h,f),wt("sending"),await new Promise(v=>fe(v,150));const x=await Wn("submit",{output:h,annotations:f},!0);wt(x?"sent":"failed"),fe(()=>wt("idle"),2500),x&&De.autoClearAfterCopy&&fe(()=>Ao(),500)},[c,Wn,f,re,xe,$e,ar,me,De.outputDetail,Bo,De.autoClearAfterCopy,Ao]);_.useEffect(()=>{if(!dr)return;const u=10,h=v=>{const S=v.clientX-dr.x,P=v.clientY-dr.y,X=Math.sqrt(S*S+P*P);if(!Oo&&X>u&&ed(!0),Oo||X>u){let V=dr.toolbarX+S,ne=dr.toolbarY+P;const le=20,ce=337,ve=44,_e=ce-(j?Mn==="connected"?297:257:44),Z=le-_e,gt=window.innerWidth-le-ce;V=Math.max(Z,Math.min(gt,V)),ne=Math.max(le,Math.min(window.innerHeight-ve-le,ne)),Zi({x:V,y:ne})}},x=()=>{Oo&&(ea.current=!0),ed(!1),td(null)};return document.addEventListener("mousemove",h),document.addEventListener("mouseup",x),()=>{document.removeEventListener("mousemove",h),document.removeEventListener("mouseup",x)}},[dr,Oo,j,Mn]);const Yp=_.useCallback(u=>{if(u.target.closest("button")||u.target.closest("[data-agentation-settings-panel]"))return;const h=u.currentTarget.parentElement;if(!h)return;const x=h.getBoundingClientRect(),v=ct?.x??x.left,S=ct?.y??x.top;td({x:u.clientX,y:u.clientY,toolbarX:v,toolbarY:S})},[ct]);if(_.useEffect(()=>{if(!ct)return;const u=()=>{let S=ct.x,P=ct.y;const ne=20-(337-(j?Mn==="connected"?297:257:44)),le=window.innerWidth-20-337;S=Math.max(ne,Math.min(le,S)),P=Math.max(20,Math.min(window.innerHeight-44-20,P)),(S!==ct.x||P!==ct.y)&&Zi({x:S,y:P})};return u(),window.addEventListener("resize",u),()=>window.removeEventListener("resize",u)},[ct,j,Mn]),_.useEffect(()=>{const u=h=>{const x=h.target,v=x.tagName==="INPUT"||x.tagName==="TEXTAREA"||x.isContentEditable;if(h.key==="Escape"){if(ae){je?pe(null):fl();return}if(jn){Gi(!1);return}if(bt.length>0){ur([]);return}I||j&&(Ot(),M(!1))}if((h.metaKey||h.ctrlKey)&&h.shiftKey&&(h.key==="f"||h.key==="F")){h.preventDefault(),Ot(),j?ud():M(!0);return}if(!(v||h.metaKey||h.ctrlKey)&&((h.key==="p"||h.key==="P")&&(h.preventDefault(),Ot(),ra()),(h.key==="l"||h.key==="L")&&(h.preventDefault(),Ot(),jn&&Gi(!1),O&&se(!1),I&&sa(),ae?fl():We(!0)),(h.key==="h"||h.key==="H")&&f.length>0&&(h.preventDefault(),Ot(),N(S=>!S)),(h.key==="c"||h.key==="C")&&(f.length>0||re.length>0||xe)&&(h.preventDefault(),Ot(),ia()),(h.key==="x"||h.key==="X")&&(f.length>0||re.length>0||xe)&&(h.preventDefault(),Ot(),Ao(),re.length>0&&Ge([]),xe&&pn(null)),h.key==="s"||h.key==="S")){const S=Hn(De.webhookUrl)||Hn($||"");f.length>0&&S&&Fe==="idle"&&(h.preventDefault(),Ot(),aa())}};return document.addEventListener("keydown",u),()=>document.removeEventListener("keydown",u)},[j,jn,ae,je,re,xe,I,f.length,De.webhookUrl,$,Fe,aa,ra,ia,Ao,bt]),!ue||W)return null;const ls=f.length>0,pr=f.filter(u=>!od.has(u.id)&&u.kind!=="placement"&&u.kind!=="rearrange"),Xp=pr.length>0,fd=f.filter(u=>od.has(u.id)),hd=u=>{const P=u.x/100*window.innerWidth,X=typeof u.y=="string"?parseFloat(u.y):u.y,V={};window.innerHeight-X-22-10<80&&(V.top="auto",V.bottom="calc(100% + 10px)");const le=P-200/2,ce=10;if(le<ce){const ve=ce-le;V.left=`calc(50% + ${ve}px)`}else if(le+200>window.innerWidth-ce){const ve=le+200-(window.innerWidth-ce);V.left=`calc(50% - ${ve}px)`}return V};return Ou.createPortal(s.jsxs("div",{ref:he,style:{display:"contents"},"data-agentation-theme":On?"dark":"light","data-agentation-accent":De.annotationColorId,"data-agentation-root":"",children:[s.jsx("div",{className:`${A.toolbar}${k?` ${k}`:""}`,"data-feedback-toolbar":!0,"data-agentation-toolbar":!0,style:ct?{left:ct.x,top:ct.y,right:"auto",bottom:"auto"}:void 0,children:s.jsxs("div",{className:`${A.toolbarContainer} ${j?A.expanded:A.collapsed} ${qu?A.entrance:""} ${D?A.hiding:""} ${!De.webhooksEnabled&&(Hn(De.webhookUrl)||Hn($||""))?A.serverConnected:""}`,onClick:j?void 0:u=>{if(ea.current){ea.current=!1,u.preventDefault();return}M(!0)},onMouseDown:Yp,role:j?void 0:"button",tabIndex:j?-1:0,title:j?void 0:"Start feedback mode",children:[s.jsxs("div",{className:`${A.toggleContent} ${j?A.hidden:A.visible}`,children:[s.jsx(Ig,{size:24}),Xp&&s.jsx("span",{className:`${A.badge} ${j?A.fadeOut:""} ${qu?A.entrance:""}`,children:pr.length})]}),s.jsxs("div",{className:`${A.controlsContent} ${j?A.visible:A.hidden} ${ct&&ct.y<100?A.tooltipBelow:""} ${ze||O?A.tooltipsHidden:""} ${Vu?A.tooltipsInSession:""}`,onMouseEnter:Tp,onMouseLeave:Pp,children:[s.jsxs("div",{className:`${A.buttonWrapper} ${ct&&ct.x<120?A.buttonWrapperAlignLeft:""}`,children:[s.jsx("button",{className:A.controlButton,onClick:u=>{u.stopPropagation(),Ot(),ra()},"data-active":E,children:s.jsx(Tg,{size:24,isPaused:E})}),s.jsxs("span",{className:A.buttonTooltip,children:[E?"Resume animations":"Pause animations",s.jsx("span",{className:A.shortcut,children:"P"})]})]}),s.jsxs("div",{className:A.buttonWrapper,children:[s.jsx("button",{className:`${A.controlButton} ${On?"":A.light}`,onClick:u=>{u.stopPropagation(),Ot(),jn&&Gi(!1),O&&se(!1),I&&sa(),ae?fl():We(!0)},"data-active":ae,style:ae&&$e?{color:"#f97316",background:"rgba(249, 115, 22, 0.25)"}:void 0,children:s.jsx(Hg,{size:21})}),s.jsxs("span",{className:A.buttonTooltip,children:[ae?"Exit layout mode":"Layout mode",s.jsx("span",{className:A.shortcut,children:"L"})]})]}),s.jsxs("div",{className:A.buttonWrapper,children:[s.jsx("button",{className:A.controlButton,onClick:u=>{u.stopPropagation(),Ot(),N(!b)},disabled:!ls||ae,children:s.jsx(Rg,{size:24,isOpen:b})}),s.jsxs("span",{className:A.buttonTooltip,children:[b?"Hide markers":"Show markers",s.jsx("span",{className:A.shortcut,children:"H"})]})]}),s.jsxs("div",{className:A.buttonWrapper,children:[s.jsx("button",{className:`${A.controlButton} ${G?A.statusShowing:""}`,onClick:u=>{u.stopPropagation(),Ot(),ia()},disabled:ae&&$e?re.length===0&&!xe?.sections?.length:!ls&&mn.length===0&&re.length===0&&!xe?.sections?.length,"data-active":G,children:s.jsx(Ng,{size:24,copied:G,tint:ae&&$e&&(re.length>0||xe?.sections?.length)?"#f97316":void 0})}),s.jsxs("span",{className:A.buttonTooltip,children:[ae&&$e?"Copy layout":"Copy feedback",s.jsx("span",{className:A.shortcut,children:"C"})]})]}),s.jsxs("div",{className:`${A.buttonWrapper} ${A.sendButtonWrapper} ${j&&!De.webhooksEnabled&&(Hn(De.webhookUrl)||Hn($||""))?A.sendButtonVisible:""}`,children:[s.jsxs("button",{className:`${A.controlButton} ${Fe==="sent"||Fe==="failed"?A.statusShowing:""}`,onClick:u=>{u.stopPropagation(),Ot(),aa()},disabled:!ls||!Hn(De.webhookUrl)&&!Hn($||"")||Fe==="sending","data-no-hover":Fe==="sent"||Fe==="failed",tabIndex:Hn(De.webhookUrl)||Hn($||"")?0:-1,children:[s.jsx(Lg,{size:24,state:Fe}),ls&&Fe==="idle"&&s.jsx("span",{className:A.buttonBadge,children:f.length})]}),s.jsxs("span",{className:A.buttonTooltip,children:["Send Annotations",s.jsx("span",{className:A.shortcut,children:"S"})]})]}),s.jsxs("div",{className:A.buttonWrapper,children:[s.jsx("button",{className:A.controlButton,onClick:u=>{u.stopPropagation(),Ot(),Ao()},disabled:!ls&&mn.length===0&&re.length===0&&!xe?.sections?.length,"data-danger":!0,children:s.jsx(Dg,{size:24})}),s.jsxs("span",{className:A.buttonTooltip,children:["Clear all",s.jsx("span",{className:A.shortcut,children:"X"})]})]}),s.jsxs("div",{className:A.buttonWrapper,children:[s.jsx("button",{className:A.controlButton,onClick:u=>{u.stopPropagation(),Ot(),ae&&fl(),se(!O)},children:s.jsx(Pg,{size:24})}),m&&Mn!=="disconnected"&&s.jsx("span",{className:`${A.mcpIndicator} ${A[Mn]} ${O?A.hidden:""}`,title:Mn==="connected"?"MCP Connected":"MCP Connecting..."}),s.jsx("span",{className:A.buttonTooltip,children:"Settings"})]}),s.jsx("div",{className:A.divider}),s.jsxs("div",{className:`${A.buttonWrapper} ${ct&&typeof window<"u"&&ct.x>window.innerWidth-120?A.buttonWrapperAlignRight:""}`,children:[s.jsx("button",{className:A.controlButton,onClick:u=>{u.stopPropagation(),Ot(),ud()},children:s.jsx(Bg,{size:24})}),s.jsxs("span",{className:A.buttonTooltip,children:["Exit",s.jsx("span",{className:A.shortcut,children:"Esc"})]})]})]}),s.jsx(y1,{visible:ae&&j,activeType:je,onSelect:u=>{pe(je===u?null:u)},isDarkMode:On,sectionCount:xe?.sections.length??0,onDetectSections:()=>{const u=I1(),h=xe?.sections??[],x=new Set(h.map(X=>X.selector)),v=u.filter(X=>!x.has(X.selector)),S=[...h,...v],P=[...xe?.originalOrder??[],...v.map(X=>X.id)];pn({sections:S,originalOrder:P,detectedAt:Date.now()})},placementCount:re.length,onClearPlacements:()=>{Ki(u=>u+1),Yu(u=>u+1),fe(()=>{pn({sections:[],originalOrder:[],detectedAt:Date.now()})},200)},blankCanvas:$e,onBlankCanvasChange:u=>{const h={sections:[],originalOrder:[],detectedAt:Date.now()};u?(Vi.current={rearrange:xe,placements:re},pn(Do.current.rearrange||h),Ge(Do.current.placements),pe(null)):(Do.current={rearrange:xe,placements:re},pn(Vi.current.rearrange||h),Ge(Vi.current.placements)),fn(u)},wireframePurpose:mt,onWireframePurposeChange:Gn,Tooltip:Vo,onDragStart:(u,h)=>{h.preventDefault();const x=J[u];let v=null,S=!1;const P=h.clientX,X=h.clientY,ne=h.target.closest("[data-feedback-toolbar]")?.getBoundingClientRect().top??window.innerHeight,le=ve=>{const Te=ve.clientX-P,_e=ve.clientY-X;if(!S&&(Math.abs(Te)>4||Math.abs(_e)>4)&&(S=!0,v=document.createElement("div"),v.className=`${R.dragPreview}${$e?` ${R.dragPreviewWireframe}`:""}`,document.body.appendChild(v)),!v)return;const Z=Math.max(0,ne-ve.clientY),gt=Math.min(1,Z/180),et=1-Math.pow(1-gt,2),jt=28,qe=20,yt=Math.min(140,x.width*.18),ye=Math.min(90,x.height*.18),Ee=jt+(yt-jt)*et,ut=qe+(ye-qe)*et;v.style.width=`${Ee}px`,v.style.height=`${ut}px`,v.style.left=`${ve.clientX-Ee/2}px`,v.style.top=`${ve.clientY-ut/2}px`,v.style.opacity=`${.5+.5*et}`,v.textContent=et>.25?u:""},ce=ve=>{if(window.removeEventListener("mousemove",le),window.removeEventListener("mouseup",ce),v&&document.body.removeChild(v),S){const Te=x.width,_e=x.height,Z=window.scrollY,gt=Math.max(0,ve.clientX-Te/2),et=Math.max(0,ve.clientY+Z-_e/2),jt={id:`dp-${Date.now()}-${Math.random().toString(36).slice(2,7)}`,type:u,x:gt,y:et,width:Te,height:_e,scrollY:Z,timestamp:Date.now()};Ge(qe=>[...qe,jt]),pe(null),qr.current=new Set,Uu(qe=>qe+1)}};window.addEventListener("mousemove",le),window.addEventListener("mouseup",ce)}}),s.jsx(zx,{settings:De,onSettingsChange:u=>Dp(h=>({...h,...u})),isDarkMode:On,onToggleTheme:Bp,isDevMode:zp,connectionStatus:Mn,endpoint:m,isVisible:K,toolbarNearBottom:!!ct&&ct.y<230,settingsPage:we,onSettingsPageChange:be,onHideToolbar:Wp})]})}),(ae||Oe)&&s.jsx("div",{className:`${R.blankCanvas} ${qt?R.visible:""} ${ll?R.gridActive:""}`,style:{"--canvas-opacity":Bn},"data-feedback-toolbar":!0}),ae&&$e&&qt&&s.jsxs("div",{className:R.wireframeNotice,"data-feedback-toolbar":!0,children:[s.jsxs("div",{className:R.wireframeOpacityRow,children:[s.jsx("span",{className:R.wireframeOpacityLabel,children:"Toggle Opacity"}),s.jsx("input",{type:"range",className:R.wireframeOpacitySlider,min:0,max:1,step:.01,value:Bn,onChange:u=>hn(Number(u.target.value))})]}),s.jsxs("div",{className:R.wireframeNoticeTitleRow,children:[s.jsx("span",{className:R.wireframeNoticeTitle,children:"Wireframe Mode"}),s.jsx("span",{className:R.wireframeNoticeDivider}),s.jsx("button",{className:R.wireframeStartOver,onClick:()=>{Ki(u=>u+1),pn({sections:[],originalOrder:[],detectedAt:Date.now()}),Do.current={rearrange:null,placements:[]},Gn(""),Fl(me)},children:"Start Over"})]}),"Drag components onto the canvas.",s.jsx("br",{}),"Copied output will only include the wireframed layout."]}),(ae||Oe)&&s.jsx(f1,{placements:re,onChange:Ge,activeComponent:Oe?null:je,onActiveComponentChange:pe,isDarkMode:On,exiting:Oe,onInteractionChange:Cp,passthrough:!je,extraSnapRects:xe?.sections.map(u=>u.currentRect),deselectSignal:jp,clearSignal:Ip,wireframe:$e,onSelectionChange:(u,h)=>{qr.current=u,h||(il.current=new Set,Ep(x=>x+1))},onDragMove:(u,h)=>{const x=il.current;if(!(!x.size||!xe)){if(!Cn.current){Cn.current=new Map;for(const v of xe.sections)x.has(v.id)&&Cn.current.set(v.id,{x:v.currentRect.x,y:v.currentRect.y})}for(const v of xe.sections){if(!x.has(v.id)||!Cn.current.get(v.id))continue;const P=document.querySelector(`[data-rearrange-section="${v.id}"]`);P&&(P.style.transform=`translate(${u}px, ${h}px)`)}}},onDragEnd:(u,h,x)=>{const v=il.current,S=Cn.current;if(Cn.current=null,!(!v.size||!xe||!S)){for(const P of v){const X=document.querySelector(`[data-rearrange-section="${P}"]`);X&&(X.style.transform="")}x&&pn(P=>P&&{...P,sections:P.sections.map(X=>{const V=S.get(X.id);return V?{...X,currentRect:{...X.currentRect,x:Math.max(0,V.x+u),y:Math.max(0,V.y+h)}}:X})})}}}),(ae||Oe)&&xe&&s.jsx(L1,{rearrangeState:xe,onChange:pn,isDarkMode:On,exiting:Oe,blankCanvas:$e,extraSnapRects:re.map(u=>({x:u.x,y:u.y,width:u.width,height:u.height})),clearSignal:$p,deselectSignal:Mp,onSelectionChange:(u,h)=>{il.current=u,h||(qr.current=new Set,Uu(x=>x+1))},onDragMove:(u,h)=>{const x=qr.current;if(x.size){if(!Cn.current){Cn.current=new Map;for(const v of re)x.has(v.id)&&Cn.current.set(v.id,{x:v.x,y:v.y})}for(const v of x){const S=document.querySelector(`[data-design-placement="${v}"]`);S&&(S.style.transform=`translate(${u}px, ${h}px)`)}}},onDragEnd:(u,h,x)=>{const v=qr.current,S=Cn.current;if(Cn.current=null,!(!v.size||!S)){for(const P of v){const X=document.querySelector(`[data-design-placement="${P}"]`);X&&(X.style.transform="")}x&&Ge(P=>P.map(X=>{const V=S.get(X.id);return V?{...X,x:Math.max(0,V.x+u),y:Math.max(0,V.y+h)}:X}))}}}),s.jsx("canvas",{ref:qi,className:`${A.drawCanvas} ${jn?A.active:""}`,style:{opacity:na?1:0,transition:"opacity 0.15s ease"},"data-feedback-toolbar":!0}),s.jsxs("div",{className:A.markersLayer,"data-feedback-toolbar":!0,children:[q&&pr.filter(u=>!u.isFixed).map((u,h,x)=>s.jsx(U_,{annotation:u,globalIndex:pr.findIndex(v=>v.id===u.id),layerIndex:h,layerSize:x.length,isExiting:Be,isClearing:Bt,isAnimated:nd.has(u.id),isHovered:!Be&&Vn===u.id,isDeleting:Sn===u.id,isEditingAny:!!T,renumberFrom:Kn,markerClickBehavior:De.markerClickBehavior,tooltipStyle:hd(u),onHoverEnter:v=>!Be&&v.id!==_l.current&&ml(v),onHoverLeave:()=>ml(null),onClick:v=>De.markerClickBehavior==="delete"?la(v.id):pl(v),onContextMenu:pl},u.id)),q&&!Be&&fd.filter(u=>!u.isFixed).map(u=>s.jsx(Y_,{annotation:u},u.id))]}),s.jsxs("div",{className:A.fixedMarkersLayer,"data-feedback-toolbar":!0,children:[q&&pr.filter(u=>u.isFixed).map((u,h,x)=>s.jsx(U_,{annotation:u,globalIndex:pr.findIndex(v=>v.id===u.id),layerIndex:h,layerSize:x.length,isExiting:Be,isClearing:Bt,isAnimated:nd.has(u.id),isHovered:!Be&&Vn===u.id,isDeleting:Sn===u.id,isEditingAny:!!T,renumberFrom:Kn,markerClickBehavior:De.markerClickBehavior,tooltipStyle:hd(u),onHoverEnter:v=>!Be&&v.id!==_l.current&&ml(v),onHoverLeave:()=>ml(null),onClick:v=>De.markerClickBehavior==="delete"?la(v.id):pl(v),onContextMenu:pl},u.id)),q&&!Be&&fd.filter(u=>u.isFixed).map(u=>s.jsx(Y_,{annotation:u,fixed:!0},u.id))]}),j&&s.jsxs("div",{className:A.overlay,"data-feedback-toolbar":!0,style:I||T?{zIndex:99999}:void 0,children:[ke?.rect&&!I&&!Xe&&!qn&&s.jsx("div",{className:`${A.hoverHighlight} ${A.enter}`,style:{left:ke.rect.left,top:ke.rect.top,width:ke.rect.width,height:ke.rect.height,borderColor:"color-mix(in srgb, var(--agentation-color-accent) 50%, transparent)",backgroundColor:"color-mix(in srgb, var(--agentation-color-accent) 4%, transparent)"}}),bt.filter(u=>document.contains(u.element)).map((u,h)=>{const x=u.element.getBoundingClientRect(),v=bt.length>1;return s.jsx("div",{className:v?A.multiSelectOutline:A.singleSelectOutline,style:{position:"fixed",left:x.left,top:x.top,width:x.width,height:x.height,...v?{}:{borderColor:"color-mix(in srgb, var(--agentation-color-accent) 60%, transparent)",backgroundColor:"color-mix(in srgb, var(--agentation-color-accent) 5%, transparent)"}}},h)}),Vn&&!I&&(()=>{const u=f.find(S=>S.id===Vn);if(!u?.boundingBox)return null;if(u.elementBoundingBoxes?.length)return Gt.length>0?Gt.filter(S=>document.contains(S)).map((S,P)=>{const X=S.getBoundingClientRect();return s.jsx("div",{className:`${A.multiSelectOutline} ${A.enter}`,style:{left:X.left,top:X.top,width:X.width,height:X.height}},`hover-outline-live-${P}`)}):u.elementBoundingBoxes.map((S,P)=>s.jsx("div",{className:`${A.multiSelectOutline} ${A.enter}`,style:{left:S.x,top:S.y-He,width:S.width,height:S.height}},`hover-outline-${P}`));const h=co&&document.contains(co)?co.getBoundingClientRect():null,x=h?{x:h.left,y:h.top,width:h.width,height:h.height}:{x:u.boundingBox.x,y:u.isFixed?u.boundingBox.y:u.boundingBox.y-He,width:u.boundingBox.width,height:u.boundingBox.height},v=u.isMultiSelect;return s.jsx("div",{className:`${v?A.multiSelectOutline:A.singleSelectOutline} ${A.enter}`,style:{left:x.x,top:x.y,width:x.width,height:x.height,...v?{}:{borderColor:"color-mix(in srgb, var(--agentation-color-accent) 60%, transparent)",backgroundColor:"color-mix(in srgb, var(--agentation-color-accent) 5%, transparent)"}}})})(),ke&&!I&&!Xe&&!qn&&s.jsxs("div",{className:`${A.hoverTooltip} ${A.enter}`,style:{left:Math.max(8,Math.min(oe.x,window.innerWidth-100)),top:Math.max(oe.y-(ke.reactComponents?48:32),8)},children:[ke.reactComponents&&s.jsx("div",{className:A.hoverReactPath,children:ke.reactComponents}),s.jsx("div",{className:A.hoverElementName,children:ke.elementName})]}),I&&s.jsxs(s.Fragment,{children:[I.multiSelectElements?.length?I.multiSelectElements.filter(u=>document.contains(u)).map((u,h)=>{const x=u.getBoundingClientRect();return s.jsx("div",{className:`${A.multiSelectOutline} ${ns?A.exit:A.enter}`,style:{left:x.left,top:x.top,width:x.width,height:x.height}},`pending-multi-${h}`)}):I.targetElement&&document.contains(I.targetElement)?(()=>{const u=I.targetElement.getBoundingClientRect();return s.jsx("div",{className:`${A.singleSelectOutline} ${ns?A.exit:A.enter}`,style:{left:u.left,top:u.top,width:u.width,height:u.height,borderColor:"color-mix(in srgb, var(--agentation-color-accent) 60%, transparent)",backgroundColor:"color-mix(in srgb, var(--agentation-color-accent) 5%, transparent)"}})})():I.boundingBox&&s.jsx("div",{className:`${I.isMultiSelect?A.multiSelectOutline:A.singleSelectOutline} ${ns?A.exit:A.enter}`,style:{left:I.boundingBox.x,top:I.boundingBox.y-He,width:I.boundingBox.width,height:I.boundingBox.height,...I.isMultiSelect?{}:{borderColor:"color-mix(in srgb, var(--agentation-color-accent) 60%, transparent)",backgroundColor:"color-mix(in srgb, var(--agentation-color-accent) 5%, transparent)"}}}),(()=>{const u=I.x,h=I.isFixed?I.y:I.y-He;return s.jsxs(s.Fragment,{children:[s.jsx(Ex,{x:u,y:h,isMultiSelect:I.isMultiSelect,isExiting:ns}),s.jsx(Ei,{ref:id,element:I.element,selectedText:I.selectedText,computedStyles:I.computedStylesObj,placeholder:I.element==="Area selection"?"What should change in this area?":I.isMultiSelect?"Feedback for this group of elements...":"What should change?",onSubmit:Fp,onCancel:sa,isExiting:ns,lightMode:!On,accentColor:I.isMultiSelect?"var(--agentation-color-green)":"var(--agentation-color-accent)",style:{left:Math.max(160,Math.min(window.innerWidth-160,u/100*window.innerWidth)),...h>window.innerHeight-290?{bottom:window.innerHeight-h+20}:{top:h+20}}})]})})()]}),T&&s.jsxs(s.Fragment,{children:[T.elementBoundingBoxes?.length?Ce.length>0?Ce.filter(u=>document.contains(u)).map((u,h)=>{const x=u.getBoundingClientRect();return s.jsx("div",{className:`${A.multiSelectOutline} ${A.enter}`,style:{left:x.left,top:x.top,width:x.width,height:x.height}},`edit-multi-live-${h}`)}):T.elementBoundingBoxes.map((u,h)=>s.jsx("div",{className:`${A.multiSelectOutline} ${A.enter}`,style:{left:u.x,top:u.y-He,width:u.width,height:u.height}},`edit-multi-${h}`)):(()=>{const u=Me&&document.contains(Me)?Me.getBoundingClientRect():null,h=u?{x:u.left,y:u.top,width:u.width,height:u.height}:T.boundingBox?{x:T.boundingBox.x,y:T.isFixed?T.boundingBox.y:T.boundingBox.y-He,width:T.boundingBox.width,height:T.boundingBox.height}:null;return h?s.jsx("div",{className:`${T.isMultiSelect?A.multiSelectOutline:A.singleSelectOutline} ${A.enter}`,style:{left:h.x,top:h.y,width:h.width,height:h.height,...T.isMultiSelect?{}:{borderColor:"color-mix(in srgb, var(--agentation-color-accent) 60%, transparent)",backgroundColor:"color-mix(in srgb, var(--agentation-color-accent) 5%, transparent)"}}}):null})(),s.jsx(Ei,{ref:ad,element:T.element,selectedText:T.selectedText,computedStyles:C1(T.computedStyles),placeholder:"Edit your feedback...",initialValue:T.comment,submitLabel:"Save",onSubmit:Hp,onCancel:Up,onDelete:()=>la(T.id),isExiting:Op,lightMode:!On,accentColor:T.isMultiSelect?"var(--agentation-color-green)":"var(--agentation-color-accent)",style:(()=>{const u=T.isFixed?T.y:T.y-He;return{left:Math.max(160,Math.min(window.innerWidth-160,T.x/100*window.innerWidth)),...u>window.innerHeight-290?{bottom:window.innerHeight-u+20}:{top:u+20}}})()})]}),qn&&s.jsxs(s.Fragment,{children:[s.jsx("div",{ref:os,className:A.dragSelection}),s.jsx("div",{ref:rs,className:A.highlightsContainer})]})]})]}),document.body)}function Wx(){const e=document.querySelector("script[data-agentation-config]");if(!e)return null;try{const t=atob(e.dataset.agentationConfig||"");return JSON.parse(t||"{}")}catch(t){return console.warn("[agentation] config parse failed",t),null}}(function(){const t=Wx()||{};if(window.TYPO3Agentation=t,t.enabled===!1)return;const n=()=>{if(document.getElementById("typo3-agentation-root"))return;const o=document.createElement("div");o.id="typo3-agentation-root",o.setAttribute("data-agentation-scope",t.scope||"frontend"),document.body.appendChild(o);const r=async a=>{if(navigator.clipboard?.writeText){await navigator.clipboard.writeText(a);return}const c=document.createElement("textarea");c.value=a,c.setAttribute("readonly",""),c.style.position="absolute",c.style.left="-9999px",document.body.appendChild(c),c.select(),document.execCommand("copy"),document.body.removeChild(c)},l=async a=>{const c=t.webhookUrl;if(c)try{await fetch(c,{method:"POST",headers:{"Content-Type":"application/json",...t.apiKey?{Authorization:`Bearer ${t.apiKey}`}:{}},body:JSON.stringify({annotation:a,context:t.context,pageId:t.pageId,beUser:t.beUser,workspaceId:t.workspaceId,metadata:t.metadata}),keepalive:!0})}catch(p){console.warn("[agentation] webhook POST failed",p)}},i={webhookUrl:t.webhookUrl||void 0,sessionId:t.sessionId||void 0,copyToClipboard:r,onSubmit:l,...t.additionalOptions||{}};try{const a=lp(o);a.render(_.createElement(Ax,i)),t.__root=a}catch(a){console.warn("[agentation] mount failed",a)}};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",n,{once:!0}):n()})();
